...
public class CompanyRegnDataImporter
{
	...
	private static void importCompanies( )
	{
		...
		System.out.println( "Total List Size - " + csvDataList.size( ) );
		...
		for( String [ ] strings : csvDataList )
        {
	        ...
	        System.out.println( "Response code for company " + (i-2) + ": " + responseCode );
	        i++;
	...
	private static void activateCompany( RegnData regnData, String reqType )
	{
		...
		System.out.println( "Company Activation result: " + responseCode );
