		...
		try
        {
			...
			if( requestType.equals( "QuoteCreation" ) ||  requestType.equals( "UpdateQuote" ) )  // This conversion process only for the QuoteCreation request
			{
				...
				for( JsonElement jsonele : itemsArr )
				{
					...
					System.out.println( "multiplier="+quoteItemJSONData.get( "multiplier" ).getAsString( ) );
					...
					System.out.println( "item multiplier="+item.multiplier_ );
				...
				if( requestType.equals( "UpdateQuote" ) )
				{
					...
					System.out.println( "QuoteId="+quoteData.quoteId_+"transid="+quoteData.transId_ );
