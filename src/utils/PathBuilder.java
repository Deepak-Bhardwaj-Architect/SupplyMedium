...
public class PathBuilder
{
	...
	public int getRelativePath( String localPath, StringHolder relativePath )
	{
		...
		try
        {
			...
			relativePath.value =  localPath.replace( currentStr, replaceStr );
	...
	public int getWebURL( String localPath, StringHolder webURL )
	{
		...
		try
        {
			...
			//System.out.println( "Path builder current str - " + currentStr );
			
			//System.out.println( "Path builder replace str - " + replaceStr );
			
			//currentStr = currentStr.replace( "\\", "/" );
			
			webURL.value =  localPath.replace( currentStr, replaceStr );
			
			//System.out.println( "WebURL at path builder - " + webURL.value );
			
			String basePath = AppConfigReader.instance( ).get( "BASE_SERVER_URL" );
	...
	public int getWebURLFromRelativepath( String relativePath, StringHolder webURL )
	{
		...
		try
        {
             ...
             // System.out.println("Path = "+userFeedData.relativePath_);
	...
	public int getUserLogoDirPath( String companyname, String phoneNumber, StringHolder path )
	{
		...
		try
        {
			...
			path.value = path.value+"/"+companyFolderName+"/Images/UserProfile/";
        }
        catch( Exception e )
        {
        	ErrorLogger errLogger = ErrorLogger.instance( );
	...
	public int getCompanyDirPath( String companyname, String phoneNumber,StringHolder path )
	{
		...
		try
        {
			...
			System.out.println( "Catalina home - " + path.value );
			String companyFolderName = companyname+"-"+phoneNumber;
