...
public class Test1
{
	...
	public void singleFeedInsertTest()
	{
		...
		if( result == 1800)
			System.out.println( "Single feed inserted test successfully completed" );
		else 
			System.out.println( "Single feed inserted test failed." );	
	...
	public void deleteFeedTest()
	{
		...
		if( result == 1810)
			System.out.println( " Feed deleted test successfully completed" );
		else 
			System.out.println( " Feed deleted test failed." );	
	}
