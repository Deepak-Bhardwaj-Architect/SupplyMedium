...
public class VRMailingAddressTest
{
	...
	public void addTest()
	{
		...
		System.out.println( "VRMailing result id="+result );
		
		if( result == 10300  )
		{
			System.out.println( "Address add test successfully completed" );
		...
		{
			System.out.println( "Address add test failed" );
		}
	...
	public void deleteTest()
	{
		...
		if( result == 10310  )
		{
			System.out.println( "Address delete test successfully completed" );
			
		}
		
		else
		{
			System.out.println( "Address delete test failed" );
		}
	...
	public void fetchTest()
	{
		...
		if( result == 10320  )
		{
			System.out.println( "Address fetch test successfully completed" );
		...
		{
			System.out.println( "Address fetch test failed" );
		}
