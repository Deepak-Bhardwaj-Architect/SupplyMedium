...
public class NotificationTest
{
	...
	public void addTest()
	{
		...
		System.out.println( "Notification result id="+result );
		
		if( result == 10300  )
		{
			System.out.println( "Notification add test successfully completed" );
		...
		{
			System.out.println( "Notification add test failed" );
		}
	...
	public void deleteTest()
	{
		...
		if( result == 10310  )
		{
			System.out.println( "Notification delete test successfully completed" );
			
		}
		
		else
		{
			System.out.println( "Notification delete test failed" );
		}
	...
	public void fetchTest()
	{
		...
		if( result == 10320  )
		{
			System.out.println( "Notification fetch test successfully completed" );
		...
		{
			System.out.println( "Notification fetch test failed" );
		}
