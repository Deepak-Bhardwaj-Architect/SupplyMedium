...
public class HistoryTest
{
			...
			
	{
		...
		System.out.println( "Remainder result id="+result );
		
		if( result == 10300  )
		{
			System.out.println( "Remainder add test successfully completed" );
			
			System.out.println( "Remainder added successfully" );
		}
		
		else
		{
			System.out.println( "Remainder add test failed" );
		}
	...
	public void deleteTest()
	{
		...
		if( result == 10310  )
		{
			System.out.println( "Remainder delete test successfully completed" );
			
		}
		
		else
		{
			System.out.println( "Remainder delete test failed" );
		}
	}
	...
	public void fetchTest()
	{
		...
		if( result == 10320  )
		{
			System.out.println( "Remainder fetch test successfully completed" );
		...
		{
			System.out.println( "Remainder fetch test failed" );
		}
	...
	public void addTestRating()
	{
		...
		System.out.println( "Ratings result id="+result );
		
		if( result == 16020  )
		{
			System.out.println( "Ratings add test successfully completed" );
		...
		{
			System.out.println( "Ratings add test failed" );
		}
	...
	public void fetchTransactionHistoryTest()
	{
		...
		if( result == 10320  )
		{
			System.out.println( "TransactionHistory fetch test successfully completed" );
		...
		{
			System.out.println( "TransactionHistory fetch test failed" );
		}
