...
public class WLMemberTest
{
	...
	public void addMembersTest()
	{
		...
		if( result == 10130 )
			System.out.println( "Add members test completed" );
		else
			System.out.println( "Add members test failed" );
	...
	public void deleteMembersTest()
	{
		...
		if( result == 10140 )
			System.out.println( "delete members test completed" );
		else
			System.out.println( "delete members test failed" );
	...
	public void getMembersTest()
	{
		...
		if( result == 10150 )
		{
			System.out.println( "Members fetch test completed" );
		...
		{
			System.out.println( "Members fetch test failed" );
		}
