...
public class AdTest
{
	...
	public void addTest()
	{
		...
		System.out.println( "Advertisement result id ="+result );
	...
	public void deleteTest()
	{
		...
		if( result == 10310  )
		{
			System.out.println( "Advertisement delete test successfully completed" );
			
		}
		
		else
		{
			System.out.println( "Advertisement delete test failed" );
		}
	}
	...
	public void fetchTest()
	{
		...
		if( result == 0  )
		{
			System.out.println( "Advertisement fetch test successfully completed" );
		...
		{
			System.out.println( "Advertisement fetch test failed" );
		}
