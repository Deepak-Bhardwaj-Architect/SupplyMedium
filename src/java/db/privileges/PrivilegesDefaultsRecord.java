...
if( errorMaster_ == null ) errorMaster_ = new ErrorMaster( );
		errorMaster_.insert( "userPrivileges_		= " + userPrivileges_ );
		errorMaster_.insert( "groupPrivileges_		= " + groupPrivileges_ );
		errorMaster_.insert( "deptPrivileges_		= " + deptPrivileges_ );
