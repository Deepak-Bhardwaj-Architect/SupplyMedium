...
if( errorMaster_ == null ) errorMaster_ = new ErrorMaster( );
		...
		try
		{
			...
			if( insertResult > 0 ) 
			{
				...
				if( keys.next( ) )
				{
					...
					errorMaster_.insert( "feedId_"+deptFeedData.deptFeedId_ );
				}
	...
	private String formInsertQuery( DeptFeedRecord record )
	{
		...
		insertQuery = insertQuery + ")";
                System.out.println("record.feedTitle_==========================>"+record.feedTitle_);
