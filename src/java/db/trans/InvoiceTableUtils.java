 ...
 */
	...
	public int dataToRecord( InvoiceData invoiceData, InvoiceRecord invoiceRecord )
	{
		try
        {
			...
			invoiceRecord.outsideSupplierNmae_	= invoiceData.outsideSupplierName_;
	...
	public String formInsertQuery( InvoiceRecord invoiceRecord )
	{
		...
		query 		 = query + "'" + invoiceRecord.selected_address+ "',";
                query 		 = query + "'" + invoiceRecord.outsideSupplierNmae_+", "+invoiceRecord.outsideSupplieraddress+", "+invoiceRecord.outsideSuppliercity+", "+invoiceRecord.outsideSupplierstate+", "+invoiceRecord.outsideSuppliercountry+", "+invoiceRecord.outsideSupplierzipcode+ "'";
		query 	  	 = query + ")";
	...
	public int rsToDataList( ResultSet rs, List<InvoiceData> invoiceList )
	{
		try
        {
			...
			{			
    			...
    			invoiceData.outsideSupplieraddress=rs.getString("outside_supplier_address");
