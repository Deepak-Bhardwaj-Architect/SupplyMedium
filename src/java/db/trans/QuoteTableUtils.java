	...
	*/
	...
	public int dataToRecord( QuoteData quoteData, QuoteRecord quoteRecord )
	{
		try
        {
			...
			quoteRecord.outsideSupplierNmae_	= quoteData.outsideSupplierName_;
	...
	public String formInsertQuery( QuoteRecord quoteRecord )
	{
		...
		query 		 = query + "'" + quoteRecord.totalPrice_ + "',";
                query 		 = query + "'" + quoteRecord.outsideSupplierNmae_+", "+quoteRecord.outsideSupplieraddress+", "+quoteRecord.outsideSuppliercity+", "+quoteRecord.outsideSupplierstate+", "+quoteRecord.outsideSuppliercountry+", "+quoteRecord.outsideSupplierzipcode+ "'";
		...
		try
        {
			...
			{			
    			...
    			quoteData.isPOCreated_		 		= rs.getInt( "is_po_created" );
                        quoteData.outsideSupplieraddress		 		= rs.getString("outside_supplier_address" );
