	...
	*/
	...
	public int dataToRecord( RFQData rfqData, RFQRecord rfqRecord )
	{
		try
        {
			...
			rfqRecord.outsideSupplierNmae_	= rfqData.outsideSupplierName_;
	...
	public String formInsertQuery( RFQRecord rfqRecord )
	{
		...
		query 		 = query + "'" + rfqRecord.RFQDate_ + "',";
                query 		 = query + "'" + rfqRecord.outsideSupplierNmae_+", "+rfqRecord.outsideSupplieraddress+", "+rfqRecord.outsideSuppliercity+", "+rfqRecord.outsideSupplierstate+", "+rfqRecord.outsideSuppliercountry+", "+rfqRecord.outsideSupplierzipcode+ "'";
		...
		try
        {
			while( rs.next( ) )
			{
    			...
    			rfqData.createdTimestamp_ 		= rs.getTimestamp( "created_timestamp" );
                        rfqData.outsideSupplieraddress 		= rs.getString("outside_supplier_address" );    			
    			RFQList.add( rfqData );
