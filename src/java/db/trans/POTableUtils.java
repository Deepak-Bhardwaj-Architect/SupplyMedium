...
public class POTableUtils
{
	...
	*/
	...
	public String formInsertQuery( PORecord poRecord )
	{
		...
		query 		 = query + "'" + poRecord.outsideSupplieraddress+", "+poRecord.outsideSuppliercity+", "+poRecord.outsideSupplierstate+", "+poRecord.outsideSuppliercountry+", "+poRecord.outsideSupplierzipcode+ "'";
	...
	public int rsToDataList( ResultSet rs, List<POData> poList )
	{
		try
        {
			...
			{			
    			...
    			poData.createdTimestamp_ 		= rs.getTimestamp( "created_timestamp" );
