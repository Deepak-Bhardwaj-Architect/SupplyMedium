...
public class NotificationTableUtils
{
    ...
    public int dataToRecord( NotificationCenterData notificationCenterData, NotificationRecord  notificationRecord )
    {
		...
		//System.out.print("notificationCenterData.receiverKey_.email_2================>"+notificationCenterData.receiverKey_.email_);	
    		notificationRecord.receiverKey_				= notificationCenterData.receiverKey_.email_; 
		//System.out.print("notificationRecord.receiverKey_================>"+notificationRecord.receiverKey_);
...
public int getFilterString( NotificationRecord filter, StringHolder query )
{
		try
        {
	        System.out.print("filter.receiverKey_ ====================================>"+filter.receiverKey_ );
