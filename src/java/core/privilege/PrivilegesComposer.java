...
public class PrivilegesComposer
{
	        ...
	        AllPrivilegesData allPrivilegesData )
	{
		...
		try
        {
			...
			errorMaster_.insert( "get dept privileges start" );
			...
			if( result == 0 )
			{
				...
				errorMaster_.insert( "get dept privileges end : dept privileges data arr count="+deptPrivilegesDataArr.size( ) );
			}
			else
			{
	        ...
	        List<DeptPrivilegesData> deptPrivilegesDataArr )
	{
		...
		//errorMaster_.insert( "*******************************************************************************"+profileData.userType_.equals( UserType.type.ADMIN.getValue( )));
		
		//errorMaster_.insert( "usertype="+profileData.userType_+"admin="+UserType.type.ADMIN.getValue( )  );
	        ...
	        List<DeptPrivilegesData> deptPrivilegesDataArr )
	{
		...
		errorMaster_.insert( "Size of GetDept = " + deptPrivilegesDataArr.size( ) );
	        ...
	        UserPrivilegesData userPrivilegesData )
	{
		...
		errorMaster_.insert( "Response: "+response );
	        ...
	        UsergroupPrivilegesData groupPrivilegesData )
	{
		...
		errorMaster_.insert( "Encoded Privileges: "+privileges );
