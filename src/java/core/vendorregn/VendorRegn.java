...
public class VendorRegn
{
	...
	public int update( VendorRegnData vendorRegnData )
	{
		...
		vendorRegnTable = null;
                ...
                //System.out.println("vendorRegnTable.updateStatus( vendorRegnData )");
		
		addNotification( vendorRegnData );
		
		//System.out.println("addNotification( vendorRegnData )");
		//To send vendor registraiton email
		...
		//int res	= regnTable.find(vendorRegnData.regnKey_, regnData );
                ...
                //System.out.println("regnTable.find(vendorRegnData.regnKey_, regnData )");
		...
		boolean canSendMail = notificationSettings.canSendNotification(userKey);
                ...
                //System.out.println("notificationSettings.canSendNotification(userKey)");
		...
		if( canSendMail )
		{
			...
			vrMail.send( vendorRegnData.regnKey_, vendorRegnData.vendorRegnKey_ );
                        ...
                        System.out.println("vrMail.send( vendorRegnData.regnKey_, vendorRegnData.vendorRegnKey_ )");
