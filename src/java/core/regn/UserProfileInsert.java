...
public class UserProfileInsert implements UserSignupProcess
{
	...
	public int process( UserProfileData userProfileData )
	{
		...
		errorMaster_.insert( "Address Details successfully inserted" );
		...
		errorMaster_.insert( "Profile Details successfully inserted" );
		...
		errorMaster_.insert( "Login Details successfully inserted" );
	...
	{
		errorMaster_.insert( "createuseraddress" + userProfileData );
	...
	private void sendUserSignupMail( String emailId, String firstName )
	{
		...
		mailerObj.composeAndSendMail( to, sub, message,"SM Registration" );
