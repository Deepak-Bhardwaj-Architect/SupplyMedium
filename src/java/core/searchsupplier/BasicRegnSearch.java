...
public class BasicRegnSearch implements BasicSupplierSearch
{
	...
	public int search( SearchOption searchOptionObj, List<SupplierSearchResult> searchResultList )
	{
		...
		errorMaster_.insert(  "supplierCompanyKeys before retainAll size:" + supplierCompanyKeys.size( ) );
				 ...
				 !( searchOptionObj.keyword_.trim( ).equalsIgnoreCase( "" ) ) )
		{
			...
			errorMaster_.insert(  "SuppliersByKeyword size:" + suppliersByKeyword.size( ) );
			errorMaster_.insert(  "supplierCompanyKeys size:" + supplierCompanyKeys.size( ) );
