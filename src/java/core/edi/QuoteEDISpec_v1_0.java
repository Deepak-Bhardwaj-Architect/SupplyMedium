...
/**
 * File:  QuoteEDISpec_v1_0.java 
 *
 * Created on Oct 22, 2013 5:56:51 PM
 */
public class QuoteEDISpec_v1_0 implements EDISpec
{
	ErrorLogger errorLogger_;

	// This map contain the all the Quote EDI element code.
	private Map<String, String> elementCodeMap_;
	
	// This map contain the all the  Quote segment code
	...
	private void loadElementCodeMap( )
	{
		...
		elementCodeMap_.put( "Transaction Set Purpose Code", "353" );
		
		elementCodeMap_.put( "Request for Quote Reference Number", "586" );
		...
		elementCodeMap_.put( "State or Province Code", "156" );
		...
		elementCodeMap_.put( "Quantity Ordered", "330" );
		...
		elementCodeMap_.put( "Quantity", "380" );
		
		elementCodeMap_.put( "Date/Time Qualifier", "374" );
		
		elementCodeMap_.put( "Number Of Line Item", "354" );
	...
	private void loadSegmentCodeMap( )
	{
		...
		segCodeMap_.put( "Beginning Segment for Response To Request for Quotation", "BQR" );
		...
		segCodeMap_.put( "Baseline Item Data", "PO1" );
		...
		segCodeMap_.put( "Line Item Schedule", "SCH" );
   ...
   // @Override
    public String getElementCode( String elementName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::QuoteEDISpec.getElementId- " + e );
	        return null;
        }
    }
    ...
    public String getSegmentCode( String segmentName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::QuoteEDISpec.getSegmentId- " + e );
	        return null;
        }
    }
