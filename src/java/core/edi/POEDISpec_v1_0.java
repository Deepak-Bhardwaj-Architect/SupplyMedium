...
/**
 * File:  POEDISpec_v1_0.java 
 *
 * Created on Oct 22, 2013 5:57:28 PM
 */
public class POEDISpec_v1_0 implements EDISpec
{
	...
	private void loadElementCodeMap( )
	{
		...
		elementCodeMap_.put( "Purchase Order Type Code", "92" );
	...
	private void loadSegmentCodeMap( )
	{
		...
		segCodeMap_.put( "Beginning Segment for Purchase Order ", "BEG" );
		...
		segCodeMap_.put( "Effective Date Time Reference", "DTM" );
   ...
   // @Override
    public String getElementCode( String elementName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::POEDISpec.getElementId- " + e );
	        return null;
        }
    }
    ...
    public String getSegmentCode( String segmentName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::POEDISpec.getSegmentId- " + e );
	        return null;
        }
    }
