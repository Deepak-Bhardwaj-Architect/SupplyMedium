...
/**
 * File:  RFQEDISpec_v1_0.java 
 *
 * Created on 21-Oct-2013 4:27:01 PM
 */
public class RFQEDISpec_v1_0 implements EDISpec
{
	ErrorLogger errorLogger_;

	// This map contain the all the RFQ EDI element code.
	private Map<String, String> elementCodeMap_;
	
	// This map contain the all the RFQ EDI segment code
	...
	private void loadElementCodeMap( )
	{
		...
		elementCodeMap_.put( "Transaction Set Control Nember", "329" );
	...
	private void loadSegmentCodeMap( )
	{
		...
		segCodeMap_.put( "Beginning Segment for Request for Quotation", "BQT" );
    ...
    public String getElementCode( String elementName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::RFQEDISpec.getElementId- " + e );
	        return null;
        }
    }
    ...
    public String getSegmentCode( String segmentName )
    {
        ...
        {
        	errorLogger_.logMsg( "Exception::RFQEDISpec.getSegmentId- " + e );
	        return null;
        }
    }
