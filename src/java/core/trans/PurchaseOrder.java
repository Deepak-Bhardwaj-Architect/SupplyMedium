	...
	private int sendPOMail( POData poData )
	{
		...
		try
        {
			...
			if( poData.isOutsideSupplier_ == 1 && poData.outsideSupplierEmailFlag_ == 1)
			{
				...
				String subject = "Perchase Order (PO"+poData.transId_+") from "+poData.fromCompanyProfileData_.companyName_;
				...
				String message = composer.composeTransactionMail4( trasnMsg,poData);
