	...
	public int convert( HttpServletRequest request, UserFeedData feedData )
	{
		try
        {
			...
			feedData.userKey_.email_ 			= request.getParameter( "UserKey" );
                        feedData.relativePath_                      = request.getParameter( "new_feed_image" );
                        feedData.localPath_                         = request.getParameter( "new_feed_image" );
                        feedData.webURL_                            = request.getParameter( "new_feed_image" );
