...
public class UserSignupDataConverter
{
	...
	public int convert( HttpServletRequest request,UserProfileData userProfileData )
    {
		try
		{
			...
			errorMaster_.insert( "converter Start");
			...
			if(reqMap.containsKey( "country" ))
			{
				...
				mailingAddressObj.countryRegion_ = request.getParameter( "country" );
				...
				mailingAddressObj.state_ = request.getParameter( "state" );
                        ...
                        if(request.getParameter( "RequestType" ).equals( "NewSignup" ))
                        {
                            ...
                            if(request.getParameter( "state" )==null)
                            {
                               ...
                               //System.out.println("mailingAddressObj.state_"+mailingAddressObj.state_);
                            }
                        }
			...
			errorMaster_.insert( "ReqType = " + request.getParameter( "RequestType" ));
