...
public class RegnController
{
	...
	/*
	 * Method : isCompnayIdExist( ) 
	 * 
	 * Input : company id 
	 * 
	 * Return : boolean
	 * 
	 * Purpose: It check whether company id already exist in supply medium or
	 * not. If exist it return true otherwise return false
	 */
	...
	public boolean isCompanyIdExist( String companyId )
	{
		...
		try
		{
			...
			result = regnValidationObj.isCompanyIdExist( companyId );
		...
		{
			errLogger_.logMsg( "Exception::RegnController.isCompanyIdExist() - " + ex );
