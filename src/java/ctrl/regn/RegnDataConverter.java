...
public class RegnDataConverter 
{
	...
	public int convert( HttpServletRequest request,RegnData regnDataObj )
	{
                    ...
                    
		{
			...
			{
				regnDataObj.businessCategory_ = request.getParameter( "businesscategory2" );
			}
...
//                        System.out.println(logoPath.value);
//                        Thread.sleep(20000);
                        ...
                        if( pathResult == 0 )  // Logo path fetch successfully
                        {
                                ...
                                {
                                         regnDataObj.logo_ = storedPath.value.replace(FileUploadPath.getFileUploadPath(request), AppConfigReader.instance( ).get( "TEMP_PATH" )+"/");
                                         //regnDataObj.logo_ = FileUploadPath.getFileDatabasePath(request, storedPath.value);
                                         //storedPath.value=regnDataObj.logo_;
                                         //storedPath.value.replace(AppConfigReader.instance( ).get( "TEMP_PATH" ),AppConfigReader.instance( ).get( "JSP_PATH" ));
...
//                                         Thread.sleep(20000);
			...
			errorMaster_.insert( "Parse request completed" );
