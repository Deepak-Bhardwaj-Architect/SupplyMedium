        ...
        try {
            ...
            if (requestType.equals("InvoiceCreation") || requestType.equals("UpdateInvoice")) {
                ...
                if (invoiceData.isOutsideBuyer_ == 1) {
                    invoiceData.outsideSupplierName_ = invoiceJSONData.get("outsideSuppliername").getAsString();
                ...
                for (JsonElement jsonele : itemsArr) {
                    ...
                    String multiplier = invoiceItemJSONData.get("multiplier").getAsString();
                    ...
                    item.multiplier_ = Integer.parseInt(multiplier);
