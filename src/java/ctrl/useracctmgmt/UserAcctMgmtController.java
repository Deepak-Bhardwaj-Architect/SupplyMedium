...
public class UserAcctMgmtController
{
	        ...
	        UserAcctMgmtData userAcctMgmtData )
	{
		...
		else if( requestType.equals( "UpdateProfilePic" ) )
		{
			errLogger_.logMsg( "Info::UserAcctMgmtController.manageUserAccount( ) - Update Profile Settings"
			                ...
			                + ">" );
                        userAcctMgmtData.userProfileData_.profilePicture_=FileUploadPath.getFileUploadPath(request);
                        //System.out.println("userAcctMgmtData.userProfileData_.profilePicture_2"+userAcctMgmtData.userProfileData_.profilePicture_);
                        
                        //System.exit(0);
                        userAcctMgmtData.userProfileData_.user_Store_profile_=FileUploadPath.getFileDatabasePath(request, "");
                        userAcctMgmtData.userProfileData_.user_url_path=request.getServletContext().getRealPath("/").replace("\\", "/");
	...
	public int updateProfilePic( UserProfileData profileData )
	{
		UserAcctManager userAcctManager = new UserAcctManager( );
                ...
                //System.out.println("kk-->>"+profileData.profilePicture_);
                //System.exit(0);
