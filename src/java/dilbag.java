    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("typ") != null) {
            ...
            if (request.getParameter("typ").equals("crt_usr_fldr")) {
                File dir = new File("/home/lokesh/Dilbag/" + request.getParameter("fldr_nm").trim());
                if (dir.exists()) {
            ...
            if (request.getParameter("typ").equals("gt_usr_fldrs")) {
                ...
                File f = new File("/home/lokesh/Dilbag");
                ...
                if (files != null) {
                    for (int i = 0; i < files.length; i++) {
                        File file = files[i];
                        if (file.isDirectory()) {
                            out.print("<li id=" + file.getName() + " onclick=\"javascript:opn_fldr_fls('" + file.getName() + "')\";>&nbsp;&nbsp;<div class='folder folder_closed_top_one'></div>" + file.getName() + "</li>");
                        }
                    }
                }
            }
            if (request.getParameter("typ").equals("gt_usr_fldrs_fls")) {
                int count = 0;
                File f = new File("/home/lokesh/Dilbag/" + request.getParameter("fldr_nm"));
                File[] files = f.listFiles();
            ...
            if (request.getParameter("typ").equals("gt_cmpny_fldrs")) {
                ...
                if (files != null) {
                    for (int i = 0; i < files.length; i++) {
                        File file = files[i];
                        if (file.isDirectory()) {
                            out.print("<li style='width:165px;' id=" + file.getName() + " onclick=\"javascript:opn_cmpny_fldr_fls('" + file.getName() + "')\";>&nbsp;&nbsp;<div class='folder folder_closed_top_one'></div>" + file.getName() + "</li>");
                        }
                    }
                }
            }
            ...
            if (request.getParameter("typ").equals("dlt_usr_fldr")) {
                //out.print("fldr_nm"+request.getParameter("fldr_nm"));
                File f = new File("/home/lokesh/Dilbag/" + request.getParameter("fldr_nm"));
            ...
            if (request.getParameter("typ").equals("dlt_usr_fl")) {
                //out.print("/home/lokesh/Dilbag/" + request.getParameter("fldr_nm")+"/" + request.getParameter("fl_nm"));
                File f = new File("/home/lokesh/Dilbag/" + request.getParameter("fldr_nm")+"/" + request.getParameter("fl_nm"));
                if(f.exists())
                {
                    f.delete();
                }
...
"                                        <th class=\"rowBorder\">Zip Code</th>\n" +
"					<th class=\"rowBorder\" style=\"border-right:1px solid #c8c8c8\">Email</th>\n" +
"				</tr>\n" +
"			</thead>";
                    while (rs.next()) {
