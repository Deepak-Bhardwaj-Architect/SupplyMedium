...
public class TimeBasedReportTest
{
	...
	if( result == 10220  )
	{
		errorMaster_.insert( "TimeBasedReport fetchDaily test successfully completed" );
	...
	{
		errorMaster_.insert( "TimeBasedReport fetchDaily test failed" );
	}
	...
	public void fetchTestMonthly()
	{
		...
		if( result == 10220  )
		{
			errorMaster_.insert( "TimeBasedReport fetchMonthly test successfully completed" );
		...
		{
			errorMaster_.insert( "TimeBasedReport fetchMonthly test failed" );
		}
    ...
    public void fetchTestYearly( )
    {
	    ...
	    {  
			...
			errorMaster_.insert( "date" +datestr);
		...
		if( result == 10220  )
		{
			errorMaster_.insert( "TimeBasedReport fetchYear test successfully completed" );
		...
		{
			errorMaster_.insert( "TimeBasedReport fetchYear test failed" );
		}
    ...
    public void fetchTestQuarterly( )
    {
		...
		if( result == 10220  )
		{
			errorMaster_.insert( "TimeBasedReport fetchQuarterly test successfully completed" );
		...
		{
			errorMaster_.insert( "TimeBasedReport fetchQuarterly test failed" );
		}
