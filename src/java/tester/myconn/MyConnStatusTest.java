...
public class MyConnStatusTest
{
	...
	public void addConnTest()
	{
		...
		if( result == 10000 )
		{
			errorMaster_.insert( "Add connection test successfully completed" );
		}
		else
		{
			errorMaster_.insert( "Add connection text failed" );
		}
	...
	public void acceptConnTest()
	{
		...
		if( result == 10010 )
		{
			errorMaster_.insert( "Accept connection test successfully completed" );
		}
		else
		{
			errorMaster_.insert( "Accept connection test failed" );
		}
	}
	...
	public void rejectConnTest()
	{
		...
		if( result == 10020 )
		{
			errorMaster_.insert( "Reject connection test successfully completed" );
		}
		else
		{
			errorMaster_.insert( "Reject connection test failed" );
		}
	}
}
