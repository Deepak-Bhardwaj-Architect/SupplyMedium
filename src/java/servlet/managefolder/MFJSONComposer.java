		...
		if( responseCode == 7800 )
		{
			...
			for( GroupData groupData : groupDataList )
            {
				...
				for( UserProfileData profileData: groupData.profileDataList_ )
                {
	                ...
	                errorMaster_.insert( "Profile Arr size: "+ groupData.profileDataList_.size( )+", profileIter: "+profileIter );
				...
				errorMaster_.insert( "group data list size: " + groupDataList.size( )
				        + ", iterator: " + iterator );
	...
	public String composeUserListJSON( int responseCode, List<UserProfileData> profileDataList )
	{
		...
		//	jsonMap.put( "result", "success" );
			...
			for( UserProfileData profileData : profileDataList )
			{
				...
				errorMaster_.insert( "Profile Arr size: " + profileDataList.size( )
		...
		//	jsonMap.put( "result", "success" );
			...
			for( DeptData deptData : deptDataList )
            {
				...
				for( DeptFolderData folderData: deptData.deptFolderDataList_ )
                {
	                ...
	                errorMaster_.insert( "folderArr size: "+ deptData.deptFolderDataList_.size( )+", profileIter: "+profileIter );
				...
				errorMaster_.insert( "Dept data list size: " + deptDataList.size( )
				        + ", iterator: " + iterator );
