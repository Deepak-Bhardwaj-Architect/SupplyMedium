...
public class RegnValidationServlet extends HttpServlet
{
	        ...
	        throws ServletException, IOException
	{
		...
		else if( fieldName.equals( "companyid" ) ) // Check company id already
                                                          // exist
		{
		String companyId = request.getParameter( "companyid" );
		
		result = regnCtrlObj.isCompanyIdExist( companyId );
		}
		...
		if( fieldName.equals( "phoneno" ) || fieldName.equals( "companyid" ) || fieldName.equals( "member" )  )
		{
			if( result )
			{
