...
public class SmProperties {
    ...
    public static final String pathUrl=serverUrl;

    public static final String dataLocalUrl="http://localhost:8084/zData/cropData/";
    public static final String dataServerUrl="http://supplymedium.in:8080/zData/cropData/";
    public static final String dataPathUrl=dataServerUrl;
    
    public static final String urlPath=pathUrl;    
    public static final String dataUrlPath=dataPathUrl;    
    ...
    public static final String emailUrl=emailServerUrl;
