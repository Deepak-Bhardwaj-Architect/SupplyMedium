    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
           ...
           String email=request.getParameter("emailId");
            ...
            response.sendRedirect("emailUserActivate.jsp?email="+email+"&key="+key);
//            int result=UserMaster.activateAccount(email,key);
//            if(result>0)
//                response.sendRedirect("confirmationResponse.jsp");
        } finally {
            out.close();
        }
    }
