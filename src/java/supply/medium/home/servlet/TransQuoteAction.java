 ...
 * @author Intel
 */
public class TransQuoteAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String rfqKey = "0";
            String status = request.getParameter("quoteAction");
            String transactionKey = request.getParameter("quoteKey");
            TransactionQteMaster.updateTransStatus(transactionKey, status);
            HttpSession session = request.getSession(true);
            String inquireType = "QTE";
            String vrKey = transactionKey;
...
//                out.print(inquireFrom+userKeyFrom+inquireTo+userKeyTo);
            ...
            if (status.equals("Inquired")) {
                ...
                InquiryMaster.insert(inquireType, vrKey, rfqKey, transactionKey, inquireTo, inquireFrom, inquireDetails);
                    NotificationMaster.insert(userKeyTo, userKeyFrom, inquireTo, inquireFrom, "Quote", vrKey, "Quote " + status);
                }
                ...
                InquiryMaster.insert(inquireType, vrKey, rfqKey, transactionKey, inquireFrom, inquireTo, inquireDetails);
                    NotificationMaster.insert(userKeyFrom, userKeyTo, inquireFrom, inquireTo, "Quote", vrKey, "Quote " + status);
                }
