...
public class TransQuoteToPoDecode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String poTransQteKey=request.getParameter("qTransRfqKey");
            ...
            transPoKey = TransactionPoMaster.insertPo(transPoKey,companyKeyFrom,companyKeyTo,
                    userKeyFrom,userKeyTo,transactionType,poTransQteKey,poNo, transStatus, transAction, quoteRef,
                    isOutside, isOutsideAddress,recurring,totalAmount,taxPercent,billingAmount,isPoCreated);
            NotificationMaster.insert(userKeyFrom, userKeyTo, companyKeyFrom, companyKeyTo, "PO", transPoKey, "PO Generated");
            ...
            TransactionQteMaster.updatePoGenerated(poTransQteKey, "yes");
        ...
        {
            ErrorMaster.insert("Exception on TransQuoteToPoDecode : "+e.getMessage());
        } finally {
            out.close();
        }
    }
