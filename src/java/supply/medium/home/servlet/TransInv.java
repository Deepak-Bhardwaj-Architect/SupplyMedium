...
public class TransInv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String quantityFreightUnit = request.getParameter("quantity_freight_units");
            ...
            NotificationMaster.insert(userKeyFrom, userKeyTo, companyKeyFrom, companyKeyTo, "INV", transKey, "INV Generated");
...
//                    multiplier = itemDetail[9];
                ...
                shipedQuantityUnitKey[i]=QuantityTypeMaster.showKeyByCode(shipedQuantityUnitKey[i]);
                currencyKey[i]=CurrencyMaster.showKeyByCode(currencyKey[i]);
                    TransactionInvItemMaster.insertInvItem(transKey, invNo, itemKey[i], partNo[i], barcode[i], quantity[i], quantityUnitKey[i], shipedQuantity[i], shipedQuantityUnitKey[i], "2015-01-01", price[i], currencyKey[i], multiplier[i]);
                //}
