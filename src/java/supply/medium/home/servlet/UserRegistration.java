...
public class UserRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		am.composeAndSendMail( to, sub, message.toString( ),"SM Registration" );
            ...
            String source=SmProperties.folderPath+"no_image_icon.png";
            String target=SmProperties.folderPath+"company-"+companyKey+"\\"+userKey+".png";
            FileCopy.copyCompleteFile(source, target);

            target=SmProperties.folderPath+"users\\"+userKey+".png";
            FileCopy.copyCompleteFile(source, target);
