...
public class TransRfq extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            NotificationMaster.insert(userKeyFrom, userKeyTo, companyKeyFrom, companyKeyTo, "RFQ", transRfqKey, "RFQ Genrated");
...
//                System.out.println("itemKey" + itemKey[i]);
//                System.out.println("partNo" + partNo[i]);
//                System.out.println("barcode" + barcode[i]);
//                System.out.println("quantity" + quantity[i]);
//                System.out.println("quantityUnitKey" + quantityUnitKey[i]);
//                System.out.println("shipDate" + shipDate[i]);
