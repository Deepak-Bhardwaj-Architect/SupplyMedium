 ...
 * @author Intel
 */
public class TranPoAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String rfqKey = "0";
            String status = request.getParameter("poAction");
            String transactionKey = request.getParameter("poKey");
            TransactionPoMaster.updateTransStatus(transactionKey, status);
            HttpSession session = request.getSession(true);
            String inquireType = "PO";
...
//                out.print(inquireFrom+userKeyFrom+inquireTo+userKeyTo);
            ...
            if (status.equals("Inquired")) {
                ...
                InquiryMaster.insert(inquireType, vrKey, rfqKey, transactionKey, inquireTo, inquireFrom, inquireDetails);
                    NotificationMaster.insert(userKeyTo, userKeyFrom, inquireTo, inquireFrom, "PO", vrKey, "PO " + status);
                }
                ...
                InquiryMaster.insert(inquireType, vrKey, rfqKey, transactionKey, inquireFrom, inquireTo, inquireDetails);
                    NotificationMaster.insert(userKeyFrom, userKeyTo, inquireFrom, inquireTo, "PO", vrKey, "PO " + status);
                }
