...
public class NotificationMaster {
    ...
    public static ArrayList showNotiifcationTypeCount(String userKey) {
        ...
        try {
            con = MyConnection.connect();
            st = con.createStatement();
            query = "select notification_type,count(*),replace(replace(notification_type,'@#@Buyer',''),'@#@Supplier','') as nt from notification_master where status='Unread' and user_key_to='" + userKey + "' group by nt;";
