...
public class UserMaster {
    ...
    public static String getPhoneByAdminEmail(String email) {
        String result = "";
        Connection con = null;
        Statement st = null;
        ResultSet rs = null;
        try {
            ...
            ErrorMaster.insert("Exception at getPhoneByAdminEmail in UserMaster : " + ex.getMessage());
        } finally {
            try {
                st.close();
                con.close();
            } catch (Exception ex) {
                ErrorMaster.insert("Exception at closing getPhoneByAdminEmail in UserMaster : " + ex.getMessage());
            }
        }
        return result;
    }
    ...
    public static int showUserCount(String companyKey) {
        Connection con = null;
        Statement st = null;
        ResultSet rs = null;
        CompleteUserBean cub = null;
        ...
        try {
            ...
            ErrorMaster.insert("Exception at showUserCount in UserMaster : " + ex.getMessage());
        } finally {
            try {
                rs.close();
                st.close();
                ...
                ErrorMaster.insert("Exception at closing showUserCount in UserMaster : " + ex.getMessage());
            }
        }
        return result;
    }
    ...
    public static ArrayList showNonExistingUserInGroup(String companyKey, String groupKey) {
        ...
        try {
            con = MyConnection.connect();
            st = con.createStatement();
            String query = "SELECT user_key,first_name,last_name FROM user_master "
                    + "where company_key='" + companyKey + "' and "
                    + "user_key not in(SELECT user_key FROM group_user_master "
    ...
    public static ArrayList showExistingUserInGroup(String companyKey, String groupKey) {
        ...
        try {
            ...
            String query = "SELECT user_key,first_name,last_name FROM user_master "
                    + "where company_key='" + companyKey + "' and "
                    + "user_key in(SELECT user_key FROM group_user_master "
                    + "where group_key='" + groupKey + "')"
                    + " order by first_name";
            rs = st.executeQuery(query);
            al = new ArrayList();
    ...
    public static ArrayList showNonExistingUserInDepartment(String companyKey, String departmentKey) {
        ...
        try {
            ...
            String query = "SELECT user_key,first_name,last_name FROM user_master "
                    + "where company_key='" + companyKey + "'"
//                    + " and user_key not in(SELECT user_key "
//                    + "FROM department_user_master "
//                    + "where company_key='" + companyKey + "')"
    ...
    public static ArrayList showExistingUserInDepartment(String companyKey, String departmentKey) {
        ...
        try {
            ...
            String query = "SELECT user_key,first_name,last_name FROM user_master "
                    + "where company_key='" + companyKey + "' and "
                    + "user_key in(SELECT user_key FROM department_user_master "
                    + "where department_key='" + departmentKey + "')"
                    + " order by first_name";
            rs = st.executeQuery(query);
            al = new ArrayList();
