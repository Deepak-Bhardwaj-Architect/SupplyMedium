...
public class TransactionInvMaster {
    ...
    public static String insertInv(String trans_key, String company_key_from, String company_key_to,
        ...
        Connection con = null;
        Statement st = null;
        freight_weight_unit = QuantityTypeMaster.showKeyByCode(freight_weight_unit);
        try {
            ...
            String query = "insert into transaction_master "
                    ...
                    + "shipped_date,is_nonpo_invoice,po_num,is_diff_address,diff_address,is_inv_paid,inv_paid_on_dated,inv_del)"
                    ...
                    + "'" + is_diff_address + "','" + diff_address + "','no',sysdate(),'No')";
    ...
    public static double showTotalTransactionVolume(String companyKey) {
        Connection con = null;
        Statement st = null;
        ResultSet rs = null;
        CompanyDetailAddressBean ub = null;
    ...
    public static int deleteTransactionInv(String transKey) {
        int result = 0;
        Connection con = null;
        Statement st = null;
        transKey=transKey.replace("INV", "");
        try {
            con = MyConnection.connect();
            st = con.createStatement();
            String query = "update transaction_master "
            ...
            ErrorMaster.insert("Exception at deleteTransactionInv in TransactionPoMaster : " + ex.getMessage());
        } finally {
            try {
                st.close();
                con.close();
