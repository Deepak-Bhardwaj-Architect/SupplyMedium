...
public class GlobalProductItemMaster {
    ...
    public static ArrayList showAll() {
        ...
        try {
            ...
            st = con.createStatement();
            String query = "select * "
                    + "from product_master order by item_key desc";
            rs = st.executeQuery(query);
            al = new ArrayList();
            while (rs.next()) {
                pb = new GlobalProductItemBean();
            ...
            ErrorMaster.insert("Exception at showAll in GlobalProductItemMaster : " + ex.getMessage());
        } finally {
            try {
                rs.close();
                st.close();
                ...
                ErrorMaster.insert("Exception at closing showAll in GlobalProductItemMaster : " + ex.getMessage());
            }
        }
        return al;
    }
