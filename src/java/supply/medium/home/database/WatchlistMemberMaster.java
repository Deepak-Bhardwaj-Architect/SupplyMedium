...
public class WatchlistMemberMaster {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                else
                {
                    ...
                    {
                        if(wb.getUserKey().equals(""+al2.get(i)))
                        {
                            flag++;
                        }
                    } 
    ...
    public static int delete(String watchlistMemberKey,String watchlistKey) 
    {
        int result = 0;
        Connection con = null;
        Statement st = null;
        try {
            ...
            String query = "delete from watchlist_member_master "
                    + "where user_key in("+watchlistMemberKey+") and watchlist_key in("+watchlistKey+")";
            result = st.executeUpdate(query);
        } catch (Exception ex) {
