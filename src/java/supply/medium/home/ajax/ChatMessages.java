...
public class ChatMessages extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String messageKey = System.currentTimeMillis() + 1+"";
            String messageKey2 = System.currentTimeMillis() + 2 +"";
            ...
            MessageMaster.insert(messageKey2, userKeyTo, userKeyFrom, "@#@#@"+userKeyFrom+"@@##@@"+message);
            NotificationMaster.insert(userKeyFrom, userKeyTo, companyKeyFrom, companyKeyTo, "Chat", messageKey, message);
        }
        catch(Exception e)
        {
