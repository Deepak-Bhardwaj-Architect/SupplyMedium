        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("slct_cmnt") != null) {
                ...
                for (int i = 0; i < feedCommentList.size(); i++) {
                    ...
                    out.print("<li style='background:#FFFFFF;margin-top:10px;padding:10px;height:auto;border-radius:10px;'><p style='color:#2E2E2E'>" + scb.getComment() + "</p><p style='color:#A4A4A4;margin-left:450px;'>" + scb.getCommentedOn() + "</p></li>");
                }
            }
            if (request.getParameter("selectInternalFeedComment") != null) {
                ...
                for (int i = 0; i < feedCommentList.size(); i++) {
                    scb = (FeedCommentBean) feedCommentList.get(i);
                    out.print("<li style='background:#FFFFFF;margin-top:10px;padding:10px;height:auto;border-radius:10px;'><p style='color:#2E2E2E'>" + scb.getComment() + "</p><p style='color:#A4A4A4;margin-left:330px;'>" + scb.getCommentedOn() + "</p></li>");
                }
            }
