...
public class AllPrivilegesData
{
	...
	public void show( )
	{
		...
		System.out.println( "userPrivilegesdata_	= " + userPrivilegesdata_ );

		System.out.println( "deptPrivilegesDataArr_	= " + deptPrivilegesDataArr_ );

		System.out.println( "manageFolderPrivilegesDataArr_	= "
