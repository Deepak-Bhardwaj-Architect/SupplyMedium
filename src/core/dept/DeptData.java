...
public class DeptData
{
	...
	public void show( )
	{
		System.out.println( "deptKey_				= " + deptKey_.companyRegnKey_.companyPhoneNo_+":"+deptKey_.deptName_ );
		//System.out.println( "companyRegnKey_		= " + companyRegnKey_ );
		System.out.println( "deptName_				= " + deptName_ );
		System.out.println( "deptFolderDataList_ size = " + deptFolderDataList_.size( ) );
	}
