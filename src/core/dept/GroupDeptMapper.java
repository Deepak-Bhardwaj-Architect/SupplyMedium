...
public class GroupDeptMapper
{
	...
	public int remove( DeptKey deptKey,List<GroupData> groupDataArr )
	{
		...
		System.out.println( "remove group from dept" +groupDataArr.size( ) );
	...
	public int getGroups( DeptKey deptKey,List<GroupData> groupDataArr )
	{
		...
		System.out.println( "allgroups count="+allGroups.size( )
		...
		try
        {
			...
			for( GroupData groupData : allGroups )
	        {
				...
				{
					//System.out.println( "all groupname="+ groupData.groupName_+"group groupname="+ groupData2.groupName_);
