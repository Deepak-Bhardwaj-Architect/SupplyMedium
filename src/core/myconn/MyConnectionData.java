...
public class MyConnectionData
{
	...
	public void show( )
	{
		...
		System.out.println( "fromUserKey_	="+ fromUserKey_.toString( ));
		...
		System.out.println( "toUserKey_		="+ toUserKey_.toString( ));
		
		System.out.println( "toRegnKey_		="+ toRegnKey_.toString( ));
		
		System.out.println( "Image path     ="+ userProfileImagePath_ );
		
		
		System.out.println( "status_		="+ status_);
		
		System.out.println( "timeStamp      ="+ createdTimestamp_);
