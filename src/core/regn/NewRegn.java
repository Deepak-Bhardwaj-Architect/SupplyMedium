...
public class NewRegn implements RegnProcess
{
	...
	public int process( RegnData regnDataObj )
	{
		...
		System.out.println( "**************LogoImage successfully stored**********************" );
		...
		System.out.println( "*************Adding company address details**********************" );
		...
		System.out.println( "*************Adding Admin profile details*********************" );
		...
		System.out.println( "************* Adding Admin login details*********************" );
		...
		System.out.println( "************* Get and set default account policies details *********************" );
		...
		System.out.println( "************* Set default privileges for admin *********************" );
		...
		System.out.println( "Notification settings insertion result: "+result );
		
		notifySettings = null;
		
		notifySettingsData = null;
		
		System.out.println( "************* Get and set default wh settings *********************" );
		...
		System.out.println( "WH settings insertion result: "+result );
		
		whSettings = null;
		
		whData = null;
		
		System.out.println( "************* Company details added successfully now send email *********************" );
		...
		//System.out.println( "Success - New registration" );
