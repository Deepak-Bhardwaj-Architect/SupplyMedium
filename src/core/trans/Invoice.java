...
public class Invoice
{
	...
	public int add( InvoiceData invoiceData)
	{
		...
		System.out.println( "GetMax Value = " + result );
	...
	public int get( CompanyRegnKey regnKey, UserProfileKey userKey, List<InvoiceData> invoiceList )
	{
		...
		System.out.println( "fetch invoice core" );
	...
	public int update( InvoiceData invoiceData )
	{
		...
		System.out.println( " status="+ invoiceData.status_);
...
*/
	...
	{
		System.out.println( "Invoice data status="+invoiceData.status_ );
	...
	private int sendInvoiceMail( InvoiceData invoiceData )
	{
		...
		try
        {
			...
			{
				System.out.println("Outside Supplier");
				
				
				to[0] = invoiceData.outsideBuyerEmail_;
				
				
				String subject = "Invoice from "+invoiceData.fromCompanyProfileData_.companyName_;
