...
public class RFQ
{
	...
	public int add( RFQData rfqData)
	{
		...
		System.out.println( "can send mail"+canSendMail);
		
		if(canSendMail)
		{
			System.out.println( "----------------------RFQ mail---------------------------");
			sendRFQMail( rfqData );
		}*/
	...
	{
		System.out.println("rfq core start");
		...
		System.out.println( "rfq core End");
		return 8010;
	}
	...
	private int sendRFQMail( RFQData rfqData )
	{
		try
        {
			...
			if( rfqData.isOutsideSupplier_ == 1 && rfqData.outsideSupplierEmailFlag_ == 1)
			{
				...
				String subject = "RFQ from "+rfqData.fromCompanyProfileData_.companyName_;
