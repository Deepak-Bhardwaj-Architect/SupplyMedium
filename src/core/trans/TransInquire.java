...
public class TransInquire
{
	...
	{
		System.out.println( "action 1="+inquireData.action_);
		...
		System.out.println( "action 2="+inquireData.action_);
		...
		System.out.println( "action 3="+rfqData.status_);
		...
		System.out.println( "action 4="+inquireData.action_);
	...
	private int addQuoteInquire( TransInquireData inquireData )
	{
		...
		System.out.println( "action 3="+quoteData.status_);
	...
	private int addPOInquire( TransInquireData inquireData )
	{
		...
		System.out.println( "action 3="+poData.status_);
	...
	private int addInvoiceInquire( TransInquireData inquireData )
	{
		...
		System.out.println( "action 3="+invoiceData.status_);
