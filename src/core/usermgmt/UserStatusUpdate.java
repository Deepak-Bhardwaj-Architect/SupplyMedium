...
public class UserStatusUpdate implements UserSignupProcess
{
	...
	public int process( UserProfileData signupDataObj )
	{
		...
		{
			System.out.println( "Update status only" );
		...
		{
			System.out.println( "Update and activate user" );
			...
			if( emailResult == 0 )
			{
				...
				System.out.println( "Change activation record to login record - progress 1" );
				...
				if( loginDataRes == 0 )
				{
					...
					if( loginVal == 0 )
					{
						...
						{						
    						...
    						System.out.println( "Activation table deleting  - key value : "
    						        + userKey.email_ );
    						...
    						System.out.println( "Change activation record to login record - progress 3" );
