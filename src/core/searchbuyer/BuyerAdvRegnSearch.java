...
/**
 * File:  BuyerAdvRegnSearch.java 
 *
 * Created on Jul 19, 2013 7:07:52 PM
 */

public class BuyerAdvRegnSearch implements AdvBuyerSearch
{
	private ErrorLogger errLogger_;
	
	/**
	 * Method : BuyerAdvRegnSearch( ) - constructor Input : Return :
	 * 
	 * Purpose: It is used initialization
	 */
	
	public BuyerAdvRegnSearch()
	{
            ...
            List<BuyerSearchResult> searchResultList )
    {
		...
		else // the list is not empty, i.e. there EXISTS item names/part numbers to search from.
		{
			...
			{
				System.out.println( "rfqItemCompanyKeys is null !!" );
				return 3303;
