...
public class BuyerBasicRegnSearch implements BasicBuyerSearch
{
            ...
            List<BuyerSearchResult> searchResultList )
    {
		...
		System.out.println(  "Buyer CompanyKeys before retainAll size:" + buyerCompanyKeys.size( ) );
				 ...
				 !( searchOptionObj.keyword_.trim( ).equalsIgnoreCase( "" ) ) )
		{
			...
			System.out.println(  "BuyersByKeyword size:" + buyersByKeyword.size( ) );
			System.out.println(  "BuyersCompanyKeys size:" + buyerCompanyKeys.size( ) );
