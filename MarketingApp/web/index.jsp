...
<html>
    ...
    <body>
        ...
        <div class="pagetitlecontainer">
            <div class="pagetitle">Supply Medium Marketing Console</div>
        </div>	 
                ...
                <form name="loginform" id="loginform" method="post" action="CheckLogin">
                    ...
                    <div class="loginleft">
                        <div class=" loginlbl labellink">
                            <input type="text" name="email" value="" id="email" class="required email textbox" style="width: 290px;">
                        </div>
                        <div class=" loginlbl labellink" style="margin-bottom: 20px;">
                            <input type="password" value="" name="password" id="password" class="required textbox" style="width: 290px;">
