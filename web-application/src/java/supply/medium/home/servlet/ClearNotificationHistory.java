 ...
 * @author LenovoB560
 */
public class ClearNotificationHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            NotificationMaster.delete(session.getAttribute("userKey").toString());
            MemoryTest.test("footer start");
                System.gc();
                MemoryTest.test("footer end");
            response.sendRedirect("homeNotification.jsp");
        } finally {
            out.close();
        }
    }
