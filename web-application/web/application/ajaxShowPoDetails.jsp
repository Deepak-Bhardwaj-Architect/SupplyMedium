...
String nme=null;
    ...
    else
    {
        ...
        <div style="float: right;width:100px;" onclick="window.location.href='';">
            <a onClick="this.href = '<%=request.getRealPath("") + File.separator + "cropData/company-"+session.getAttribute("companyKey")+"/transaction/PO"+request.getParameter("poKey")+".pdf" %>'" target="_blank">
                ...
                <div class="mCustomScrollBox mCS-dark-thick" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;">
                    <div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                        ...
                        <div class="items" id="popup_items">         
                                ...
                                <input type="text" autocomplete="off" class="textbox" maxlength="12" id="quantity1" style="width:28px;" disabled="" value="<%=transactionPoItemBean.getQuantity()%>">
                        ...
                        <div id="supplier_ctrls" class="supplier_controls">
                            ...
                            <%
                            if(!qtb.getPo_trans_status().equalsIgnoreCase("Accepted"))
                            {
                            %>
