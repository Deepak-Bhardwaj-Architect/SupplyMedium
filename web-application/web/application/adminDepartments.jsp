...
%>                                    
                                ...
                                <div class="deptlistbox">
                                    ...
                                    <select class="deptlistsel listbox" name="deptlistsel" id="deptlistsel" size="5" onChange="$('#departmentKey').val(this.value);showDeptPrev(this.value);showNonExistingUserInDepartment();showExistingUserInDepartment();showNonExistingGroupInDepartment();showExistingGroupInDepartment();showNonExistingFolderInDepartment();showExistingFolderInDepartment();//getDeptData(this.value);">
                                        <% 
                            ...
                            <!-- Privileges settings -->
                            <div class="deptpriv" id="showDepartmentPerm">
                            </div>
                            <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
