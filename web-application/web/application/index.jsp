...
<%@page import="supply.medium.home.mailing.EmailApi"%>
...
/* 
            String to[]={"kakkar.lokesh@gmail.com"};
            HTMLMailComposer obj = new HTMLMailComposer();
            String message=obj.composeInvitationMail("Company Name", "Sender Name");
            String path = request.getRealPath("") + File.separator + "cropData";
            String file = "mugshot.png";
            new EmailApi().normalMail(to,"SM Registration Activation",message,"SM Registration");
            //new EmailApi().attachmentMail(to,"SM Transaction Activation",message,path,file);
 */
        %>
    </HEAD>
    <BODY>
