                                    ...
                                    <table id="quote_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="quote_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr <%=stl%> onclick="$('#quote_popup').fadeIn();
                                                ...
                                                <td class="rowBorder"><a target="_blank" href="<%=request.getRealPath("") + File.separator%>cropData/company-<%=companyKey%>/transaction/<%=trb.getQ_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                }
                                                if (al.size() == 0) {
