                    ...
                    <div class="content cpcontent" style="height:auto!important;width:942px!important;">
                        <div style="float:left;margin-bottom:50px;">
                            ...
                            <div class="pricingContent" style="width:432px;">
                                ...
                                <div class="row" style="height:40px;">
                                    <span style="color:green;">After 2 registered users, USD $1.99 per user per month will be charged</span>
                                </div>
                                <div class="row" style="height:40px;">
                                </div>
                                <!--<div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:40px;">
                                    <span style="color:green;">After usage of first 100MB free space, USD $1.99 per 100MB annually will be charged.</span>
                                </div>
                                <div class="row" style="height:40px;">
                                </div>
                                <div class="Sub_Heading">		
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=(usersLic1979 * 1.99)%> per month
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=charges1979%> per month
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl" style="color:green;"> Total Charges
                                    </label>
                                    <label class="valuelbl" style="color:green;">:&nbsp;&nbsp;USD $<%=total1979%> per month
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">
                                        <input type="button" value="Pay via Paypal" style="float:right;width:180px;" class="general-button gen-btn-Orange" onClick="javascript:$('#rtrn').val($('#rtrn').val()+'?amt=<%=total1979%>');$('#amnt').val('<%=total1979%>');document.forms['paypalForm'].submit();" />
                                    </label>
                                </div>
                                <div class="row" style="height:30px;margin:40px 0;">
                                    <img style="cursor: pointer;" src="inside/paypal.jpg" border="0" height="100" alt="PayPal Logo" title="Proceed to Pay"  onclick="$('#amnt').val('<%=total1979%>');document.forms['paypalForm'].submit();">
                                </div>
                            </div>
                        </div>
                    </div>
