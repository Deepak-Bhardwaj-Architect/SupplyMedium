                ...
                <div id="trans_super_container" style="">
                    ...
                    <div id="trans_content" class="trans_content" style="display: block;">
                        ...
                        <form id="paypalForm" name="paypalForm" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                            ...
                            <input type="hidden" id="item_name" name="item_name" value="Plan">
                            <input type="hidden" id="amnt" name="amount" value="0">
                            <input type="hidden" name="bn" value="PP-BuyNowBF:btn_paynowCC_LG.gif:NonHosted">
                            <input type="hidden" id="rtrn" name="return" value="<%=SmProperties.emailUrl%>transactionPayments.jsp">
                            <input type="hidden" id="cncl_rtrn" name="cancel_return" value="<%=SmProperties.emailUrl%>transactionPayment.jsp">
                        </form>
                                    ...
                                    <table id="invoice_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="invoice_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                    ...
                                                    if (companyKey.equals(trb.getCompany_key_from())) {
                                                        ...
                                                        if (cstatus.equals("Accepted")) {
                                                            if (trb.getIs_inv_paid().equalsIgnoreCase("no")) {
                                                                cstatus = "<a style='text-decoration: underline;color:blue;' onclick=\"javascript:$('#rtrn').val($('#rtrn').val()+'?id="+trb.getTrans_key()+"&amt="+trb.getInv_total_billing_amount()+"');$('#item_name').val('SupplyMedium Invoice No: "+trb.getInv_trans_rqf_key()+"');$('#amnt').val('"+trb.getInv_total_billing_amount()+"');$('#paypalForm').submit();\">Make a Payment</a>";
                                                            } else {
                                                                cstatus = "Payment Done";
                                                            }
                                                        } else if (cstatus.equals("Inquired")) {
                                            ...
                                            <tr <%=stl%> onclick="$('#invoice_popup').fadeIn();
                                                ...
                                                <td class="rowBorder"><a target="_blank" href="<%=request.getRealPath("") + File.separator%>cropData/company-<%=companyKey%>/transaction/<%=trb.getInv_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                }
                                            }
                        ...
                        <div id="invoice_form_content" style="display:none;" class="invoice_form_content">
                            ...
                            <div class="invoice_form">
                                ...
                                <div class="invoice_form_btns">
                                    ...
                                    <input type="button" class="gen-btn-blue" value="Send" id="add_invoice_btn" >
                                </div>
