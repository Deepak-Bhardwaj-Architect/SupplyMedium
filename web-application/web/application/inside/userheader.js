...
//	$("#show_invite_btn" ).show();
        //alert(document.getElementById("notification_container").style.display);
//        if(document.getElementById("notification_container").style.display==="block"||document.getElementById("notification_container").style.display==="")
//        {
