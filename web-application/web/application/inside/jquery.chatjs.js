        ...
        this.addMessage = function (message, clientGuid) {
            ...
            else 
            {
                ...
                else 
                {
                   ...
                   // var $pname=$("<b/>").text( message.UserFromId).appendTo();
                    //alert($pname);
                    var $textWrapper = $("<div/>").addClass("chat-text-wrapper").appendTo($chatMessage);

                    //$textWrapper.appendTo($pname);
                    ...
                    //alert(messageUserFrom.ProfilePictureUrl);
                    if(message.UserFromId === this.opts.myUser.Id)
                    $("<b/>").addClass("dilbag-s").text(message.UserFromId).appendTo($gravatarWrapper);
                    else
                    $("<b/>").addClass("dilbag-r").text(message.UserFromId).appendTo($gravatarWrapper);
                    $("<img/>")
