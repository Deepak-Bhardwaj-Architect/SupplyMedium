...
String nme=null;
    ...
    else
    {
        ...
        <div style="float: right;width:100px;" onclick="window.location.href='';">
            <a onClick="this.href = '<%=request.getRealPath("") + File.separator + "cropData/company-"+session.getAttribute("companyKey")+"/transaction/INV"+request.getParameter("invoiceKey")+".pdf" %>'" target="_blank">
                    ...
                    <div class="mCSB_container mCS_no_scrollbar" style="invoicesition: relative; top: 0px;">
                        ...
                        <div class="invoice_supplier_det"  style="width:440px;">
                            ...
                            <div class="trans_row" style="margin-top: 50px;">
                                ...
                                <span class="customSelect selectbox customSelectDisabled" style="position: static;width: 165px; display: inline-block;">
                                    <span class="customSelectInner" style="width: 142px; display: inline-block;position:none!important;">None</span>
                                </span>
                            </div>
                        </div>
                        <div class="items_head" style="margin-bottom:20px;">
                            <div class="items_head" style="padding-left:3px;">
                                ...
                                <label class="trans_label" style="width: 55px;margin-right:4px;">Batch No</label>
                        ...
                        <div class="items" id="invoicepup_items">         
                            ...
                            <div id="item1" class="item" style="width:970px;float:left;margin-top:5px;margin-left:15px;margin-right:0px;">
                                ...
                                <input type="text" autocomplete="off" class="textbox" maxlength="12" id="quantity1" style="width:28px;" disabled="" value="<%=transactionInvItemBean.getQuantityOrdered()%>">
                                ...
                                <input type="text" autocomplete="off" class="textbox" maxlength="12" id="quantity1" style="width:28px;" disabled="" value="<%=transactionInvItemBean.getQuantityShipped()%>">
                        ...
                        <div class="price_det" id="price_det">
                            ...
                            <%
                            if (qtb.getBill_of_landing() != null && !qtb.getBill_of_landing().equals("")){
                            %>
...
<!--                                        <label class="trans_label" style="width: 200px;margin-right: 9px;">Carrier</label>-->
                        ...
                        <div class="shipping_det_content">
                                        ...
                                        <div class="quantity_unit" id="quantity_freight_unit" name="quantity_freight_unit" ><%=QuantityTypeMaster.showCodeByKey(qtb.getFreight_weight_unit()) %></div>
                        ...
                        <div id="supplier_ctrls" class="supplier_controls">
                            <%
                                if (!session.getAttribute("userKey").toString().equals(request.getParameter("supplierKey")) && (objTr.getInv_trans_status().equals("INV Sent") || objTr.getInv_trans_status().equals("Inquired"))){  %>
                            ...
                            <%
                            if(!qtb.getInv_trans_status().equalsIgnoreCase("Accepted"))
                            {
                            %>
