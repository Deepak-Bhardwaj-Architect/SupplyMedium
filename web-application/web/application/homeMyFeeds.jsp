                            ...
                            <div id="feeds" class="feeds" style="margin-left:0px;">
                                    ...
                                    <div id="feed_1" class="feed">                                        
                                        <div class="publisher_details">
                                            <div>
                                                <img src="<%=request.getRealPath("") + File.separator %>cropData/users/<%=sbcb.getUserKey()%>.png" class="publisher_photo">
                                            </div>
                                        ...
                                        <div class="feed_summary">
                                            ...
                                            <p class="feed_text"><%=feedDescription.replace("@#@#@",SmProperties.urlPath+"company-").replace("@#@",File.separator) %></p>
                                            <p>
                                            </p>
                                        </div>
