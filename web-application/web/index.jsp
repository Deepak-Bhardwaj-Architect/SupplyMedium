...
%>
                        ...
                        <%
                        for(int company=0;company<recObj.size();company++)
                        {
                        ...
                        <div class="result-set-data">
                        	...
                        	<img src="<%=SmProperties.pathUrl+"company-"+recCB.getCompanyKey()+File.separator+"company-"+recCB.getCompanyKey()+".png"%>" width="128"
                            ...
                            <div class="data-title"><%=recCB.getCompanyName()%></div>
                            </a>
                        </div>
                        <%
                        }
                    ...
                    <div class="select-query">
                        ...
                        <div class="result-set-data" style="border:none;width:220px;float:left;">
                            <a href="<%=cabs.getLinkPage()%>" style="text-decoration: none;" target="_blank">
                                ...
                                src="<%=SmProperties.pathUrl+"company-" + cabs.getCompanyKey() + File.separator + "ad" + File.separator+cabs.getImagePath()%>"
                                title="<%=cabs.getHoverText()%>" alt="<%=cabs.getHoverText()%>">
                                <h1 title="<%=cabs.getHoverText()%>" style="padding:10px 0;font-size:14px;width:100%;color:white;" align="center"><%=cabs.getHoverText()%></h1>
                            </a>
                        </div>
                        <%
                        }
                    ...
                    %>
                        ...
                        <%
                        for(int product=0;product<alGPIM.size();product++)
                        {
                            ...
                            else
                            {
                                    ...
                                    for(int i=0;i<1;i++)
                                    productImageName = request.getRealPath("") + File.separator +"cropData/products/"+pics[i].replace("@#@","");
                            }
                        %>
                        <div class="result-set-data">
                            <img src="<%=productImageName%>" width="128"
                            ...
                            <div class="bg-white-gap"></div>
                            <div class="data-title"><%=gpib.getItemName()%></div>
            ...
            <div class="clear-both"></div>
            <div id="footer"><h1>Copyright 2015. <a style="color:#fff;" href="superadmin/">Supply Medium, Inc.</a></h1></div>
        </div>
    </body>
</html>
