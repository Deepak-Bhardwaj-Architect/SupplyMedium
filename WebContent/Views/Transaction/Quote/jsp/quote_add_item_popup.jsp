...
<div style="display: none;z-index:2000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline quote_add_item_popup_outline" >
		...
		<div style="margin-top:0px;margin-left:10px;float:left;">
			...
			<div class="item" style="width:1000px;float:left;margin-left:35px;margin-right:0px;position:relative;">
