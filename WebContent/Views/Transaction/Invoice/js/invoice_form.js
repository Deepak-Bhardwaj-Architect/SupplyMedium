...
function saveItem()
{
	...
	if( $("#from_form").val()=="invoiceForm")
	{
		...
		itemDet += '<div class="quantity_unit" id="quantity_ordered_unit'+itemsCount+'" >'+quantityOrderedUnit+'</div>';
		...
		itemDet += '<div class="quantity_unit" id="quantity_shipped_unit'+itemsCount+'" >'+quantityShippedUnit+'</div>';
...
function validateInvoice()
{
	...
	{
		$("#invoice_form_error").text("The shipping date is not selected.");
