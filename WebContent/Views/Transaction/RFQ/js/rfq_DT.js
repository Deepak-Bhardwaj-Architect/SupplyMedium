...
function parseRFQRequest( rfqArr )
{
	...
	for( var i=0;i<rfqArr.length;i++)
	{
		...
		rfqDataTable.fnAddData([transImg,RFQId,RFQDate,fromCompName,fromRegnKey,fromUserKey,fromState+inquireChat,status,
				...
				items,trans,inquires,transId,isQuoteCreated]);
	}
