...
function parsePORequest( poArr )
{
	...
	for( var i=0;i<poArr.length;i++)
	{
		...
		poDataTable.fnAddData([transImg,POId,PODate,fromCompName,fromRegnKey,fromUserKey,fromState+inquireChat,status,
				...
				items,trans,inquires,transId,totListPrice,tax,totPrice,isInvoiceCreated]);
	}
