    ...
    getTC( fromRegnKey,"Quote" );
     ...
     for(var i=0;i<rfqitems.length;i++)
     {
    	sNo=sNo+1;
 		...
 		itemDet += '<input type="text" class="textbox"  maxlength=80 id="item_desc'+itemsCount+'" style="width:170px;margin-right:20px;" disabled  value="'+item.itemDesc+'";/>';
 		...
 		itemDet += '<input type="text" class="textbox"  maxlength=7 id="quantity'+itemsCount+'" style="width:60px;"  value="'+item.quantity+'"; onblur="calculateTotal()"/>';
 		...
 		itemDet += '<input type="text"  maxlength=7 class="textbox" id="price'+itemsCount+'" style="width:60px;" onblur="calculateTotal()"/>';
 		...
 		itemDet += '<input type="text" class="textbox"  maxlength=7 id="multiplier'+itemsCount+'" style="width:85px;margin-right:20px;" onblur="calculateTotal()" />';
...
function fillPOForm( aData )
{
    ...
    getTC( fromRegnKey,"PO" );
     ...
     for(var i=0;i<items.length;i++)
     {
 		...
 		itemDet += '<input type="text" class="textbox" maxlength=7 id="price'+itemsCount+'" style="width:60px;"  value="'+item.price+'"; onblur="calculateTotal()"/>';
 		itemDet += '<div class="quantity_unit" id="currency'+itemsCount+'" >'+item.currency+'</div>';
 		itemDet += '<div class="currency_list" id="currency_currency'+itemsCount+'" style="display:none;left:689px;" ></div>';
 		
 		itemDet += '<input type="text" class="textbox" maxlength=7 id="multiplier'+itemsCount+'" style="width:85px;margin-right:20px;"  value="'+item.multiplier+'"; onblur="calculateTotal()"/>';
...
function fillInvoiceForm( aData )
{
    ...
    getTC( fromRegnKey,"Invoice" );
     ...
     for(var i=0;i<items.length;i++)
     {
		...
		itemDet += '<input type="text" class="textbox" maxlength=7 id="quantity_ordered'+itemsCount+'" style="width:60px;"  value="'+item.quantity+'"; onblur="calculateInvoiceTotal()"/>';
		itemDet += '<div class="quantity_unit" id="quantity_ordered_unit'+itemsCount+'" >'+item.quantityUnit+'</div>';
		itemDet += '<div class="quan_units" id="units_quantity_ordered_unit'+itemsCount+'" style="display:none;left:452px;"></div>';
		
		itemDet += '<input type="text" class="textbox" maxlength=7 id="quantity_shipped'+itemsCount+'" style="width:60px;"  value="'+""+'";/>';
		itemDet += '<div class="quantity_unit" id="quantity_shipped_unit'+itemsCount+'" >'+"KG"+'</div>';
		itemDet += '<div class="quan_units" id="units_quantity_shipped_unit'+itemsCount+'" style="display:none;left:574px;"></div>';
		
		itemDet += '<input type="text" class="textbox" maxlength=7 id="price'+itemsCount+'" style="width:60px;"  value="'+item.price+'"; onblur="calculateInvoiceTotal()"/>';
		itemDet += '<div class="quantity_unit" id="currency'+itemsCount+'" >'+item.currency+'</div>';
