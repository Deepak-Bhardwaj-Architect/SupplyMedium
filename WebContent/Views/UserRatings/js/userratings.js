					...
					for ( var i = 0; i < data.UserRatingList.length; i++)
					{
						...
						if (i == 0)
						{
							SM.Network.UserRatings.AddCompanyList(cmpInfo._regn_rel_key.companyPhoneNo_, cmpInfo._company_name,
									cmpInfo._logoPath, cmpInfo._avgRating, cmpInfo._rating, "selectedItem", false);
							
							SM.Network.UserRatings.getCompanyReviewList(cmpInfo._regn_rel_key.companyPhoneNo_, cmpInfo._company_name,
									cmpInfo._logoPath, cmpInfo._avgRating, cmpInfo._rating, 'firstone');
						}
						else
						{
							SM.Network.UserRatings.AddCompanyList(cmpInfo._regn_rel_key.companyPhoneNo_, cmpInfo._company_name,
									cmpInfo._logoPath, cmpInfo._avgRating, cmpInfo._rating, " ", false);
						}
					}
				}
		...
		itemselected, isreturn)
{
	...
	var temp = '<div class="ratingcompanylistrow ' + itemselected
			...
			+ '&#39;,&#39;' + companylogpath + '&#39;,&#39;' + ratingvalue + '&#39;,&#39;' + numberofrating + '&#39;,this)">'
...
SM.Network.UserRatings.getCompanyReviewList = function(companykey, companyname, companylogpath, ratingvalue, numberofrating,
		thisdiv)
{
