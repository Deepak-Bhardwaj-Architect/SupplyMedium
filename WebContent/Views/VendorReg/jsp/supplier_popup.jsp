...
<body>
	...
	<div style="display: none; z-index: 5000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline"
			style="position: fixed; width: 1010px; height: 720px; top: 50%; left: 50%;margin-top:-360px;margin-left:-505px;border-radius: 0px;">
			...
			<div id="supplier_form_popup_content" style="overflow:auto;height:655px;float:left; position:relative;margin-top:10px;margin-bottom:10px;">
			...
			<div class="ven_reg_left">
					...
					<div class="ven_reg_btns">
						...
						<input type="button" class="gen-btn-Orange" style="margin-right:50px;"  value="Send" id="send_regn_btn"/>
						<input type="button" class="gen-btn-Orange" style="margin-right:50px;"  value="Inquire" id="inquire_regn_btn"/>
					</div>	
					</form>
