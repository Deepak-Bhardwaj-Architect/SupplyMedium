...
<body>
	...
	<div style="display: none; z-index: 5000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline"
			...
			<div id="buyer_form_popup_content" style="overflow:auto;height:655px;float:left; position:relative;margin-top:10px;">
			...
			<div class="ven_reg_left">
					...
					<div class="ven_reg_btns">
						...
						<input type="button" class="gen-btn-Orange" style="margin-right:50px;"  value="Inquire" id="inquire_btn"/>
					</div>	
