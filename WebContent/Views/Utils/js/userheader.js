$(document).ready(function() {
	...
	$("#notification").click(function(e){$("#notification_container").toggle(); e.stopPropagation();$("#noti_dropdown_content").mCustomScrollbar("update");});
	
	$("#notification_count").click(function(e){$("#notification_container").toggle(); e.stopPropagation();});
