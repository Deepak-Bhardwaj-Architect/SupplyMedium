		...
		<div class="T_content_container">
			<div id="T_menu_contact_det">
				...
				<div style="margin:10px 0 0 255px;">
					<input id="btn_contact_clear"  type="button" class="general-button gen-btn-TOrange" value="Clear" />
					<input id="btn_contact_submit" type="button" class="general-button gen-btn-TOrange" value="Submit" />
				</div>
			</div>
		</div>
