...
<link rel="stylesheet" href="../css/T1_blue_common.css" />
<link rel="stylesheet" href="../css/T1_contact.css" />
	...
	<form method="post" id="T_container" class="content_container" style="padding-top: 0px;">	
		...
		<div class="T_content_container">
			<div id="T_menu_contact_det">
				<div class="T_contact_title T_hading_Title">
					Contacts
				</div>
				...
				<div style="margin:10px 0 0 255px;">
					<input id="btn_contact_clear"  type="button" class="general-button gen-btn-T1blue" value="Clear" />
					<input id="btn_contact_submit" type="button" class="general-button gen-btn-T1blue" value="Submit" />
				</div>
			</div>
		</div>
