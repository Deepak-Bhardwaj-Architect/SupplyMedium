	...
	<div class="leftcontent">
		...
		<div class="row">
			...
			<input type="radio" name="signupas" value="Buyer" id="buyerradio"
				...
				<input type="radio" name="signupas" value="Both" id="Bothradio" class="radiobtnlbl" checked/>
				<label for="Bothradio" class='radiobtn radiobtnlbl'>Both</label>&nbsp;
		</div>
		...
		<div id="canBtnDiv" >
			<a style="text-decoration:none;" href="${pageContext.request.contextPath}/index.jsp"><input
				type="button" id="" value="Cancel" class="gen-btn-Gray"
				 /></a>
		</div>
	</div>
