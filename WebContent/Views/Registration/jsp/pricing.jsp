...
<body >
	<div class="pricing" style="">
		...
		<div class="pricingtag">
			<div class="bluetag_mo pricingtagimg" id="basic">
				...
				<div class="tagdesc">
					...
					<div class="tagdescright">25 Employee license</div>
				</div>
				<div class="tagdesc">
				<div class="tagdescleft">
				<img
			...
			<div class="greentag pricingtagimg" id="plus">
				<div class="tagtitle">Plus</div>
				<div class="tagdescmed">$49.99/month</div>
				...
				<div class="tagdescright">100 Employee license
				</div>
			...
			<div class="orangetag pricingtagimg" id="premium">
				...
				<div class="tagdescmed">$99.99/month</div>
				<div class="tagdesc">
				<div class="tagdescleft">
				<img
		...
		<input type="radio" id="free" name="pricingoption" class="pricingradiobox"
			value="Basic" style="display:none;" checked="checked"/>  <input
			type="radio" id="plus" name="pricingoption" class="pricingradiobox"
			value="Plus" style="display:none;" />  <input
			type="radio" id="premium" name="pricingoption" class="pricingradiobox"
