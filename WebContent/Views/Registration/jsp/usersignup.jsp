				...
				<div class="rightcontent">
					<div class="row" style="height: 100px;">
						...
						<fieldset class="fieldset" style="width: 160px;">
							...
							<input type="radio" style="vertical-align: middle; font-size: 12px;margin:0px;" name="usertype" id="internetuser"
								class="radiobtn required" value="IntranetUser"
								style="vertical-align:middle;font-size: 12px;" /> 
							<label for="internetuser"
								style="vertical-align: middle; font-size: 12px; color: #282828">
								Intranet Only User &nbsp;</label><BR /> 
							<input type="radio" id="transuser"
								name="usertype" class="radiobtn" style="vertical-align: middle; font-size: 12px;margin:0px;"
								value="TransactionUser"
								style="vertical-align:middle;font-size: 12px;" /> 
							<label for="transuser"
								style="vertical-align: middle; font-size: 12px; color: #282828">
								Regular User&nbsp;</label> 
							<label for="usertype" generated="true"
