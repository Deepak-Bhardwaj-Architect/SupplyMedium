...
public class CompanyFolder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String userDownloadUrl = SmProperties.dataUrlPath + "company-" + session.getAttribute("companyKey") + File.separator + "user feed" + File.separator + "user-" + session.getAttribute("userKey");
            ...
            String companyDownloadUrl = SmProperties.dataUrlPath + "company-" + session.getAttribute("companyKey") + File.separator + "internal feed" + File.separator;
