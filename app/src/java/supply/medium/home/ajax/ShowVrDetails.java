...
public class ShowVrDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            {    
            result += "                   <a download target='_blank' href='" +SmProperties.dataUrlPath+"company-"+session.getAttribute("companyKey")+"/w9forms/"+ vrb.getW9taxFormPath() + "' id='w9form_link' style='font-weight:underline;color:blue;'> Click here to download the W9Form</a>";
            }
            result += "               </div>";
            result += "           </div>";
            ...
            result += "               </div>";
            result += "               <textarea class='addr_det_text' readonly id='additional_det_popup'>" + vrb.getAdditionalDetails() + "</textarea>";
            result += "           </div>";
