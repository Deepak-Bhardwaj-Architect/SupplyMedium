...
public class HTMLMailComposer {
    ...
    public String composeCompanyActivationMail(String uuid, String emailId, String firstName, String companyName, String confimationValue) {
        ...
        message.append("' width='325' height='100' style='margin-top:10px;'/></a></div>");
        ...
        message.append("<div style='height:70px;width:600px;font-size:20px;color:#434446;text-align:center;padding-left:100;margin-top:30px;'>");
        ...
        message.append("border:1px solid #c8c8c8;background-color:#fff;margin-top:80px;margin-left:100;'>");
        ...
        message.append("text-align:left;margin-top:100;margin-left:50px;'> ");
    ...
    public String composeUserSignupMail(String emailId, String firstName) {
        ...
        // Supply Medium description
        message.append("<div style='height:70px;width:600px;font-size:20px;color:#434446;text-align:center;padding-left:100'>");
        ...
        // Message
        message.append("<div style='height:70px;width:600px;font-size:22px;color:#035458;text-align:center;padding-left:100;margin-top:70px;'>");
...
//		
//		
//		message.append( "<a href=' '><img src='logo.png'  width='325' height='100' style='margin-top:10px;'/></a></div> " );
//		
//		
//		message.append( "<div style='width:100%;background-color:#f27f02;float:left'>" );
//		message.append( " <div style='height:10px;width:800px;margin-left:auto;margin-right:auto;'></div></div> " );
...
//		
//		
//		message.append( "<div style='height:100;width:800px;font-size:25px;color:#199096;text-align:center;line-height:50px;padding-top:20px;'>  Greetings from Supply Medium ! " );
//		message.append( "</div> " );
//		
//		
//		message.append( "<div style='height:70px;width:600px;font-size:20px;color:#434446;text-align:center;padding-left:100;margin-top:30px;'> " );
...
//		
//		
//		message.append( "<div style='height:150px;width:600px;font-size:20px;color:#434446;text-align:center;padding-left:100;margin-top:30px;'> " );
...
//	
    ...
    public String composeVendorRegistrationMail(String companyName, String content){//, String inquiry) {
        ...
        message.append("<a href='/index.jsp'><img src= '" + path + "/inside/logo.png'  width='325' height='100' style='margin-top:10px;'/></a></div> ");
        ...
        message.append("<div style='height:100;width:800px;font-size:25px;color:#199096;text-align:center;line-height:50px;padding-top:20px;'>  Vendor Registration ");
        message.append("</div> ");
...
//        content = get(content, valArr);
    ...
    public String composeInvitationMail(String companyName, String senderName) {
        ...
        // Supply Medium description
        message.append("<div style='height:70px;width:600px;font-size:20px;color:#434446;text-align:center;padding-left:100;margin-top:30px;'>");
        message.append(senderName + " of " + companyName + " has invited to join to SupplyMedium.<br/>"
                + "(free registration and no Credit/Debit Card required)</div>");
