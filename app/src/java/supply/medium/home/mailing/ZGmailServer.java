...
//        normalMail(msg);
        attachmentMail1(msg, path, file);
    }

    public static void normalMail1(String msg) {
...
//            message.setText(msg);
    ...
    public static void attachmentMail1(String msg, String path, String file) {
