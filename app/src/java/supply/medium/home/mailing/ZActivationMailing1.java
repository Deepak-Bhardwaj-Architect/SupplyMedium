...
public class ZActivationMailing1 {

    public void composeAndSendMail1(String[] to, String subject, String message, String fromMessage) {
        ZEmailApi.normalMail1(to, subject, message, fromMessage);
    }
...
//    String fromMsg=null;
//    public void composeAndSendMail(String[] to, String subject, String message,String fromMessage) {
//
//        fromMsg=fromMessage;
//
...
////
////            // Send the message.
////            ErrorMaster.insert("Attempting to send an email through the Amazon SES SMTP interface...");
////
...
////            transport.close();
////            ErrorMaster.insert("Email sent!");
////        } catch (Exception ex) {
////            ErrorMaster.insert("The email was not sent.");
////            ErrorMaster.insert("Error message: " + ex.getMessage());
////        }
////
////    }
//
...
//				{
//
//					InternetAddress fromAdd = new InternetAddress( from_,fromMsg);
//
//					msg.setFrom( fromAdd );
//
//
