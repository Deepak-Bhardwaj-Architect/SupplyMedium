 ...
 */
public class ZAttachmentMailer1 {

    public void composeAndSendMail1(String[] to, String subject, String message, String path, String fileName) {
        ZEmailApi.attachmentMail1(to, subject, path, path, fileName);
    }
