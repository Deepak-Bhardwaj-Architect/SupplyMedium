    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
           ...
           String [ ] to = { email };
            ...
            String emails=UserMaster.getAdminEmail(companyKey);
            String [ ] tos = { emails };
            sub = "SupplyMedium User SignUp Request";
            composer = new HTMLMailComposer( );
            message = composer.composeUserSignupMailAdmin(email,firstName );
            composer = null;
            am = new ActivationMailing( );
            am.composeAndSendMail( tos, sub, message.toString( ),"SM User SignUp" );
