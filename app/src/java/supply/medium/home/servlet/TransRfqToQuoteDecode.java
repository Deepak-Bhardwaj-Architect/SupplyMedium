 ...
 * @author Lenovo
 */
public class TransRfqToQuoteDecode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter(); try { 
            ...
            String qteTransRfqKey = request.getParameter("qTransRfqKey");
            ...
            transQteKey = TransactionQteMaster.insertQte(transQteKey, companyKeyFrom, companyKeyTo,
                    userKeyFrom, userKeyTo, transactionType, qteTransRfqKey, qteNo, transStatus, transAction, quoteRef,
            ...
            String currencyKey = request.getParameter("currencyKey");
            String multiplier[] = request.getParameterValues("discount");

            for (int i = 0; i < itemKey.length; i++) {

                TransactionQteItemMaster.insertQteItem(transQteKey, qteNo, itemKey[i], partNo[i], barcode[i], quantity[i], quantityUnitKey[i], shipDate[i], price[i], currencyKey, multiplier[i]);
            ...
            TransactionRfqMaster.updateQteGenerated(qteTransRfqKey, "yes");
