...
public class CompanyMaster {
    ...
    public static int updatePlatformAmountGenerated(String key,String amount)
    {
        int result=0;
        Connection con=null;
        Statement st=null;
        try
        {
            con=MyConnection.connect();
            st=con.createStatement();
            String query="update company_master "
                    + "set amount_genrated='"+amount+"' "
                    + "where company_key='"+key+"' ";
            result=st.executeUpdate(query);
        }
        catch(Exception ex)
        {
            ErrorMaster.insert("Exception at updatePlatformAmountGenerated in CompanyMaster : "+ex.getMessage());
        }
        finally
        {
            try
            ...
            {
                ErrorMaster.insert("Exception at closing updatePlatformAmountGenerated in CompanyMaster : "+ex.getMessage());
            }
        }
        return result;
    }

    public static String showPlatformCharges(String key)
    {
        String result="";
        Connection con=null;
        Statement st=null;
        ...
        try
        {
            con=MyConnection.connect();
            st=con.createStatement();
            String query="select amount_genrated,amount_paid "
                    + "from company_master "
                    + "where company_key='"+key+"';";
...
//                System.out.println(result);
        ...
        {
            ErrorMaster.insert("Exception at showPlatformCharges in CompanyMaster : "+ex.getMessage());
        }
        finally
        {
            try
            ...
            {
                ErrorMaster.insert("Exception at closing showPlatformCharges in CompanyMaster : "+ex.getMessage());
            }
        }
        return result;
    }

    public static int updateAmountPaid(String key,String amount)
    {
        int result=0;
        Connection con=null;
        Statement st=null;
        ...
        {
            ErrorMaster.insert("Exception at updateAmountPaid in CompanyMaster : "+ex.getMessage());
        }
        finally
        {
            try
            ...
            {
                ErrorMaster.insert("Exception at closing updateAmountPaid in CompanyMaster : "+ex.getMessage());
            }
        }
        return result;
    }
...
//    public static int getCompanyPlan(String companyId)
//    {
//        int result=0;
//        Connection con=null;
//        Statement st=null;
...
//                        + "and "
    ...
    public static ArrayList showAll()
    {
        ...
        try
        {
            ...
            st=con.createStatement();
            String query="select * "
                    + "from company_master order by company_key desc;";
            rs=st.executeQuery(query);
            al=new ArrayList();
            while(rs.next())
            {
        ...
        {
            ErrorMaster.insert("Exception at showAll in CompanyMaster : "+ex.getMessage());
        }
        finally
        {
            try
            ...
            {
                ErrorMaster.insert("Exception at closing showAll in CompanyMaster : "+ex.getMessage());
            }
        }
        return al;
    }
