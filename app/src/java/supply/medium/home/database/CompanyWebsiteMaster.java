...
public class CompanyWebsiteMaster {
    ...
    public static String showWebsiteUrlLink(String companyKey)
    {
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
        ...
        try
        {
            con=MyConnection.connect();
            st=con.createStatement();
            String query="select website_url "
                    + "from company_website_master "
        ...
        {
            ErrorMaster.insert("Exception at showWebsiteUrlLink in CompanyWebsiteMaster : "+ex.getMessage());
        }
        finally
        {
            try
            ...
            {
                ErrorMaster.insert("Exception at closing showWebsiteUrlLink in CompanyWebsiteMaster : "+ex.getMessage());
            }
        }
        return result;
    }
