    ...
    <body>
        ...
        <div class="contentcontainer">
            <div class="successcontent">
                ...
                <div class="resmsg">
                    <font size="4">Your password has been successfully updated.</font><br><br> Click <a href="index.jsp">here</a> to login. Thank you for reseting your password with Supply Medium.
                </div>
            </div>
        </div>
