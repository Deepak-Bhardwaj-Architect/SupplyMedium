...
<html>
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');splitFeedKeys();<% if(request.getParameter("folder")!=null){ %> get_user_folders('<%=request.getParameter("folder") %>'); <% }else { %>get_user_folders('none');<%}%>" onkeydown="displayunicode(event);">
        ...
        <div id="ad_usr_fldr_fl" class="rfq_post_confirmation" style="height: 140px; margin-left: 35%; width: 340px; display: none;">
            <center>
                ...
                <form name="frm_fl_nm" action="FolderManagementMyFeed" method="post" encType="multipart/form-data" >
                    ...
                    <br>
                    <br>
                    <input type="submit" class="gen-btn-blue" value="Save" onClick="$('#ad_usr_fldr_fl').fadeOut();return add_user_folder_file();" style="margin-left:10px;">
                        ...
                        <div style="width:230px;float: left;background: #FFFFFF">
                            ...
                            <div style="width:230px;height:350px;float: left;border: 1px solid #d3d3d3">
                                ...
                                <div style="float: right;">
                                    ...
                                    <a onClick="if(slctd_fl2.trim()!==''){this.href=$('#slected_user_folder_url').val()+'/'+slctd_fl2;}else { ShowToast('Select file to download','2000'); }window.location.href='';" target="_blank">
                            ...
                            <div id="newfeed" class="newfeed" style="width:750px;">
                                <form onsubmit="return feedValidater($('#feedTitle').val(),$('#feedDesc').val());" id="user_feed_frm" style="width:750px;" name="user_feed_frm" action="CreateFeed" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="feed_btns">
                                        ...
                                        <input onclick="showLoading()" type="submit" class="gen-btn-Orange post_feed_btn" id="post_feed_btn" value="Post" style="z-index:99;">
                                        <!--</div>-->
                            ...
                            <div id="feeds" class="feeds" style="margin-left:0px;">
                                    <%                                        
                                        ...
                                        for (int i = 0; i < feedList.size(); i++) {
                                            ...
                                            filePath=SmProperties.dataPathUrl+"/"+sbcb.getFilePath();
                                    %>
                                    <div id="feed_1" class="feed">                                        
                                        <div class="publisher_details">
                                            <div>
                                                <img src="<%=SmProperties.dataUrlPath%>users/<%=sbcb.getUserKey()%>.png" class="publisher_photo">
                                            </div>
                                        ...
                                        <div class="feed_summary">
                                            ...
                                            <p class="feed_text"><%=feedDescription.replace("@#@#@",SmProperties.dataUrlPath+"company-").replace("@#@",File.separator) %></p>
                                            <p>
                                            </p>
                                        </div>
