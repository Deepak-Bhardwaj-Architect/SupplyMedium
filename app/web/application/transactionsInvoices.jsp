...
<!--                        <div id="chs_usr_adrs" class="rfq_post_confirmation" style="height:auto;margin-left:15%;width:700px;">
                        ...
                        <div class="sub_tab_container" id="invoice_submenu">
                            ...
                            <div class="highlight" id="invoice_request_tab" onclick="swapWkTabs2('invoice_request_tab', 'invoice_form_tab');
                                    ...
                                    $('#invoice_form_content').hide();"><a style="color:#0b8fad;" href="transactionsInvoice.jsp">My Request</a></div>
                            <!-- My Request tab -->
                        ...
                        <div id="invoice_form_content" style="display:none;" class="invoice_form_content">
                            <form method="post" action="TransPoToInvoiceDecode"  onsubmit="return invoiceFormValidation();">
                                <input type="hidden" name="qTransRfqKey" value="<%=request.getParameter("generateinvoice")%>"/>
                                ...
                                <div class="invoice_form">
                                    ...
                                    <div class="invoice_buyer_det">
                                        ...
                                        <div class="trans_row" style="float:left;">
                                            ...
                                            <input type="text" autocomplete="off" readonly class="textbox" name="invoice_due_date" id="invoice_due_date">
                                        </div>
                                        <div class="trans_row" style="float:left;">
...
//                                                            $('#chs_usr_adrs').fadeOut();
                                        ...
                                        <div class="items" id="items">
                                            ...
                                            <div id="item1" class="item" style="width:970px;float:left;margin-top:10px;margin-left:15px;margin-right:0px;">
                                                ...
                                                <input type="text" autocomplete="off" class="textbox" maxlength="12" name="quantity11" id="quantity111" style="width:28px;" readonly value="<%=transactionPoItemBean.getQuantity()%>">
                                                ...
                                                <input type="text" autocomplete="off" class="textbox" maxlength="12" name="quantity" id="quantity1" style="width:28px;" value="<%=transactionPoItemBean.getQuantity()%>" />
                                                ...
                                                <input type="hidden" name="currencyKey" value="<%=transactionPoItemBean.getCurrencyKey()%>">
                                                <input type="text" autocomplete="off" class="textbox" name="discount" id="multipl1" style="width:48px;margin-right:10px;" value="<%=multi%>">
                        ...
                        <div style="display: none;z-index:2000;" class="Custome_Popup_Window" id="invoice_add_item_popup">
                            <div class="Cus_Popup_Outline invoice_add_item_popup_outline"style="height:400px">
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:none; " id="addNewItem">
                                    ...
                                    <div class="rfq_error" id="rfq_item_form_error" style="width:620px;font-weight:bold;color:green;font-size:14px;padding-top:10px;">
                                    </div>
                                </div>
                            </div>
