...
(function($) {
    $.fn.jRating = function(op) {
        var defaults = {
            /** String vars **/
            bigStarsPath: getBaseURL() + '/inside/big_star_empty.png', // path of the icon stars.png
            smallStarsPath: getBaseURL() + '/inside/small_star_empty.png', // path of the icon small.png
            moreBigStarsPath: getBaseURL() + '/inside/great_star_empty.png', // path of the more big star.png
