...
<html>
	...
	<script>
	function abc123(valCur,curName,key,rfqKey)
	{
		var myurls="http://openexchangerates.org/api/latest.json?app_id=3061c5972066457aaa00772f31515e07";
		var resultCur="0";
		$.ajax({
			url: myurls,
			dataType: 'jsonp',
			success: function(json)
			{
				...
				var amt=json.rates[curName];
				resultCur=1/amt;
                                resultCur*=valCur;
				resultCur=Math.round(resultCur * 100) / 100;
                                $('#amnt').val(resultCur);
                                $('#rtrn').val($('#rtrn').val()+"?id=" + key);
                                $('#item_name').val("SupplyMedium Invoice No: "+ rfqKey);
                                $('#paypalForm').submit();
                                //alert($('#amnt').val());
			}
		});
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');<% if (request.getParameter("generateinvoice") != null) {%>swapWkTabs2('invoice_form_tab', 'invoice_request_tab');
        ...
        $('#invoice_request_content').hide();<% }%>" onkeydown="displayunicode(event);">
                                ...
                                <div class="fixed_height">
                                    <table id="invoice_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="invoice_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                                ...
                                                                if (companyKey.equals(trb.getCompany_key_from())) {
                                                                    ...
                                                                    if (cstatus.equals("Accepted")) {
                                                                        if (trb.getIs_inv_paid().equalsIgnoreCase("no")) {
                                                                            ...
                                                                            TransactionInvItemBean trivb = (TransactionInvItemBean)TransactionInvItemMaster.showInvItemFromInvKey(trb.getTrans_key()).get(0);
                                                                            String curCode=CurrencyMaster.showCodeByKey(trivb.getCurrencyKey());
                                                                            cstatus+=" onclick=\"javascript:ShowToast('<b>Warning: </b>You are leaving SupplyMedium. If you use PayPal to process the invoice payment, PayPal charges its own fees for processing payments. To see the PayPal payment transaction fees/charges please refer to the PayPal website.',5000);abc123('" + trb.getInv_total_billing_amount() + "','"+curCode+"','" + trb.getTrans_key() + "','" + trb.getInv_trans_rqf_key() + "');\">Make a Payment</a>";
                                                                        } else {
                                                                            cstatus = "Payment Done";
                                                                        }
                                                                    } else if (cstatus.equals("Inquired")) {
                                                ...
                                                <td class="rowBorder">
                                                    <a style="float:left;" target="_blank" href="<%=SmProperties.dataUrlPath%>company-<%=companyKey%>/transaction/<%=trb.getInv_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a>
                                                    <a style="float:left;" target="_blank" onclick="deleteInv('<%=trb.getInv_trans_rqf_key()%>');"><img alt="Delete" title="Delete" src="inside/delete.png"></a>
                                                </td>
                                            </tr>
                                            <%
                                                        }
                                ...
                                <div class="invoice_form">
                                    ...
                                    <div class="invoice_buyer_det">
                                        ...
                                        <div class="trans_row" style="float:left;">
                                            ...
                                            <input type="text" autocomplete="off" class="textbox" value="<%=System.currentTimeMillis()%>" id="po_no" name="po_no">
                                        </div>
                                        <div class="trans_row" style="float:left;">
                                    ...
                                    <div class="invoice_supplier_det">
                                        ...
                                        <div class="trans_row">
                                            <div class="checkContainer">
                                                <input type="checkbox" class="checkbox"  name="outside_supplier" id="outside_supplier" onclick="isOutSideOrNot(this);if (this.checked) {
                                                    $('#insideBuyer').hide();
                                                    $('#outsideBuyer').show();
                                                    $('#to_company').val('');
                                        ...
                                        <!--<div class="trans_row">
                                            ...
                                            <label for="is_diff_addr" class="trans_label" style="line-height:19px;margin-left:5px;width:360px;line-height:15px;">In case email address is different than one given above</label>
                                        </div>-->
                                    ...
                                    <div class="items_head">
                                        ...
                                        <label class="trans_label" style="width:76px;margin-right:10px;display:none;">Qty Ordered</label>
                                        <label class="trans_label" style="width:120px;margin-right:10px;">Quantity Shipped</label>
                                    ...
                                    <div class="price_det" id="price_det">
                                        ...
                                        <div class="price_det_content">
                                            ...
                                            <input type="text" autocomplete="off" name="qt_tx" class="textbox" id="qt_tx" style="width:90px;margin-right:10px;" value="0" onKeyUp="clclt_trans_amnt(this.value)">
                                            <label>%</label>
                                        </div>
                                        <div class="price_det_content">
                                    ...
                                    <div class="invoice_error" style="margin:20px;color:green;font-size:14px;text-align:left;">SupplyMedium will charge 1% of total invoice amount from supplier.</div>
                                    ...
                                    <div style="width:100%;float:left;margin-left:40px;height:50px;" id="invoice_terms_container">
                                        Do you want to send email to buyer : <input name="sendEmail" type="radio" required value="Yes"/>Yes &nbsp;&nbsp;&nbsp;<input name="sendEmail" type="radio" required value="No"/>No
                                    </div>
                            ...
                            <div class="Cus_Popup_Outline invoice_add_item_popup_outline"style="height:400px">
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;" id="existingItem">
                                    <div class="items_head">
                                        ...
                                        <label class="trans_label" style="width:107px;margin-right:10px;display:none;">Quantity Ordered</label>
                                    ...
                                    <div class="item" style="width: 975px;float:left;margin-left:10px;margin-right:0px;position:relative;">
                                        ...
                                        <input type="hidden" autocomplete="off" class="textbox" id="popup_quantity_ordered" maxlength="12" style="width:63px;">
                                        <div class="quantity_unit" id="popup_quantity_type" style="margin-right:10px;display:none;" onclick="$('#selectQuantityUnit').toggle();">PCS</div>
                                        ...
                                        <input type="text" autocomplete="off" class="textbox" onKeyUp="document.getElementById('popup_quantity_ordered').value=document.getElementById('popup_quantity').value;mult()" id="popup_quantity" maxlength="12" style="width:63px;">
                                    ...
                                    <div id="selectQuantityUnit2" style="display:none; position: absolute;margin-left:495px;margin-top:97px;padding:0px 2px;  border:1px solid #000; z-index: 99999;width:50px;height:80px;overflow-y:scroll;">
                                        <%                                //ArrayList categoryList = QuantityTypeMaster.showAll();
                                                    qtb = null;
                                                    for (int i = 0; i < categoryList.size(); i++) {
                                                        qtb = (QuantityTypeBean) categoryList.get(i);
                                    ...
                                    <div id="selectCurrencyUnit" style="display:none; position: absolute;margin-left:611px;margin-top:97px;padding:0px 2px; border:1px solid #000; z-index: 99999;width:50px;height:80px;overflow-y:scroll;">
                                        <%
                                    ...
                                    <div class="items_head2" id="resulted-data-head" style="display:none;">                                        
                                        ...
                                        <label class="trans_label" style="width:398px;margin-left:38px;font-weight:bold;">Barcode</label>
                                    </div>
                                    <div class="items_head2" id="resulted-data" style="display:none;">                                        
                                        ...
                                        <label id="lblbc" class="trans_label" style="width:398px;margin-left:50px;"></label>
                                    </div>
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:none; " id="addNewItem">
                                    ...
                                    <div class="invoice_error" id="rfq_item_form_error2" style="width:620px;font-weight:bold;color:green;font-size:14px;padding-top:10px;">
                                    </div>
                                </div>
                            </div>
