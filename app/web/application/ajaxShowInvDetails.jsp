...
String nme=null;
    ...
    else
    {
        ...
        <div style="float: right;width:100px;" onclick="window.location.href='';">
            <a onClick="this.href = '<%=SmProperties.dataUrlPath + "company-"+session.getAttribute("companyKey")+"/transaction/INV"+request.getParameter("invoiceKey")+".pdf" %>'" target="_blank">
