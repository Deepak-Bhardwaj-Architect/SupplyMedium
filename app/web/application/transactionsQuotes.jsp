...
<html>
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');<% if (request.getParameter("generatequote") != null) { %>swapWkTabs2('quote_form_tab', 'quote_request_tab');
                $('#quote_request_content').hide();
                $('#quote_form_content').show();<% }%>" onkeydown="displayunicode(event);">
            ...
            <div class="contentcontainer" style="min-height:709px;">
                ...
                $('#quote_form_content').hide();">My Request</div>
                                ...
                                <div class="fixed_height">
                                    <table id="quote_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="quote_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                    ...
                                                    if (companyKey.equals(trb.getCompany_key_from())) {
                                                        ...
                                                        if (cstatus.equals("Accepted")) {
                                                            if (trb.getQ_is_po_created().equalsIgnoreCase("no")) {
                                                                cstatus = "<a href='transactionsPurchaseOrders.jsp?generatepo=" + trb.getTrans_key() + "&key=" + trb.getCompany_key_to() + "' style='text-decoration:underline;'>Generate Purchase Order</a>";
                                                            } else {
                                            ...
                                            %>
                                            <tr <%=stl%> onclick="$('#quote_popup').fadeIn();
                                                    showQuoteDetailInPopup('<%=trb.getTrans_key()%>', '<%=trb.getCompany_key_to()%>', '<%=trb.getCompany_key_from()%>');
                                                ...
                                                <td class="rowBorder"><a target="_blank" href="<%=SmProperties.dataUrlPath%>company-<%=companyKey%>/transaction/<%=trb.getQ_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                }
                                                if (al.size() == 0) {
                        ...
                        <div id="quote_form_content" style="display:none;width:100%;" class="quote_form_content">
                            <form method="post" action="TransRfqToQuoteDecode" onsubmit="return quoteFormValidation();">
                                <!-- This is the Quote form details -->
                                <input type="hidden" name="qTransRfqKey" value="<%=request.getParameter("generatequote")%>"/>
                                ...
                                <div class="to_comp">
                                    ...
                                    <input type="text" value="<%=CompanyMaster.getCompanyNameFromKey(request.getParameter("key"))%>" autocomplete="off" placeholder="Search Registered Vendor" id="to_company" style="width:920px;" class="textbox" onKeyUp="showCompaniesVendorSearch(this.value, 'Buyer');">
                                </div>
                                ...
                                <div class="quote_form" style="width: 1000px;">
                                    ...
                                    <div class="quote_supplier_det">
                                        ...
                                        <div class="trans_row">
                                            <div class="checkContainer">
                                                <input type="checkbox" disabled class="checkbox" name="outside_supplier" id="outside_supplier" onclick="isOutSideOrNot(this);if (this.checked) {
                                                            $('#insideBuyer').hide();
                                                            $('#outsideBuyer').show();
                                                            $('#to_company').val('');
                                        ...
                                        <div class="supplier_address" id="insideBuyer" style="width:100%;height:300px;">
                                            ...
                                            <div class="trans_row">
                                                <label class="trans_label"> Country </label>
                                                <input type="text" value="<%=CountryMaster.showCountryFromKey(cdab2.getCountry())%>" autocomplete="off" class="textbox_disable" id="buyer_country">
                                            </div>
                                            <div class="trans_row">
                                                <label class="trans_label"> State/Province </label>
                                                <input type="text" value="<%=StateMaster.showStateFromKey(cdab2.getState())%>" autocomplete="off" class="textbox_disable" id="buyer_state">
                                            </div>
                                            <div class="trans_row">
                                                <label class="trans_label"> City </label>
                                                <input type="text" value="<%=cdab2.getCity()%>" autocomplete="off" class="textbox_disable" id="buyer_city">
                                            </div>
                                            <div class="trans_row">
                                                <label class="trans_label"> Address </label>
                                                <input type="text" value="<%=cdab2.getAddress()%>" autocomplete="off" class="textbox_disable" id="buyer_addr">
                                            </div>
                                            <div class="trans_row">
                                                <label class="trans_label"> Zip Code/Postal Code </label>
                                                <input type="text" value="<%=cdab2.getZipcode()%>" autocomplete="off" class="textbox_disable" id="buyer_zipcode">
                                            </div>
                                        </div>
                                    ...
                                    <div class="items" id="items">
                                        <%
                                            int count=0;
                                            float totalListPrice=0,totalPrice=0;
                                            String item="";
                                            String allItem="";
                                            ArrayList itemList = TransactionRfqItemMaster.showRfqItemFromRfqKey(request.getParameter("generatequote"));
                                        ...
                                        <input type="text" autocomplete="off" class="textbox" maxlength="80" name="part_no" id="part_no1" style="width:46px;margin-right:10px;" readonly value="<%=transactionRfqItemBean.getPartNo()%>">
                                        <input type="text" autocomplete="off" class="textbox" maxlength="80" id="sku_no1" style="width:50px;margin-right:10px;" readonly value="<%=gpib.getSKUno()%>">
                                        <input type="text" autocomplete="off" class="textbox" maxlength="80" name="brcd_no" id="brcd_no1" style="width:48px;margin-right:10px;" readonly value="<%=transactionRfqItemBean.getBarcode()%>">
                                        <input type="text" autocomplete="off" class="textbox" maxlength="12" name="quantity" id="popup_quantity_<%=count%>" onkeyup="mult2(<%=count%>);tl_clcltn_RfqToQoute('<%=count %>');" style="width:28px;" value="<%=transactionRfqItemBean.getQuantity()%>">
                                        <div class="quantity_unit" style="margin-right:10px;" id="quantity_unit1"><%=QuantityTypeMaster.showCodeByKey(transactionRfqItemBean.getQuantityUnitKey())%></div>
                                        <input type="hidden" name="quantityUnitKey" value="<%=transactionRfqItemBean.getQuantityUnitKey() %>">
                                        <input type="text" autocomplete="off" class="textbox" name="ship_date"  id="ship_date1" style="margin-right:10px;width:73px;" readonly value="<%=transactionRfqItemBean.getShipDate().split(" ")[0]%>">
                                        <input type="text" autocomplete="off" class="textbox" style="color:blue;font-weight:bold;width:49px;" value="1" name="price" id="popup_price_<%=count%>" onkeyup="mult2(<%=count%>);tl_clcltn_RfqToQoute('<%=count %>');" style="width:50px;margin-right:0px;">
                                        <div class="currency_unit" id="currency1" onclick="$('#selectCurrencyUnit<%=i%>').toggle();" style="margin-right:10px;">USD</div>
                                        <input type="text" autocomplete="off" class="textbox" name="discount" id="dscnt_<%=count%>" onkeyup="mult2(<%=count%>);tl_clcltn_RfqToQoute('<%=count %>');" value="1" style="width:48px;margin-right:10px;">
                                        <input type="text" value="<%=transactionRfqItemBean.getQuantity() %>" autocomplete="off" class="textbox" name="total" id="total_<%=count%>" onkeyup="mult2(<%=count%>);" style="width:65px;margin-right:10px;" readonly>
                                        <!--<input type="button" class="del_btn" id="del_btn_1" style="width:110px;margin-right:10px;" onclick="delPrice(25);$(&quot;#item1&quot;).html('');document.getElementById(&quot;allQteItems&quot;).value=document.getElementById(&quot;allQteItems&quot;).value.replace(&quot;(1^b560^b560^5^KGS^5^5^USD^1),&quot;,&quot;&quot;);">-->
                                        </div>
                                    <div id="selectCurrencyUnit<%=i%>" style="display: none;position: absolute;margin-left:752px;margin-top:<%=((i*51)+502)%>px;background-color:#fff;padding:0px 2px; border:1px solid #000; z-index: 99999;width:50px;height:80px;overflow-y:scroll;">
                                        <%
                                                    ArrayList currencyList123 = CurrencyMaster.showAll();
                                                    CurrencyBean cb123 = null;
                                                    for (int ii = 0; ii < currencyList123.size(); ii++) {
                                                        cb123 = (CurrencyBean) currencyList123.get(ii);
                                                        out.print("<span style='cursor:pointer;' onclick=\"javascript:$('#currencyKey').val('" + cb123.getCurrencyKey() + "');$('.currency_unit').html('" + cb123.getCurrencyCode() + "');$('#selectedCurrencyUnit').val('" + cb123.getCurrencyCode() + "');$('#currency').html('" + cb123.getCurrencyCode() + "');$('#selectCurrencyUnit"+i+"').fadeOut();\">" + cb123.getCurrencyCode() + "</span></br>");

                                                    }
                                        %>
                                    </div>
                                        <% 
                                           //item="("+count+"^"+gpib.getItemName()+"^"+gpib.getItemDescription()+"^"+transactionRfqItemBean.getPartNo()+"^"+gpib.getSKUno()+"^"+transactionRfqItemBean.getBarcode()+"^"+transactionRfqItemBean.getQuantity()+"^"+transactionRfqItemBean.getQuantityUnitKey()+"^"+transactionRfqItemBean.getShipDate().split(" ")[0]+"),";
                                           totalListPrice+=Float.parseFloat(transactionRfqItemBean.getQuantity());
                                            }
                                            totalPrice=(totalListPrice)+(totalListPrice*0/100);
                                        %>
                                        <input type="hidden" name="currencyKey" id="currencyKey" value="1">
                                    ...
                                    <div class="price_det" id="price_det">
                                        <div class="price_det_content" style="display:none;">
                                            <label class="price_det_lbl" id="tot_list_price_lbl"> Total List Price: </label>
                                            <input type="text"  autocomplete="off" readonly class="textbox" id="tot_list_price_amt" name="tot_list_price_amt" style="width:90px;margin-right:10px;" value="<%=totalListPrice %>">
                                        </div>
                                        <div class="price_det_content">
                                            <label class="price_det_lbl" id="tax_lbl"> Tax in Percentage: </label>
                                            <input type="text" autocomplete="off" class="textbox" name="qt_tx" id="qt_tx" style="width:90px;margin-right:10px;" value="0" onKeyUp="clclt_trans_amnt(this.value)">
                                            <label>%</label>
                                            <label class="tx_er" id="tx_er"></label>
                                        </div>
                                        <div class="price_det_content" style="display:none;">
                                            <label class="price_det_lbl" id="tot_price_lbl"> Total Price: </label>
                                            <input type="text" autocomplete="off" readonly class="textbox" name="tot_price_amt" id="tot_price_amt" style="width:90px;margin-right:10px;" value="<%=totalPrice %>">
                                        </div>
                                    </div>
                        ...
                        <div style="display: none;z-index:2000;" class="Custome_Popup_Window" id="quote_add_item_popup">
                            <div class="Cus_Popup_Outline quote_add_item_popup_outline" style="width: 1100px !important;top:45%;height:350px;">
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:none; " id="addNewItem">
                                    ...
                                    <div class="quote_error" id="quote_item_form_error" style="width:620px;font-weight:bold;color:green;font-size:14px;padding-top:10px;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="display: none; z-index: 1000;" class="Custome_Popup_Window" id="quote_inquire_popup">
                            <div class="Cus_Popup_Outline quote_inquire_outline">
                                ...
                                <input type="button" class="gen-btn-blue" value="Send" style="margin-left: 250px;margin-top: 30px;margin-bottom: 20px;" id="chat_inquire_save_btn" onclick="showLoading();">
                            </div>
                        </div>
                    </div>
                </div>
