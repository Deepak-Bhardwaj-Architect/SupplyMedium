...
<div class="ratingcompanyinfo">
    <div class="rattingcompanydetails">
        ...
        <div class="ratting_row">
            <div class="rattingvaluebigmain" data-average="8" style="height: 30px; width: 150px; overflow: hidden; z-index: 1; position: relative;">
                ...
                <div class="jStar" style="background:#fff;width: 150px; height: 30px; top: -60px;">
                    <div class="rating_star_small_base rating_star_<%=(Integer.parseInt(rating)*2)%>">
                    </div>
                </div>
            </div>
        </div>
        <div class="ratting_row">
            <label class="rating_number">Based on <span class="rating_number_value_main"><%=ratingList.size()%></span> ratings</label>
        </div>
        <div class="ratting_row">
    ...
    <div class="ratingcompanyimage">
        <div id="rattingcompanyimagefilemain" class="ratingcompanyimageholder">
            <img src="<%=SmProperties.dataPathUrl%>/companies/<%=companyKey %>.png">
        </div>
    </div>
</div>
