            ...
            <div class="page" style="padding-top: 0px;">
                <div class="contentcontainer pageContent" style="width: 1010px;min-height:650px;font-family: Verdana, Arial, sans-serif;background-color:white;">
                    <div id="webselection">
                        ...
                        %>
                        <form method="post" action="InsertUpdateBankInfo" name="f1" onsubmit="return validatedBank()">
                            <div class="websel_container" style="border-bottom:none;">
                                <div style="padding: 15px 0px 0px 35px">
                                    <table id="gentable">
                                        ...
                                        %>
                                        <tr height="50">
                                            <td width="200"><label for="text_company_url">Select Your Account Type</label></td>
                                            <td>
                                                <input name="r1" id="r1" checked value="bank" onclick="$('#paypaltable').hide();$('#banktable').show();" type="radio">Bank
                                                &nbsp;&nbsp;&nbsp;
                                                <input name="r1" id="r1" value="paypal" onclick="$('#banktable').hide();$('#paypaltable').show();" type="radio">PayPal
                                            </td>
                                        </tr>
                                    </table>
                                    <table id="banktable">
                                        <tr height="50">
                                            ...
                                            <td><input name="acName" id="t1" class="textbox" value="<%=acName%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                        <tr height="50">
                                            <td><label for="text_company_url">A/C No</label></td>
                                            <td><input name="acNo" id="t2" class="textbox" value="<%=acNo%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                        <tr height="50">
                                            <td><label for="text_company_url">SWIFF Code</label></td>
                                            <td><input name="swiffCode" id="t2" class="textbox" value="<%=swiffCode%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                        <tr height="50">
                                            <td><label for="text_company_url">RTGS / NEFT IFSC Code</label></td>
                                            <td><input name="ifscCode" id="t4" class="textbox" value="<%=ifscCode%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                        <tr height="50">
                                            <td><label for="text_company_url">Branch Address</label></td>
                                            <td><input name="branchAddress" id="t5" class="textbox" value="<%=branchAddress%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                    </table>
                                    <table id="paypaltable" style="display:none;">
                                        <tr height="50">
                                            <td width="200"><label for="text_company_url">Paypal Account Holder Name</label></td>
                                            <td><input name="paypalAcName" id="t6" class="textbox" value="<%=paypalAcName%>"   type="text" autocomplete="off"></td>
                                        </tr>
                                        <tr height="50">
                                            <td><label for="text_company_url">Paypal E-mail Address</label></td>
                                            <td><input name="paypalEmail" id="t7" class="textbox" value="<%=paypalEmail%>"   type="email" autocomplete="off"></td>
                                        </tr>
                                    </table>
                                    <table>
                                        <tr height="50">
                                ...
                                <div id="bank_error" style="color:red;text-align:center;padding-top:30px;"></div>
                            </div>
                        </form>
                    </div>
                </div>
