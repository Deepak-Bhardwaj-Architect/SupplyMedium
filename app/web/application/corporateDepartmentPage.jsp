...
%>                                    
                            ...
                            <form name="file_download_frm" id="file_download_frm" action="DeptFileDownloadServlet" method="post" enctype="multipart/form-data">
                                <div class="file_ctrls" id="file_ctrls" style="display:none;">
                                    <a title="Download File" alt="Download File" onclick="this.href=$('#corporateDepartmentFileUrl').val();window.location.href='';" target="_blank" ><input type="button" id="file_export_btn" class="export_btn" title="Download File"></a>
<%
                                if((!userType.equals("Admin") 
