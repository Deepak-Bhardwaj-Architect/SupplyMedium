...
<html>
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');splitFeedKeys();<% if(request.getParameter("folder")!=null){ %> get_cmpny_folders('<%=request.getParameter("folder") %>'); <% }else { %>get_cmpny_folders('none');<%}%>" onkeydown="displayunicode(event);">
        ...
        <div id="ad_usr_fldr_fl" class="rfq_post_confirmation" style="height:140px;margin-left:35%;width:340px;">
            <center>
                ...
                <form name="frm_fl_nm" action="FolderManagementInternalPage" method="post" encType="multipart/form-data" >
                    ...
                    <br>
                    <br>
                    <input type="submit" class="gen-btn-blue" value="Save" onClick="$('#ad_usr_fldr_fl').fadeOut();return add_cmpny_folder_file();" style="margin-left:10px;">
                    ...
                    <div style="width:200px;float: left;background: #FFFFFF">
                        ...
                        <div style="width:200px;height:350px;float: left;border: 1px solid #d3d3d3">
                            ...
                            <div style="float: right;">
                                ...
                                <a onClick="if(slctd_fl2.trim()!==''){this.href = $('#slected_company_folder_url').val() + '/' + slctd_fl2;}else { ShowToast('Select file to download','2000'); }window.location.href='';" target="_blank">
                    ...
                    <div class="feed_content" style="width: 550px;margin-left:8px;">
                        ...
                        <div id="newfeed" class="newfeed">                            
                            ...
                            && postAncMain.equalsIgnoreCase("yes")))
                                    {
                                    %>
                                    <input onclick="showLoading()" type="submit" class="gen-btn-Orange post_feed_btn" id="post_feed_btn" value="Post" style="margin-left:511px;">
                                    <%
                                    }
                                    %>
