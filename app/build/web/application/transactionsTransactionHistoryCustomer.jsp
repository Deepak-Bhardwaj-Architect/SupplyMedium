                ...
                <form name="customerhistoryfrm" id="customerhistoryfrm" style="min-height:600px;">
                    <div id="customerhistory_container">
                        <div class="tabbar" style="margin-top: 0;">
                            ...
                            <div class="highlight" id="transaction_history" onclick="window.location.href='transactionsTransactionHistoryCustomer.jsp?cid=<%=request.getParameter("cid")%>'" style="display:block;width:150px;">Transaction History</div>
                            <div class="normal" id="payment_history" onclick="window.location.href='transactionsTransactionHistoryPayment.jsp?cid=<%=request.getParameter("cid")%>'" style="display:block;width:150px;">Payment History</div>
                        </div>                        
                        <div class="transactionhistorycontent" id="transaction_history_content" style="display: block;">
                            ...
                            <div class="tablecontent" id="table_content" style="position:relative;margin-top:200px;">
                                <div class="DT_border">
                                </div>
...
<!--                                    <div class="dataTables_filter" id="TransList_filter">
                                    ...
                                    <div class="fixed_height">
                                        <table id="TransList" style="width: 997px;" class="dataTable" aria-describedby="TransList_info">
                                            ...
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                <%
                                                ArrayList al = TransactionInvMaster.showByTypeCompanyKeyOther("Invoice", companyKey,request.getParameter("cid"),"");
                                                String stl = "";
                                                String img = "";
                                                String cname = "";
                                                String cphone = "";
                                                ...
                                                <tr <%=stl%>>
                                                    ...
                                                    <td><a download href="<%=SmProperties.dataUrlPath+"company-"+companyKey+File.separator+"transaction"+File.separator+"INV"+trb.getTrans_key()+".xml"%>" target="_blank">XML File</a></td>
        ...
        <div class="Custome_Popup_Window" style="display:none;" id="add_remainder">
            <div class="Cus_Popup_Outline add_remainder_outline">
                ...
                <input type="button" onclick="showLoading();" class="gen-btn-Orange" id="save_remainder_btn" value="Save" style="margin-left:230px;margin-top:20px;">
            </div>
        </div>
        ...
        <div class="Custome_Popup_Window " style="display:none;" id="email_composer">
            <div class="Cus_Popup_Outline remainders_outline email_composer_outline">
                ...
                <div class="button">
                    ...
                    <input type="button" class="gen-btn-Orange" id="send_mail_btn" style="margin-top:10px;" value="Send" onclick="showLoading();">
                </div>
            </div>
        </div>
