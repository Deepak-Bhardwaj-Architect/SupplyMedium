                                ...
                                <%                                            
                                        ArrayList userList = ConnectionMaster.showConnectedList(userKey);
                                            ...
                                            for (int i = 0; i < userList.size(); i++) {
                                                ...
                                                resultUnread=MessageMaster.showUnreadMessagesIfAny(userKey, connectionBean.getUserKeyFrom());
                                        %>
                                        <div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;<% if(resultUnread!=0){out.println("background:#b9b9b9;");} %>" onclick="showMessages('<%=connectionBean.getUserKeyFrom() %>','<%=userBean.getFirstName() %>',' <%=userBean.getLastName() %>','<%=userBean.getEmail() %>');">
                                    <div class="listcontainer" id="my_conn_<%=connectionBean.getUserKeyFrom() %>">
                                        ...
                                        <div class="img_right">
                                            <img src="<%=SmProperties.dataPathUrl%>/users/<%=connectionBean.getUserKeyFrom()%>.png" class="listimg" id="message_thumbnail">
                                        </div>
