...
<HTML>
    ...
    <BODY  onkeydown="displayunicode3(event,<%=session.getAttribute("userKey") %>);" onLoad="lockUnlock('webkrit_content_loader');advanceSearchCount('Supplier', '0', '0', '<%=session.getAttribute("companyKey")%>');
            Usr_anlys('Admin');
            customizeMenu();
            pypl_rslt('null');">
    <LINK rel="stylesheet" 
                            ...
                            <div class="searchWindow">
                                ...
                                <div class="searchRow" style="float:left;width:605px;">
                                    ...
                                    <div style="width:520px;float:left">
                                        ...
                                        <input id="searchTextBox" name="searchTextBox"  placeholder="Search by company name or product name" type="text"  />

                                        <label for="searchTextBox" class="error" style=""></label>

                                    </div>

                                    <input id="searchbtn" type="button" class="searchbtn" align="right"  style="margin-right:15px;" onclick="showVrList('Supplier', $('#searchTextBox').val(), $('#basic_search_cat').val(), '<%=companyKey%>');"/>
                        ...
                        <form id="advance_search_form" >
                            ...
                            <div class="advancedSearchContainer" style="display: none;" id="advancedSearchContainer">						
                                <div style="margin: 15px 0px 5px 13px;height:30px;">
                                    ...
                                    <select id="Advanced_Selectbox"  class="customSelect selectbox" style="height:30px;width:250px;" onchange="splr_slctd_ctgry_srch(this.value);advanceSearchCount('Supplier', $('#searchTextBox').val(), $('#basic_search_cat').val(), '<%=companyKey%>');">
                                    <OPTION value="0">All Business Category</OPTION>
                                                <%
                                                    for (int i = 0; i < bcList.size(); i++) {
                                                        bcb = (BusinessCategoryBean) bcList.get(i);
                                ...
                                <div  style="margin: 15px 0px 5px 13px;height:30px;">
                                    ...
                                    <select id="cntry" class="selectbox" style="width:200px;background-color:white;" onchange="splr_slctd_cntry_srch(this.value);advanceSearchCount('Supplier', $('#searchTextBox').val(), $('#basic_search_cat').val(), '<%=companyKey%>');">
...
<!--                                <div class="advancedRow">
                                ...
                                <div class="advancedRow" style="margin-bottom: 2px;height:30px;">
                                    <div>
                                        ...
                                        <label for="regSupplierCheck" style="line-height: 19px">Search within registered suppliers only</label><br/>
                                        <label for="regSupplierCheck" style="line-height: 19px;color:red;">press "Search Now" button to refresh your results</label>
                                        <input id="btnReset" style="margin: 0px 10px 0px 0px" type="button" class="general-button btn-Reset" value="Reset" />  
                                        <input id="btnSearchNow"  style="width: 110px;margin: 0px 5px 0px 0px" type="button" class="general-button gen-btn-Orange" value="Search Now" onclick="showVrListAdvance('Supplier', $('#searchTextBox').val(), $('#basic_search_cat').val(), '<%=companyKey%>');"/>
                    ...
                    <div style="width:1010px;height:auto;float:left;display:none;" id="searchDataResults">
                        ...
                        <div class="searchNonRegistertedResult">
                            ...
                            <div style="margin-top: 30PX;">
                                <!-- <input id="btnnonGenerateRFQ" type="button" value="Generate RFQ" class="general-button gen-btn-Orange" /> -->
                                <a onclick="this.href='suppliers.jsp?name='+$('#selected_out_network_name').val()+'&id='+$('#selected_out_network_id').val()+''"><input id="btnContact" type="button" value="Contact" class="general-button gen-btn-Orange" /></a>
