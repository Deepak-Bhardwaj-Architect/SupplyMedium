...
%>
            <div style="background:#ffffff;display:block;width: 200px;padding:10px;height: auto;top: <%=(230+(250*ad))%>px;position: absolute;right:0;">
                <a href="<%=cabs.getLinkPage()%>" target="_blank">
                    <img style="display:block;" width="200"  src="<%=SmProperties.dataPathUrl+"company-" + cabs.getCompanyKey() + File.separator + "ad" + File.separator+cabs.getImagePath()%>" title="<%=cabs.getHoverText()%>">
