...
function deleteDepartment()
{
 ...
 $.ajax({
        ...
        success: function(data)
        {
            ...
            //window.location.href ='adminDepartments.jsp';
            $('#deptusersel').html('');
...
function showDeptPrev(deptKey)
{
    ...
    $.ajax({
        ...
        {
            //alert(data);
            document.getElementById('showDepartmentPerm').innerHTML = data;
            //$('#groupPermId').show();
        },
        error: function(xhr, textStatus, errorThrown)
        {
...
function updateDeptPrev()
{
    $.ajax({
        type: "POST",
        dataType: 'text',
        url: "PermDepartmentUpdate",
        data:
                {
                    'deptKey': document.getElementById('deptPermId').value,
                    'addfolder':document.getElementById('addfolder').checked,
                    'delfolder':document.getElementById('delfolder').checked,
                    'addfile':document.getElementById('addfile').checked,
                    'delfile':document.getElementById('delfile').checked,
                    'postAnno':document.getElementById('postAnno').checked
                },
        success: function(data)
        {
//            alert(data);
//            document.getElementById('showGroupPerm').innerHTML = data;
            ShowToast("Department privileges updated", 2000);
            //$('#groupPermId').show();
        },
        error: function(xhr, textStatus, errorThrown)
        {
