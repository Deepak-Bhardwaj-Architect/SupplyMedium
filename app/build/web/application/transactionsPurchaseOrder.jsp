...
<html>
    <head>
        ...
        <link rel="stylesheet" href="inside/Custpo_form_errorome_Buttons.css">
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');<% if (request.getParameter("generatepo") != null) {%>swapWkTabs2('po_form_tab', 'po_request_tab');$('#po_request_content').hide();$('#po_form_content').show();<% }%>" onkeydown="displayunicode(event);">
                ...
                <div id="trans_super_container" style="">
                    ...
                    <div id="trans_content" class="trans_content" style="display: block;">
                                    ...
                                    <table id="po_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="po_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                            ...
                                                            if (companyKey.equals(trb.getCompany_key_from())) {
                                                                ...
                                                                if (cstatus.equals("Accepted")) {
                                                                    if (trb.getPo_is_inv_created().equalsIgnoreCase("no")) {
                                                                        cstatus = "<a href='transactionsInvoices.jsp?generateinvoice=" + trb.getTrans_key() + "&key=" + trb.getCompany_key_from() + "' style='text-decoration:underline;'>Generate Invoice</a>";
                                                                    } else {
                                            ...
                                            <tr <%=stl%> <% if (trb.getTrans_key().equals(request.getParameter("nid"))) {
                                                ...
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><img src="inside/<%=img%>"/></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=trb.getPo_trans_rqf_key()%></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=trb.getPo_created_on().split(" ")[0]%></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=cname%></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=cphone%></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=cemail%></td>
                                                <td class="rowBorder" onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key()%>','<%=trb.getCompany_key_to()%>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to()%>');
                                                                                                    showPoPopupData(<%=trb.getTrans_key()%>,<%=companyKey%>,<%=trb.getCompany_key_from()%>);"><%=StateMaster.showStateFromKey(cstate)%></td>
                                                <td class="rowBorder"><%=cstatus%></td>
                                                <td class="rowBorder" onclick="window.location.href='';"><a target="_blank" href="<%=SmProperties.dataUrlPath%>company-<%=companyKey%>/transaction/<%=trb.getPo_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                        }
                                                        if (al.size() == 0) {
                        ...
                        <div id="po_form_content" style="display:none;width:100%;" class="po_form_content">
                            <form method="post" action="TransPO" onsubmit="return poFormValidation()">
                                ...
                                <div class="po_form" style="width: 1000px;">
                                    ...
                                    <div class="po_buyer_det">
                                        ...
                                        <div class="trans_row">
                                            ...
                                            <input type="text" name="poRefNo" autocomplete="off" class="textbox" id="po_ref">
                                        </div>
                                    </div>
                                    <div class="addr_sep">
                                    </div>
                            ...
                            <div class="Cus_Popup_Outline po_add_item_popup_outline" style="width: 1100px !important;top:45%;height:350px;">
                                ...
                                <div style="margin-top:0px;margin-left:15px;float:left;"id="existingItem">
                                    ...
                                    <div class="item" style="width:1095px;float:left;margin-left:10px;margin-right:0px;position:relative;">
                                        ...
                                        <input type="hidden" id="selectedQuantityUnit" name="selectedQuantityUnit" value="PCS"/>
                                        ...
                                        <input type="hidden" class="selectedCurrencyUnit" id="selectedCurrencyUnit" name="selectedCurrencyUnit" value="USD"/>
                                    ...
                                    <div id="selectQuantityUnit" style="display:none;position: absolute;margin-left:491px;margin-top:97px;padding:0px 2px;  border:1px solid #000; z-index: 99999;width:50px;height:80px;overflow-y:scroll;">                                <%                                ArrayList categoryList = QuantityTypeMaster.showAll();
                                    ...
                                    <div class="row" style="margin-top:40px;float:left;margin-left:250px;">
                                        <input id="po_add_item_popup_cancel" style="margin-left:100px;margin-right: 50px" type="button" class="gen-btn-Gray" value="Cancel" onclick="$('#po_add_item_popup').fadeOut();cancelQteItem();">
                                        <input id="save_item_btn" style="margin-left:60px;" type="button" class="gen-btn-blue" value="Add" tabindex="8" onclick="addQteItem();">
                                    </div>
                                    <div class="po_error" id="rfq_item_form_error" style="width:980px">
                                    </div>
                                </div>
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:none; " id="addNewItem">
                                    ...
                                    <div class="po_error" id="rfq_item_form_error2" style="width:620px;font-weight:bold;color:green;font-size:14px;padding-top:10px;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="display: none; z-index: 1000;" class="Custome_Popup_Window" id="po_inquire_popup">
                            <div class="Cus_Popup_Outline po_inquire_outline">
                                ...
                                <input type="button" class="gen-btn-blue" value="Send" onclick="showLoading();" style="margin-left: 250px;margin-top: 30px;margin-bottom: 20px;" id="chat_inquire_save_btn">
                            </div>
                        </div>
                    </div>
                </div>
