...
%>
                        ...
                        <%
                        for(int company=0;company<6 && company<recObj.size();company++)
                        {
                        ...
                        <div class="result-set-data" style="border:none;width:220px;float:left;">
                        	...
                        	<img src="<%=SmProperties.dataPathUrl+"companies"+File.separator+recCB.getCompanyKey()+".png"%>" width="200" height="200"
                    ...
                    <div class="select-query">
                        ...
                        <%
                        for(int ad=0;ad<6 && ad<alAdv.size();ad++)
                        {
                        ...
                        <div class="result-set-data" style="border:none;width:220px;float:left;">
                            <a href="<%=cabs.getLinkPage()%>" style="text-decoration: none;" target="_blank">
                                ...
                                src="<%=SmProperties.dataPathUrl+"company-" + cabs.getCompanyKey() + File.separator+"ad"+File.separator+cabs.getImagePath()%>"
                    ...
                    %>
                        ...
                        <%
                        for(int product=0;product<6 && product<alGPIM.size() ;product++)
                        {
                            ...
                            else
                            {
                                    ...
                                    for(int i=0;i<1;i++)
                                    productImageName = SmProperties.dataPathUrl +"products"+File.separator+pics[i].replace("@#@","");
                            }                            
