...
--
-- Definition of table `bank_master`
--
...
--
-- Definition of table `department_perm_master`
--

DROP TABLE IF EXISTS `department_perm_master`;
...
/*!40000 ALTER TABLE `department_perm_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `department_perm_master` ENABLE KEYS */;
...
--
-- Definition of table `group_perm_master`
--

DROP TABLE IF EXISTS `group_perm_master`;
...
/*!40000 ALTER TABLE `group_perm_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_perm_master` ENABLE KEYS */;
...
--
-- Definition of table `marketing_associate_master`
--

DROP TABLE IF EXISTS `marketing_associate_master`;
CREATE TABLE `marketing_associate_master` (
...
/*!40000 ALTER TABLE `marketing_associate_master` DISABLE KEYS */;
INSERT INTO `marketing_associate_master` (`marketing_associate_key`,`marketing_person_key`) VALUES 
 (1,0),
 (1440453386820,1);
/*!40000 ALTER TABLE `marketing_associate_master` ENABLE KEYS */;


--
-- Definition of table `marketing_person_business_master`
--

DROP TABLE IF EXISTS `marketing_person_business_master`;
CREATE TABLE `marketing_person_business_master` (
...
/*!40000 ALTER TABLE `marketing_person_business_master` DISABLE KEYS */;
INSERT INTO `marketing_person_business_master` (`marketing_person_business_key`,`date_of_registration`,`marketing_person_key`,`company_key`) VALUES 
 ...
 (12,'2015-07-31',1,12),
 (13,'2015-08-06',1,13);
/*!40000 ALTER TABLE `marketing_person_business_master` ENABLE KEYS */;


--
-- Definition of table `marketing_person_master`
--

DROP TABLE IF EXISTS `marketing_person_master`;
CREATE TABLE `marketing_person_master` (
...
/*!40000 ALTER TABLE `marketing_person_master` DISABLE KEYS */;
INSERT INTO `marketing_person_master` (`marketing_person_key`,`date_of_joining`,`marketing_person_name`,`address_details`,`account_details`,`contact_number`,`e_mail`,`pass_word`,`user_status`) VALUES 
 ...
 (1,'2015-04-01','WebKrit Infocom','Zirakpur, Mohali','NA','+91-82880-33280','info@webkrit.com','wbr@#123','Active'),
 (1440453386820,'2015-04-01','Sunil Marwal','Sector-26, Chandigarh','NA','+91-93572-68288','marwalsunil@gmail.com','sunil@#123','Active');
/*!40000 ALTER TABLE `marketing_person_master` ENABLE KEYS */;
...
INSERT INTO `product_master` (`item_key`,`company_key`,`item_name`,`item_description`,`part_no`,`sku`,`barcode`,`quantity`,`quantity_key`,`price`,`currency_key`,`tax`,`product_display`,`pics_count`) VALUES 
 (4,1,'Google Apps Integration','Google Apps Integration','','','','1.00',35,'5000.00',69,'0.00','NO','1437724162143.png@#@'),
 ...
 (6,11,'cctv security','','','','','1.00',35,'12500.00',69,'0.00','NO','1438055245899.png@#@'),
