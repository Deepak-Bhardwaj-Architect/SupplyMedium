                ...
                <form name="loginform" id="loginform" method="post" action="CheckLoginCredential">
                    ...
                    <div class="loginleft">
                        <div class=" loginlbl labellink">
                            <input type="text" name="email" value="info@supplymedium.com" id="email" class="required email textbox" style="width: 290px;">
                        </div>
                        <div class=" loginlbl labellink" style="margin-bottom: 20px;">
                            <input type="password" value="SupplyMedium!1" name="password" id="password" class="required textbox" style="width: 290px;">
