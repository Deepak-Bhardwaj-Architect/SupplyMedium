            ...
            <div class="admin_companies">
                ...
                <%
                    ...
                    + "company_master.company_key=company_mailing_address_master.company_key");
                        ...
                        SmProperties.folderPath = request.getRealPath("").replace("SMadmin", "SMlatest") + File.separator + "cropData" + File.separator+"company-"+rs.getString("company_master.company_key");
