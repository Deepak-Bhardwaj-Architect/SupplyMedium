            ...
            <div class="dashboardcontainer contentcontainer" style="min-height:834px;">
                ...
                <div id="divcompanybasedreport" style="display: block;"> <!-- Company Based Report -->
                    ...
                    <div class="report_type">
                        <div id="time_report_table" class="singleLine ReportTabUnSelect"><a href="homeDashboard.jsp" style="color:#000;">Report<a/></div>
                        <div id="time_report_chart" class="singleLine ReportTabSelected"><a href="homeDashboardTC.jsp" style="color:#000;">Chart</a></div>

                        <div id="chart1" style="margin:120px 0; width:500px; height:500px;"></div>
                        ...
                        <script type="text/javascript">$(document).ready(function () {
                                ...
                                var s1 = [307, 234];
                                var ticks = ['22-Dec-2014', '26-Dec-2014'];
