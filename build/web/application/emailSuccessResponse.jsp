    ...
    <body>
        ...
        <div class="contentcontainer">
            <div class="successcontent">
                ...
                <div class="resmsg">
                    <font size="4">Thank you for registering with Supply Medium.</font><br><br> An email has been sent to your registered email account with instructions to activate your account. Please log in to your email to complete the activation process. Please remember to check the junk/spam folder.
