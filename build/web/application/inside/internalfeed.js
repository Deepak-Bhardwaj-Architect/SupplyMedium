    ...
    $.ajax({
		...
		success : function(data)
		{
                    ...
                    feedContent +="<div class='dilbag-lca'>";
                        ...
                        feedContent +="</div>";
                    feedContent +="</div>";
                    feedContent +="<div style='background:#F8F8F8;float:left;width:500px;display:none;padding:15px;' id='cmnt_"+id+"'>";
                        feedContent +="<textarea id='cmntddd_"+id+"' placeholder='Write comment' style='width:460px;height:50px;background:#FFFFFF;'></textarea>";
