                                ...
                                <div class="fixed_height">
                                    <table id="invoice_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="invoice_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                ...
                                                <td class="rowBorder">
                                                    <a style="float:left;" target="_blank" href="<%=SmProperties.urlPath%>company-<%=companyKey%>/transaction/<%=trb.getInv_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a>
