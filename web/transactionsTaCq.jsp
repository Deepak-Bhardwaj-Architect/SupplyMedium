...
<html>
    ...
    <div class="mainpage" id="mainpage" style="min-height:700px;background-color:#f1f1f1">
        ...
        <form id="tc_form" name="tc_form" action="TermsConditionsAction" method="post" enctype="multipart/form-data">
            <input type="hidden" name="transactionType" value="QTE">
                ...
                <div class="tc_content">
                    <div class="menu_container">
                        <div class="tab_container">
                            ...
                            <div class="tab_orange" id="quote_tab"><a href="transactionsTaCq.jsp" class="white">Quote</a></div>
                    ...
                    <div class="transet_container">
                        ...
                        <% TermsConditionsBean tcb= TermsConditionsMaster.show(companyKey, "QTE"); 
                        try
                        {
