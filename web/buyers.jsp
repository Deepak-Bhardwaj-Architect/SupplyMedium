            ...
            <div class="contentcontainer" style="min-height:709px;">
                ...
                <div id="supplier_ven_reg_content" style="">
                    ...
                    <div id="add_buyer_content" style="display: block;">
                        ...
                        <form class="ven_reg" onsubmit="if ($('#w9form_flag').is(':checked')){ if($('#w9form').val()===''){ ShowToast('Select W9 tax form',1500);return false; } };if($('#selectedVendorKey').val().trim()===''){ ShowToast('Select buyer from search list before add a buyer',1500);return false; }" id="ven_reg_form" name="ven_reg_form" action="VendorRegistration" method="post" enctype="multipart/form-data">
