...
<title>Supply Medium</title>
             ...
             <%
                if((SessionData)session.getAttribute("UserSessionData")==null)
                {
                ...
                //sessionObjpp.userType_.toString();
                
            %>
<!--<script>
Usr_anlys('<%=sessionObjpp.userType_.toString() %>');    
</script>-->
</head>
<body onload="Usr_anlys('<%=sessionObjpp.userType_.toString() %>');customizeMenu();pypl_rslt('<%=sessionObjpp.pypl_rslt %>');">
