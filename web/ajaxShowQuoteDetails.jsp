                    ...
                    <div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                        ...
                        <div class="items" id="popup_items">         
                            ...
                            <div id="item1" class="item" style="width:970px;float:left;margin-top:5px;margin-left:15px;margin-right:0px;">
                                ...
                                <input type="text" autocomplete="off" class="textbox" maxlength="7" id="quantity1" style="width:28px;" disabled="" value="<%=transactionQteItemBean.getQuantity()%>">
                        ...
                        <div id="supplier_ctrls" class="supplier_controls">
                            <%
                                if (!session.getAttribute("userKey").toString().equals(request.getParameter("supplierKey")) && objTr.getQ_trans_status().equals("QTE Sent")) {  %>
