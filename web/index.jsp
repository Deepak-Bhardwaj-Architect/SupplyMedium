...
<HTML>
    ...
    <DIV id="regnheader" class="header">
        <DIV class="headercontent">
            <DIV class="logo">
                <A href="index.jsp">
                    <IMG 
                        style="border: currentColor; margin-top: 10px;" src="inside/logo.png" 
            ...
            <FORM id="loginform" method="post" name="loginform" action="LoginAccess">
                <DIV class="loginleft">
                    ...
                    <DIV class="remembercontainer">
                        ...
                        <INPUT style="cursor: pointer;" id="remember" name="remember" 
                                                                                   type="checkbox">
                        <DIV>
                        </DIV>
                        </DIV>
                        <LABEL style="line-height: 18px; margin-left: 5px; cursor: pointer;" 
                                                                        class=" loginlbl" for="remember">Remember							me on this 
                                                    computer</LABEL>-->
                    </DIV>
                ...
                <DIV style="height: 175px;" class="loginright">
                    <DIV class=" loginlbl labellink">						New to Supply Medium ? <BR>
                        <A id="registerlink" 
                           class="color:#0097b9;" href="companyRegistration.jsp"> 
                            Register a company or Business for free </A>
                    </DIV>
                    <DIV style="margin-bottom: 20px;" class="loginlbl labellink">						Don't have 
                        an account ?<BR>
                ...
                <INPUT style="margin-top: 5px; margin-left: 250px;" class="gen-btn-Orange" value="Login" type="submit">
            </FORM>
        </DIV>
    </DIV>
    ...
    <DIV class="footer">
        <DIV class="footercontent">
            <DIV class="copyrights">Copyright 2014. <A style="color: rgb(255, 255, 255); text-decoration: none;" 
                                                       href="http://supplymedium.com/" target="_blank">Social Medium, 
                    Inc.</A>
            </DIV>
        </DIV>
    </DIV>
