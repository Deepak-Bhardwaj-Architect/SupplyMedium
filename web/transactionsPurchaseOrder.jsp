                                ...
                                <div class="fixed_height">
                                    <table id="po_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="po_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            %>
                                            <tr <%=stl%> onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key() %>','<%=trb.getCompany_key_to() %>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to() %>');
                                                ...
                                                <td class="rowBorder"><a target="_blank" href="cropData/company-<%=companyKey%>/transaction/<%=trb.getPo_trans_rqf_key()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                }
                                                if (al.size() == 0) {
                            ...
                            <div class="Cus_Popup_Outline po_add_item_popup_outline" style="width: 1100px !important;top:45%;height:350px;">
                                ...
                                <div style="margin-top:0px;margin-left:15px;float:left;"id="existingItem">
                                    ...
                                    <div class="item" style="width:1095px;float:left;margin-left:10px;margin-right:0px;position:relative;">
                                        ...
                                        <input type="hidden" id="selectedCurrencyUnit" name="selectedCurrencyUnit" value="USD"/>
                                        ...
                                        <input type="hidden" id="selectedCurrencyUnit"> 
                                    </div>
