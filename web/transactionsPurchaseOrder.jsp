                                ...
                                <div class="fixed_height">
                                    <table id="po_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="po_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            %>
                                            <tr <%=stl%> <% if(trb.getTrans_key().equals(request.getParameter("nid"))){out.println("style='background:#c9c9c9;'");} %> onclick="$('#po_popup').fadeIn();showPoDetailInPopup('<%=trb.getTrans_key() %>','<%=trb.getCompany_key_to() %>','<%=trb.getCompany_key_from()%>');$('#toKey').val('<%=trb.getCompany_key_to() %>');
