...
<HTML>
    ...
    <BODY onload="lockUnlock('webkrit_content_loader');window.location.href='home.jsp';">
    <LINK rel="stylesheet"
    ...
    <DIV style="min-height: 700px; background-color: rgb(241, 241, 241);" id="mainpage"
        ...
        <form id="paypalForm" name="paypalForm" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
            ...
            <input type="hidden" id="item_name" name="item_name" value="SupplyMediuam Platform Charges" />
...
<%
        CompanyMaster.updatePlatformAmountGenerated(session.getAttribute("companyKey").toString(), ""+total);
