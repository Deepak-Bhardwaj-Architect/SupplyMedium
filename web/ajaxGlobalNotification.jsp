...
<%
   ...
   {    
    ...
    for (int i = 0; i < notification.size(); i++) {
        ...
        connStr = "";
        connStr += "<div class='notificationcontainer' id=" + nb.getNotificationKey()
                + " onclick='showNotification(\""+nb.getNotificationKey()+"\",\""+nb.getNotificationType()+"\",\""+nb.getNotificationTypeId()+"\");'>";
