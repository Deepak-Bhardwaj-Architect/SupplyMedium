                ...
                <div class="contentcontainer" style="min-height:0px;">
                    <form name="usermgmtfrm" id="usermgmtfrm" style="min-height:600px;" novalidate="novalidate">
                        <div id="usermgmt_content" style="display:block">
                            ...
                            && addUser.equalsIgnoreCase("yes") 
                            && adminTab.equalsIgnoreCase("yes")) || userType.equals("Admin"))
                                {
                                %>
                                ...
                                <div class="tablecontent" id="table_content" style="position:relative;">
                                            ...
                                            <table id="UserList" style="width: 997px;" class="dataTable" aria-describedby="UserList_info">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="rowBorder sorting" role="columnheader" tabindex="0" aria-controls="UserList" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 70px;">Action</th>
                                                    </tr>
                                                </thead>
                                    ...
                                    for (int i = 0; i < users.size(); i++) {
                                        ...
                                        if(i%2==0)
                                            ...
                                            rowval="class='odd'";
                                %>
                                <tr id="row_<%=i %>" <%=rowval%> onclick="selectUserRow('<%=i %>','<%=scb.getUserKey() %>','<%=scb.getAccountStates() %>',<% if((!userType.equals("Admin") 
                            && delUser.equalsIgnoreCase("yes") 
                            && adminTab.equalsIgnoreCase("yes")) || userType.equals("Admin"))
                                { out.print("'yes'");} else {out.print("'no'");} %>);">
                                                    <td  class="sorting_1 rowBorder"><%=scb.getFirstName()%> <%=scb.getLastName()%> </td>
                                                    <td  class="rowBorder"><%=scb.getCity()%></td>
                                                    <td  class="rowBorder"><%=scb.getEmail()%></td>
