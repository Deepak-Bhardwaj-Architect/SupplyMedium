<div class="header" id="header">
    <div class="headercontent">
        <div class="header_left">
            ...
            <div class="logo" id="supplymedium_logo" style="position: relative; display: none;"> <a href="/index.jsp" style="cursor: pointer;"> <img src="./files/mugshot.png" style="border: medium none ; float: left; margin-top: 10px;" height="90" width="90"> </a> <label class="company_label" id="company_label" style="width: auto; float: left;">mutti soft sol</label>
            </div>
        </div>
...
<!--
<script type="text/JavaScript" src="./files/notifi_dropdown.js"></script>
<script type="text/JavaScript" src="./files/userheader.js"></script>
-->
    ...
    <div id="Menu"><!-- Main Menu  -->
        ...
        <div class="nav_Sub Gen_nav">
            ...
            <ul id="SubAdmin" style="display: block;">
                <li id="SubAdmin_User" class="<%=usr  %>"><a title="Admins" href="/SupplyMedium/SM-admin/home.jsp">Admins</a></li>
                <li style="width: 2px;"> <br>
                </li>
                <li id="SubAdmin_Group" class="<%=cmpny  %>"><a title="Company" href="/SupplyMedium/SM-admin/company.jsp">Company</a></li>
