...
if((!userType.equals("Admin") 
                            && addGroup.equalsIgnoreCase("yes") 
                            && groupTab.equalsIgnoreCase("yes")) || userType.equals("Admin"))
{
%>                                    
...
%>
                                ...
                                <div class="grouplistbox">
                                    ...
                                    <select multiple="multiple" class="grouplistsel listbox" name="grouplistsel" id="grouplistsel" size="5" onChange="$('#groupKey').val(this.value);showGroupPrev(this.value);showNonExistingUserInGroup();showExistingUserInGroup();//getGroupData(this.value);">
                                        <%
                            ...
                            <div class="grouppriv" id="showGroupPerm">
                            </div>
                            <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
