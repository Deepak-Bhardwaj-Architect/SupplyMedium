...
<!--        <script type="text/JavaScript" src="inside/jquery.dataTables.js">
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');<% if(request.getParameter("open")!=null) { if(request.getParameter("open").equals("announcement")){ %> $('#annomt_content').show();$('#folder_content').hide(); <% } } if(request.getParameter("key")!=null) { %> $('#departmentKey').val('<%=request.getParameter("key") %>'); showDepartmentfeed(); <% } %> <% if(request.getParameter("deptKey")!=null) { %>$('#departmentKey').val('<%=request.getParameter("deptKey") %>');showFolderOfDepartment('<%=request.getParameter("deptKey") %>');$('#corporateDepartmentSelectedFolder').val('<%=request.getParameter("folderName") %>')<% } %>">
            ...
            <div class="contentcontainer" style="min-height:675px;">
                <div class="leftcontent">
                    ...
                    <div class="recommend_container">
                        ...
                        <div class="recommend_content mCustomScrollbar _mCS_8" id="recommend_content">
                            <div class="mCustomScrollBox mCS-dark-thick" id="mCSB_8" style="position:relative; height:100%; overflow:hidden; max-width:100%;">
                                <div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
...
<%
                ...
                {
%>
                                        <input type="submit" class="gen-btn-Orange post_feed_btn" id="post_annomt_btn" value="Post">
<%                    
                }
%>  
                                    </div>
