    ...
    <body onLoad="getPasswordPolicy()">
        ...
        <div class="logincontentcontainer">
            <div class="logincontent">
                ...
                <form action="ConfirmUserAccount" method="post" name="pwrresetfrm" id="pwrresetfrm" style="margin-top:70px;margin-left:100px;" novalidate="novalidate">
                    <div class="row">
        ...
        <div class="footer">
            <div class="footercontent">
                <div class="copyrights">Copyright 2014. <a href="http://supplymedium.com" style="color: #ffffff; text-decoration: none;" target="_blank">Social Medium, Inc.</a>
                </div>
            </div>
        </div>
        <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
