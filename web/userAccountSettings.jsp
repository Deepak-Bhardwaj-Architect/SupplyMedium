...
<html>
    ...
    <body onLoad="lockUnlock('webkrit_content_loader'); Usr_anlys('Admin'); customizeMenu(); pypl_rslt('null');">
                        ...
                        <div class="profilecontainer">
                            <div class="stripcontentleft" id="uploadpiccontent">
                                <div class="innercontent" style="margin-left:250px;"><!--showImagePreview(this, 'profilepicture'); showImagePreview(this, 'header_userimage');-->
                                    <input type="file" class="file" style="font-size: 12px;" title="The logo dimensions should be at most 500x500 pixels in size should not exceed 1 MB.  Supported formats are jpg, png, bmp, gif and tiff." name="profilepictxt" id="profilepicid" onchange="updateUserProfileImage(this);">
                            ...
                            <div class="stripcontentright">
                                <div class="label stripcontenttext" style="width: auto; margin-left: 32px; margin-top: 5px;line-height:10px;">
                                    ...
                                    %>
                                    <img class="profilepic" id="profilepicture" src="<%=userImage%>">
                                </div>
                            </div>
                        </div>
                    </form>
