            ...
            <div class="contentcontainer">
                <div id="internal_page_content" style="">
                    ...
                    <div class="feed_content" style="width: 550px;margin-left:8px;">
                        ...
                        <div id="newfeed" class="newfeed">                            
                            ...
                            <input type="hidden" name="isFeedCompanyWide" value="yes" />
                                ...
                                <div class="feed_btns">
                                    <input type="submit" class="gen-btn-Orange post_feed_btn" id="post_feed_btn" value="Post" style="margin-left:25px;">
                    ...
                    <div class="recommend_container">
                        ...
                        <div class="recommend_content mCustomScrollbar _mCS_9" id="recommend_content">
                            <div class="mCustomScrollBox mCS-dark-thick" id="mCSB_9" style="position:relative; height:100%; overflow:hidden; max-width:100%;">
