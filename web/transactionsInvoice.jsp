...
<html>
    ...
    <form id="paypalForm" name="paypalForm" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        ...
        <input type="hidden" id="rtrn" name="return" value="<%=SmProperties.emailUrl %>transactionsDone.jsp"/>
                                                    ...
                                                    if (companyKey.equals(trb.getCompany_key_from())) {
                                                        ...
                                                        if (cstatus.equals("Accepted")) {
                                                            if (trb.getInv_is_po_created().equalsIgnoreCase("no")) {
                                                                cstatus = "<a onclick=\"javascript:$('#amnt').val('"+trb.getInv_total_billing_amount()+"');$('#rtrn').val($('#rtrn').val()+'?invoiceKey="+trb.getInv_trans_rqf_key()+"');$('#paypalForm').submit();\">Make a Payment</a>";
                                                            } else {
                        ...
                        <div style="display: none;z-index:2000;" class="Custome_Popup_Window" id="invoice_add_item_popup">
                            <div class="Cus_Popup_Outline invoice_add_item_popup_outline"style="height:400px">
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;" id="existingItem">
                                    <div class="items_head">
                                        <label class="trans_label" style="width:385px;margin-right:20px;">Item Name / Item Description / Batch/Lot No / SKU No / Barcode</label>
                                    ...
                                    <div class="item" style="width: 975px;float:left;margin-left:10px;margin-right:0px;position:relative;">
                                        ...
                                        <input type="hidden" name="selectedCurrencyUnit" id="selectedCurrencyUnit" value="USD" >
