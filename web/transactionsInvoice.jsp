...
<!--    <form id="paypalForm" name="paypalForm" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        ...
        <input type="hidden" id="rtrn" name="return" value="<%=SmProperties.emailUrl %>transactionsPayment.jsp"/>
                                                    ...
                                                    if (companyKey.equals(trb.getCompany_key_from())) {
                                                        ...
                                                        if (cstatus.equals("Accepted")) {
                                                            if (trb.getInv_is_po_created().equalsIgnoreCase("no")) {
                                                                cstatus = "<a style='text-decoration: underline;color:blue;' onclick=\"javascript:$('#rtrn').val($('#rtrn').val()+'?id="+trb.getInv_trans_rqf_key()+"');$('#item_name').val('SupplyMedium Invoice No: "+trb.getInv_trans_rqf_key()+"');$('#amnt').val('"+trb.getInv_total_billing_amount()+"');$('#rtrn').val($('#rtrn').val()+'?invoiceKey="+trb.getInv_trans_rqf_key()+"');$('#paypalForm').submit();\">Make a Payment</a>";
                                                            } else {
