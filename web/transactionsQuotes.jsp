                            ...
                            <form method="post" action="TransRfqToQuoteDecode"   onsubmit="return quoteFormValidation();">
                                ...
                                <div class="quote_form" style="width: 1000px;">
                                    ...
                                    <div class="items_head" style="padding-left:15px;">
                                        ...
                                        <label class="trans_label" style="width:64px;margin-right:4px;">Part No</label>
                            ...
                            <div class="Cus_Popup_Outline quote_add_item_popup_outline" style="width: 1100px !important;top:45%;height:350px;">
                                ...
                                <div style="margin-top:0px;margin-left:15px;float:left;"id="existingItem">
                                    <div class="items_head">
                                        <label class="trans_label" style="width:370px;margin-right:10px;">Item Name / Item Description / Part No / SKU No / Barcode</label>
                                    ...
                                    <div class="items_head2" id="resulted-data-head" style="display:none;">                                        
                                        ...
                                        <label class="trans_label" style="width:120px;margin-right:20px;font-weight:bold;">Part No</label>
