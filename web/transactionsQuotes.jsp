                            ...
                            <form method="post" action="TransRfqToQuoteDecode" onsubmit="return quoteFormValidation();">
                                ...
                                <div class="quote_form" style="width: 1000px;">
                                    ...
                                    <div class="items_head" style="padding-left:15px;">
                                        ...
                                        <label class="trans_label" style="width:64px;margin-right:4px;">Batch/Lot No</label>
                                    ...
                                    <div class="items" id="items">
                                        ...
                                        <input type="text" autocomplete="off" class="textbox" maxlength="7" name="quantity" id="popup_quantity_<%=count%>" onkeyup="mult2(<%=count%>);tl_clcltn_RfqToQoute('<%=count %>');" style="width:28px;" value="<%=transactionRfqItemBean.getQuantity()%>">
                                        ...
                                        <input type="text" autocomplete="off" class="textbox" value="1" name="price" id="popup_price_<%=count%>" onkeyup="mult2(<%=count%>);tl_clcltn_RfqToQoute('<%=count %>');" style="width:50px;margin-right:0px;">
                                        <div class="quantity_unit" id="currency1" style="margin-right:10px;">USD</div>
                            ...
                            <div class="Cus_Popup_Outline quote_add_item_popup_outline" style="width: 1100px !important;top:45%;height:350px;">
                                ...
                                <div style="margin-top:0px;margin-left:15px;float:left;"id="existingItem">
                                    <div class="items_head">
                                        <label class="trans_label" style="width:370px;margin-right:10px;">Item Name / Item Description / Batch/Lot No / SKU No / Barcode</label>
                                    ...
                                    <div class="items_head2" id="resulted-data-head" style="display:none;">                                        
                                        ...
                                        <label class="trans_label" style="width:120px;margin-right:20px;font-weight:bold;">Batch/Lot No</label>
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:none; " id="addNewItem">
                                    <div class="items_head" style="margin-left: 25px;">                                        
                                        ...
                                        <label class="trans_label" style="width:98px;margin-right:20px;">Batch/Lot No</label>
