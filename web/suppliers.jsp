...
<html>
    ...
    <BODY onLoad="lockUnlock('webkrit_content_loader');<% if(request.getParameter("name")!=null){ %> showCompaniesNonVendorSearch('<%=request.getParameter("name") %>', 'Supplier'); <% } %>">
    ...
    <div class="mainpage" id="mainpage" style="min-height:700px;background-color:#f1f1f1">
        ...
        <div class="page">
                ...
                <div id="supplier_ven_reg_content" style="">
                    ...
                    <div id="add_buyer_content" style="display: block;">
                        ...
                        <div class="to_comp">
                            ...
                            <input type="text" autocomplete="off" id="to_company" style="width:920px;" class="textbox" onKeyUp="showCompaniesNonVendorSearch(this.value, 'Supplier');">
                        </div>
                        <form class="ven_reg" id="ven_reg_form" name="ven_reg_form" onsubmit="if ($('#w9form_flag').is(':checked')){ if($('#w9form').val()===''){ ShowToast('Select W9 tax form',1500);return false; } };if($('#selectedVendorKey').val().trim()===''){ ShowToast('Select supplier from search list before add a supplier',1500);return false; }" action="VendorRegistration" method="post" enctype="multipart/form-data">
                            <input type="hidden" id="selectedVendorKey" name="selectedVendorKey">
                            <input type="hidden" id="sendertype" name="sendertype" value="Buyer">
                            ...
                            <div class="ven_reg_btns">
                                ...
                                <input type="submit" class="gen-btn-Orange" value="Send" id="add_vendor_btn">
                            </div>
            ...
            <div id="search_ad" class="ad_container" style="margin-left: 1178.5px;">
            </div>
        </div>
