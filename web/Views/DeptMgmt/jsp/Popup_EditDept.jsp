...
$(function(){
	...
	$("#edit_cancel_dept").click(function(){$("#edit_group_popup").hide();});
	
	$('#edit_dept_input').keyup(function() 
	{
			...
			<td style="vertical-align: middle;">
				<div class="Popup_Outline_NewGroup Cus_Popup_Outline popuplayout" >
					...
					<div class="row">
						...
						<input type='text' id='edit_dept_input' name='edit_dept_input'
							 class="textbox required" style="width:300px;height:20px;"/>
					   <label id="edit_dept_input_err" style="margin-left:150px" class="error"></label> 
					</div>

					<div class="row" style="margin-top:60px;margin-left:120px;">
						
						<input id="edit_cancel_dept" type='button' style="margin-right:20px"
								class="gen-btn-Gray" value="Cancel" />
						<input type='button' id="edit_dept"
