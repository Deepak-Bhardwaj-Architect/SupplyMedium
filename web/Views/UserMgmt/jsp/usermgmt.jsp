                ...
                <form name="usermgmtfrm" id="usermgmtfrm" style="min-height:600px;">
                    <div id="usermgmt_content" style="display:block">
                        <div class="tabbar">
                            ...
                            <div class="highlight" id="user_details" style="display:block;">List Of Users</div>

                            <div class="normal" id="new_users" style="display:block;">Add User</div>
                        </div>
                        ...
                        <div class="newusercontent" id="newuser_content" style="display:none;">
                            ...
                            <div class="contentdetail" id="content_detail" style="padding-top:60px;">
                                ...
                                <div class="row" style="margin-left: 60px;">
                                    ...
                                    <input type="text" name="phone" id="phone" class="required textbox" onblur="validatePhoneNo(this.value)" />
                                ...
                                <div style="margin-left: 350px; margin-top: 14px; float: left;">
                                    ...
                                    <input
                                        ...
                                        class="gen-btn-Gray" onclick="reset('usermgmtfrm');
                                                resetNewUserFrm();"/>
