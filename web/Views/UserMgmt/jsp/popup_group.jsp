...
$(function(){
	...
	$("#cancel_group").click(function(){$("#add_group_popup").hide();});
	
	$('#new_group_input').keyup(function() 
	{
			...
			<td style="vertical-align: middle;">
				<div class="Popup_Outline_NewGroup Cus_Popup_Outline popuplayout">
					...
					<div class="row">
						...
						<input type='text' id='new_group_input' name='new_group_input'
							 class="textbox required" style="width:300px;height:20px;"/>
						<label id="new_group_input_err" style="margin-left:150px" class="error"></label> 
					</div>

					<div class="row" style="margin-top:60px;margin-left:120px;">
						
						<input id="cancel_group" type='button' style="margin-right:20px"
								class="gen-btn-Gray" value="Cancel" />
								
						<input type='button' id="save_group" 
