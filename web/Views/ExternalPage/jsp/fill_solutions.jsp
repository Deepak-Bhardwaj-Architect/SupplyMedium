...
<div class="fill_left_content">
	...
	<fieldset class="external_fieldset" style="padding-top:4px;">
		...
		<input type="text" class="external_textbox"  id="solutions_fill_video_url_1">
		...
		<div class="content_text" id="solutions_video_fill_content_1" style="display:none"></div>
	...
	<fieldset class="external_fieldset">
		...
		<input type="text" class="external_textbox" id="solutions_fill_image_text_1">
		<div class="content_lbl">Content</div>
		<div class="content_text" id="solutions_fill_image_content_1" style="display:none"></div>
	...
	<div class="external_image_content">
		<form id="solutions_file_upload_form_1" name="solutions_file_upload_form_1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadsevlet" style="margin-left:100px;padding-top:30px;">
		...
		<div class="PreviewImageContainer" style="position: absolute;margin: -55px 0px 0px 315px">
			<img class="img_prev" id="solutions_img_prev_1" src="${pageContext.request.contextPath}/Views/ExternalPage/images/default_img.png" />
		</div>
	...
	<fieldset class="external_fieldset">
		...
		<input type="text" class="external_textbox" id="solutions_fill_image_text_2">
		<div class="content_lbl">Content</div>
		<div class="content_text" id="solutions_fill_image_content_2" style="display:none"></div>
	...
	<div class="external_image_content">
		<form id="solutions_file_upload_form_2" name="solutions_file_upload_form_2" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadsevlet" style="margin-left:100px;padding-top:30px;">
		...
		<div class="PreviewImageContainer" style="position: absolute;margin: -55px 0px 0px 315px">
			<img class="img_prev" id="solutions_img_prev_2" src="${pageContext.request.contextPath}/Views/ExternalPage/images/default_img.png" />
		</div>
...
<div class="fill_right_content">
	<fieldset class="external_fieldset" style="padding-top:4px;">
		...
		<input type="text" class="external_textbox" id="solutions_fill_video_url_2">
		...
		<div class="content_lbl">Content</div>
		<div class="content_text" id="solutions_video_fill_content_2" style="display:none"></div>
	...
	<fieldset class="external_fieldset">
		...
		<input type="text" class="external_textbox" id="solutions_fill_image_text_3">
		<div class="content_lbl">Content</div>
		<div class="content_text" id="solutions_fill_image_content_3" style="display:none"></div>
	...
	<div class="external_image_content">
		<form id="solutions_file_upload_form_3" name="solutions_file_upload_form_3" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadsevlet" style="margin-left:100px;padding-top:30px;">
		...
		<div class="PreviewImageContainer" style="position: absolute;margin: -55px 0px 0px 315px">
			<img class="img_prev" id="solutions_img_prev_3" src="${pageContext.request.contextPath}/Views/ExternalPage/images/default_img.png" />
		</div>
	...
	<fieldset class="external_fieldset">
		...
		<input type="text" class="external_textbox" id="solutions_fill_image_text_4">
		<div class="content_lbl">Content</div>
		<div class="content_text" id="solutions_fill_image_content_4" style="display:none"></div>
	...
	<div class="external_image_content">
		<form id="solutions_file_upload_form_4" name="solutions_file_upload_form_4" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadsevlet" style="margin-left:100px;padding-top:30px;">
		...
		<div class="PreviewImageContainer" style="position: absolute;margin: -55px 0px 0px 315px">
			<img class="img_prev" id="solutions_img_prev_4" src="${pageContext.request.contextPath}/Views/ExternalPage/images/default_img.png" />
		</div>
