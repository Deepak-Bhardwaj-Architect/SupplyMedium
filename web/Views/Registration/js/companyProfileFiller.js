					...
					$("#businesscategory").trigger('update');
				        ...
				        var ctgry_lst=setValstr.split(",");                                        
                                        ...
                                        {   
                                            ...
                                            {    
                                            document.getElementById('slctd_ctgry_lst').innerHTML+="<li id='cat"+i+"' style='background:#B0B0B0;'>"+ctgry_lst[i]+" <span style='cursor:pointer;color:red;' onclick=\"javascript:rmv_ctgry('"+ctgry_lst[i]+"','cat"+i+"')\">X</span></li>";
                                            }
                                        }		
				},
