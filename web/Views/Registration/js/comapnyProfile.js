...
function updateCompanyProfile() {
    ...
    if($("#businesscategory2").val().replace(/^\s+|\s+$/g, '')==="")
    {
      alert("Please select at leat one category");  
    }
    else
    {    
...
//    var objlogo = document.getElementById("complogo").files;
//    alert(objlogo.length);
//    objlogo=document.getElementById("complogo").files[objlogo.length-1];
