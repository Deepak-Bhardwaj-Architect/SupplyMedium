...
<%@include file="../../Utils/jsp/header.jsp"%>
	...
	<div class="logincontentcontainer">
		...
		<form action="${pageContext.request.contextPath}/UserActivateServlet"
