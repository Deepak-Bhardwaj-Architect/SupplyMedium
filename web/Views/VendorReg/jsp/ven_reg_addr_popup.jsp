...
<form onSubmit="" method="post" style="display: none;" class="Custome_Popup_Window"
		...
		<div style="margin-top:50px;margin-left:95px;">
			<div class="row" >
				...
				<select id="branch_pop" name="branch_pop" class="selectbox">
			...
			<div class="row">
				<div class="label">Country/Region<span class="mandatory">*</span></div>

				<select id='countryregion_pop' name='countryregion_pop'
					class="selectbox required" onchange="fetchState(this.id)"></select>
			...
			<div class="row">
				...
				<input type='text' id='AddAddress_pop' name='AddAddress_pop'
			...
			<div class="row" style="margin-top:20px;">
					 <input id="Popup_Address_Cancel" style="margin-left:50px;margin-right: 50px"
					type='button' class="gen-btn-Gray" value="Cancel" />
					<input id="Popup_Address_OK" type='button' 
