...
<body>
	...
	<div style="display: none; z-index: 5000;" class="Custome_Popup_Window"
		id="supplier_form_popup">
		<div class="Cus_Popup_Outline"
			style="position: fixed; margin:auto;top: 60px; left: 133px;width: 1042px!important;height:500px!important;/*width: 1010px; height: 720px; margin-top:-360px;margin-left:-505px;*/border-radius: 0px;">
			...
			<div id="supplier_form_popup_content" style="overflow:auto;height:435px;float:left; position:relative;margin-top:10px;margin-bottom:10px;">
			
			<form class="ven_reg" id="popup_ven_reg_form" name="popup_ven_reg_form" action="${pageContext.request.contextPath}/VendorRegnServlet" method="post" enctype="multipart/form-data" >
			<div class="ven_reg_left">
						...
						<div class="row">
							...
							<input type="text" id="city_popup" name="city" class="textbox_disable" disabled/>
						</div>
					...
					<div class="ven_reg_right">
						...
						<div class="row">
							...
							<input type="text" id="typeofbusiness_popup" name="typeofbusiness" class="textbox_disable" />
						</div>
						...
						<div class="row">
							...
							<div id="naicscode_popup_select_div">
							 <select class="selectbox" name="naicscode_popup_select" id=naicscode_popup_select style="width:165px;">
							<option> Select NAICS Code </option>
							</select>
							</div>
							
							<input type="text" id="naicscode_popup_text" name="naicscode_popup_text" class="textbox" />
						</div>
					...
					<div class="buss_size_container">
						...
						<div class="buss_size_large">
							...
							<label class="des_text" for="buss_large_popup" ><b>Large:<br></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A domestic concren which, including domestic and foreign divisions and affiliates, normally 
						...
						<div class="buss_size_small">
							...
							<label class="des_text" for="buss_small_popup"><b>Small:<br></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"Small business cocren" means a concren, including its affiliates, that is independently 
					...
					<div class="buss_clari_container">
						...
						<label class="des_text" for="Disadvantaged_popup"><b>Disadvantaged:</b> In addition to meeting the requirements of the FAR definition, 
						...
						<label class="des_text" for="HubZone_popup"><b>HUBZone:</b> In addition to meeting the requirements of the FAR definition, any business
						...
						<label class="des_text" for="NonProfit_popup"><b>Non-Profit:</b> Any business or organization that has received non-profit status
						...
						<label class="des_text" for="Foreign_popup"><b>Foreign:</b> A concern which is not incorporated in the United States or an 
						...
						<label class="des_text" for="PublicSector_popup"><b>Public Sector:</b> An agency of the Federal or State Government, or a local municipality.
						</label>
						...
						<label class="des_text" for="ANCORITNCD_popup"><b>Alaska Native Corporations or Indian Tribe:</b> Not certified by the Small Business Administration as disadvantaged.
						</label>
					...
					<div class="ven_reg_btns" id="cntrl_btns">
						...
						<input type="button" class="gen-btn-Orange" style="margin-right:50px;width:auto!important;padding-left:10px!important;padding-right:10px!important;"  value="Respond to Inquiry" id="inquire_regn_btn"/>
					</div>
					...
					<div id="vendor_reg_popup_error" class="vendor_reg_error"></div>
			</div>
	...
	src="${pageContext.request.contextPath}/Views/VendorReg/js/supplier_popup.js"></script>
