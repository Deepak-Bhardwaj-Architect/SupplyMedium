...
function addBuyer()
{
    ...
    if ($("#state_0").val().replace(/^\s+|\s+$/g, '') === "" || $("#zipcode").val().replace(/^\s+|\s+$/g, '') === "")
    {
        ...
        {
            $("#cntct_dtl_er").fadeIn();
            document.getElementById("cntct_dtl_er").innerHTML="Update your contact detail for adding a vendor on following tab <b style='font-size: medium;font-style: italic;'> Admin >> Company Profile >> Address and other contact details </b>";
            setTimeout("$('#cntct_dtl_er').fadeOut()",5000);
        }
        else
        {
            $("#cntct_dtl_er").fadeIn()
            document.getElementById("cntct_dtl_er").innerHTML="Contact your company admin to update your company contact detail for adding a vendor on following tab <b style='font-size: medium;font-style: italic;'> Admin >> Company Profile >> Address and other contact details </b>";
            setTimeout("$('#cntct_dtl_er').fadeOut()",5000)
        }
        return;
    }
   ...
   $("#add_vendor_btn").attr("disabled", "disabled");
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if (data.result == "success")
            {
                ...
                resetVenRegForm();
                $("#add_vendor_btn").removeAttr("disabled"); 
