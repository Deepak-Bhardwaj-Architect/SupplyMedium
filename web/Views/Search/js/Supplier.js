...
function SerachResultContainor(vendor,autoNumber, regnKey,className,noOfRatings,avgRatings,bit )
{
        //alert(bit)
	var ratings;
	var dlt="";
	...
	var SerachResult=
		...
		+'<div class="searchCol3"><ul>'
				...
				+'<li class="searchCmpAddr" style="cursor:pointer;" onclick=rmv_frm_ntwrk("'+regnKey+'","Supplier");>'+dlt+'</li>'
