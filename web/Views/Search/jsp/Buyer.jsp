                ...
                <div id="search_buyer_content" style="display:none;">
                    <div style="position: relative;float: none;">
                        ...
                        <form id="advance_search_form" >
                            <input id="btnadvancedSearch" type="button" class="general-button btn-Advanced-down" align="right" value="Advanced search"  onclick="byr_al_srch();"/>
                            <div class="advancedSearchContainer">						
                                <div  style="margin: 15px 0px 5px 13px;">
                                    <label class="advacedLabel" for="advanPartNumber">Business Category</label>
                                ...
                                <div  style="margin: 15px 0px 5px 13px;">
                                    <label class="advacedLabel" for="advanPartNumber">Country</label>
                                ...
                                <div class="advancedRow" style="margin-bottom: 2px;">
                                    <div>
                                        <div style="margin-left: 114px" class="checkContainer">
