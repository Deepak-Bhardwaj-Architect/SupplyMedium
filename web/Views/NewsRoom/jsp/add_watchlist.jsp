...
$(function(){
	...
	$(".Gen_Cus_Popup_Close").click(function(){$("#add_watchlist_popup").hide();});
	$("#cancel_watchlist").click(function(){$("#add_watchlist_popup").hide();});
		...
		<tr>
			<td style="vertical-align: middle;">
				<div class="Popup_Outline_NewGroup Cus_Popup_Outline popuplayout" >
					...
					<div class="row">
						<div class="label" style="width:150px;">Watchlist Name</div>
						<input type='text' id='new_watchlist_input' name='new_watchlist_input'
							 class="textbox required" style="width:300px;height:20px;border: 1px solid #a5b7bb;"/>
						<label id="new_watchlist_input_err" style="margin-left:150px" class="error"></label> 
					</div>

					<div class="row" style="margin-top:60px;margin-left:120px;">
						
						<input id="cancel_watchlist" type='button' style="margin-right:20px"
								class="gen-btn-Gray" value="Cancel" />
						<input type='button' id="save_watchlist"
