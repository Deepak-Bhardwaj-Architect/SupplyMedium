...
//return "http://supplymedium.elasticbeanstalk.com";
			   ...
			   if(resJSON.result == "success")
				{
				  ...
				  // var adjacentDivMargin = parseInt($("."+adjacentDivClassName).css('marginLeft').replace("px", ""));
				   ...
				   $(".ad_container").css('marginLeft',marginLeft+3 );
                                   //ShowToast( "result : "+resJSON.message, 2000 );
				   
				}

				else 
				{
					//ShowToast( "Error : "+resJSON.message, 2000 );
				}
