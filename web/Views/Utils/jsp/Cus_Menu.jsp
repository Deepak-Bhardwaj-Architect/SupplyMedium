        ...
        <script type="text/javascript">
            ...
            $("#content_loader").show(        );
                ...
                $("#Search").live("click", function() {
                    ...
                    if (companyType == "Buyer" || companyType == "Buyers/Suppliers")
                    {
                        $("#mainpage").load("Views/Search/jsp/Supplier.jsp", function()
                        {
                            //$("#content_loader").hide();
            ...
            <div id="Menu">
                ...
                <div class="nav_Main Gen_nav" style="width:994px;">			
                    <ul class="MenuType1 DisplayMenu "  >
                        <li id="Network"><a  title="Home" >Home</a></li>
                        ...
                        <li id="Admin" style="width:117px;"><a  title="Admin" >Admin</a></li>
                    </ul>
                    <ul class="MenuType2 HideMenu ">
                        ...
                        <li id="Search"><a  title="Search" >Search</a></li>
                        <li style="width: 2px"><div class="menu_separtor"></div></li>
                        <li id="Suppliers"><a  title="Suppliers / Buyer" >Suppliers / Buyer</a></li>
                        <li style="width: 2px"><div class="menu_separtor"></div></li>
                        <li id="Transactions"><a  title="Transactions" >Transactions</a></li>
                        <li style="width: 2px"><div class="menu_separtor"></div></li>
                ...
                <div class="nav_Sub Gen_nav">
                    <ul id="SubAdmin" >
                        <li id="SubAdmin_User"><a  title="Users" >Users</a></li>
                        <li  style="width: 2px"><div class="Sub_menu_separtor" id="Sub_menu_seperator_SubAdmin_User"></div></li>
                        <li id="SubAdmin_Group"><a  title="Groups" >Groups</a></li>
                        ...
                        <li id="SubAdmin_Company_Profile"><a title="Company Profile" >Company Profile</a></li>
                        ...
                        <li id="SubCorporate_Ad"><a  title="Advertisement" >Advertisement</a></li>
                        <li style="width: 2px"><div class="Sub_menu_separtor"></div></li>
                    </ul>
                    <ul id="SubCorporate">
                        <li id="SubCorporate_Internal_Page"><a  title="Main" >Main</a></li>
                    ...
                    <ul  class="Sub_display" id="SubTransactions">
                        ...
                        <li id="SubTransactions_History"><a  title="History" >Transaction History</a></li>
                        <li  style="width: 2px"><div class="Sub_menu_separtor"  id="Sub_menu_seperator_SubTransactions_Histroy"></div></li>
                        <li id="SubTransactions_TC"><a  title="Terms & Conditions" >Terms & Conditions</a></li>
                    ...
                    <ul id="SubNetwork">
                        <li id="SubNetwork_News_Feed"><a title="Network Feeds" >Network Feeds</a></li>
                        <li  style="width: 2px"><div class="Sub_menu_separtor" id="Sub_menu_seperator_SubNetwork_News_Feed"></div></li>
                        <li id="SubCorporate_User_Page"><a title="My Feeds" >My Feeds</a></li>
                        ...
                        <li id="SubNetwork_Notification"><a  title="Notification" >Notification</a></li>
