...
<div class="header" id="header"> 
	<div class="headercontent"> 
		...
		<div class="logo" id="supplymedium_logo" style="position:relative;display:none;">
			<a href="${pageContext.request.contextPath}/index.jsp" style="cursor:pointer;">
			<img src="${pageContext.request.contextPath}/Views/Utils/images/mugshot.png" width="90px" height="90px" style="float:left;border:none;margin-top:10px;">
			</a>
                        <label class="company_label"  id="company_label" style="width:auto;float:left;"><%=companyName%></label>
		</div>
