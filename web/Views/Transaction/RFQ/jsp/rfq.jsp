...
<html>
    ...
    <body>
        <%
            ...
            core.login.SessionData sessionObj7 = (core.login.SessionData) session.getAttribute("UserSessionData");
        %>
        <div id="rfq_post_confirmation" class="rfq_post_confirmation"><center><p><br/><br/>Do you want to post RFQ in news feed as open BID ?<br/><br/><br/><br/>
                    <input type="button" class="gen-btn-blue" value="YES" onclick="send_feed();
                        $('#rfq_post_confirmation').fadeOut();"/><input type="button" class="gen-btn-blue" value="NO" onclick="sendRFQ();
                                $('#rfq_post_confirmation').fadeOut();" style="margin-left:30px;"/></p></center>
            <input type="hidden" id="cmpny_nm9" value="<%=sessionObj7.companyName_%>" />  
        </div>
