...
function saveItem()
{
    ...
    {
        $("#quote_item_form_error").text("Enter the Part No.");
    ...
    if ($("#from_form").val() == "QuoteForm")
    {
        ...
        itemDet += '<input type="text" class="textbox" maxlength=5 id="dscnt' + itemsCount + '" style="width:35px;margin-right:20px;" disabled value="' + dscnt + '";/>';
...
function validateQuote()
{
    ...
    if ($('#outside_supplier').is(":checked"))
    {
        ...
        quoteObj.outsideSuppliercountry = $("#otsd_splr_cntry").val();
        quoteObj.outsideSupplierstate = $("#otsd_splr_st").val();
