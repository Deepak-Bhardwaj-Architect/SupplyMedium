    ...
    for (var i = 0; i < quoteArr.length; i++)
    {
       //alert(quoteArr[i]);
        ...
        if (fromRegnKey == regnKey)
        {
            ...
            quoteDataTable.fnAddData([transImg, QuoteId,QuoteRef, QuoteDate, toCompName, toRegnKey, toUserKey, fromState + inquireChat, status, open,
                ...
                items, trans, inquires, transId, totListPrice, tax, totPrice, isPOCreated, "sent"]);
        }
        else
        {
            quoteDataTable.fnAddData([transImg, QuoteId,QuoteRef, QuoteDate, fromCompName, fromRegnKey, fromUserKey, fromState + inquireChat, status, open,
                ...
                toCity, toAddress, toZipcode, isOutsideSupplier, outsideSupplierEmail, recurring, quotationRef,
                items, trans, inquires, transId, totListPrice, tax, totPrice, isPOCreated, "rec"]);
        }
