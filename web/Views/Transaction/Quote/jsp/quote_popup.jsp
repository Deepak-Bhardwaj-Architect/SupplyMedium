...
<div style="display: none; z-index: 1000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline quote_popup_outline">
			<div class="Popup_Tilte_NewGroup Gen_Popup_Title"
				...
				<div style="padding: 0px 0px 0px 15px; float: left" id="qt_tl">Quote</div>
                                <div style="float: right;width:100px;">
                                <a onclick="this.href='quote_pdf_download?trans_id='+$('#trans_id').val()+'&from='+$('#popup_buyer_name').val()+'&to='+$('#to_company_popup').val()+'&date='+$('#dt').val()+'&typ='+$('#typ').val()+$('#outside_supplier_address').val()" target="_blank"><img src="Views/Transaction/TransCommon/images/open.png" style="margin-top:10px;"></a>    
