				...
				<div class="to_comp">
					...
					<input type="text" id="to_company_popup" disabled style="width: 890px;"
						class="textbox" onkeyup="getNRVendor();">
                                ...
                                <div style="float: right;"><a onclick="this.href='quote_pdf_download?trans_id='+$('#trans_id').val()+'&from='+$('#popup_buyer_name').val()+'&to='+$('#to_company_popup').val()+'&date='+$('#dt').val()" target="_blank">download</a></div>
