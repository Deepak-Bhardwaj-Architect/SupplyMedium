	...
	<div style="display: none; z-index: 1000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline po_inquire_outline">
			<div class="Popup_Tilte_NewGroup Gen_Popup_Title"
				...
				<div style="padding: 0px 0px 0px 15px; float: left">PO Inquire Details</div>
			...
			<div id="chat_new_inquire">
				<div class="inquire_row">
					...
					<label class="po_error" style="width:300px;margin-left: 125px;margin-top: 10px;" id="chat_inquire_error"></label>
				</div>
			</div>
