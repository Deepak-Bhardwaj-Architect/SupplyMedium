...
function saveItem()
{
    ...
    {
        $("#po_item_form_error").text("Enter the Part No.");
    ...
    if ($("#from_form").val() == "POForm")
    {
        ...
        itemDet += '<input type="text" class="textbox" maxlength=80 id="item_desc' + itemsCount + '" style="width:100px;margin-right:20px;" disabled  value="' + itemDesc + '";/>';
        ...
        itemDet += '<input type="text" class="textbox" maxlength=80 id="brcd' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + brcd + '";/>';
        itemDet += '<input type="text" class="textbox" maxlength=7 id="quantity' + itemsCount + '" style="width:60px;" disabled value="' + quantity + '";/>';
        itemDet += '<div class="quantity_unit" id="quantity_unit' + itemsCount + '" >' + quantityUnit + '</div>';
        itemDet += '<input type="text" class="textbox" id="ship_date' + itemsCount + '" style="width:85px;margin-right:20px;" disabled value="' + shipDate + '";/>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="price' + itemsCount + '" style="width:60px;" disabled value="' + priceperunit + '";/>';
        itemDet += '<div class="quantity_unit" id="currency' + itemsCount + '" >' + currency + '</div>';
        itemDet += '<input type="text" class="textbox" maxlength=5 id="dscnt' + itemsCount + '" style="width:50px;margin-right:20px;" disabled value="' + dscnt + '";/>';
        itemDet += '<input type="text" class="textbox" maxlength=5 id="multiplier' + itemsCount + '" style="width:85px;margin-right:20px;" disabled value="' + multiplier + '";/>';
    ...
    else  // Add item button clicked from PO Edit from poup view
    {
        ...
        itemDet += '<input type="text" class="textbox" id="popup_item_desc' + itemsCount + '" style="width:165px;margin-right:20px;" disabled  value="' + itemDesc + '";/>';
        itemDet += '<input type="text" class="textbox" id="popup_part_no' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + partNo + '";/>';
        ...
        itemDet += '<input type="text" class="textbox" id="popup_ship_date' + itemsCount + '" style="width:80px;margin-right:20px;" disabled value="' + shipDate + '";/>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="popup_price' + itemsCount + '" style="width:60px;" disabled value="' + priceperunit + '";/>';
        itemDet += '<div class="quantity_unit" id="popup_currency' + itemsCount + '" >' + currency + '</div>';
        itemDet += '<input type="text" class="textbox" maxlength=5 id="popup_multiplier' + itemsCount + '" style="width:65px;margin-right:20px;" disabled value="' + multiplier + '";/>';
...
// Calculate total before delete the item
    ...
    var multiplier = $("#multiplier" + itemsCount).val();
...
function validatePO()
{
    ...
    if ($('#outside_supplier').is(":checked"))
    {
        ...
        poObj.outsideSuppliercountry = $("#otsd_splr_cntry").val();
        poObj.outsideSupplierstate = $("#otsd_splr_st").val();
