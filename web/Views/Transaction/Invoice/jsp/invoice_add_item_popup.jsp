...
<div style="display: none;z-index:2000;" class="Custome_Popup_Window"
		...
		<div style="margin-top:0px;margin-left:10px;float:left;position:relative;">
			...
			<div class="item" style="width: 970px;float:left;margin-left:10px;margin-right:0px;position:relative;">
				...
				<div class="currency_list" id="currency_currency" style="display: none;left:731px;">
