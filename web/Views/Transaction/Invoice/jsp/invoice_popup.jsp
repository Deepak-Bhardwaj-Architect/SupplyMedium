...
<div style="display: none; z-index: 1000;" class="Custome_Popup_Window"
		...
		<div class="Cus_Popup_Outline invoice_popup_outline">
			<div class="Popup_Tilte_NewGroup Gen_Popup_Title"
				...
				<div style="padding: 0px 0px 0px 15px; float: left" id="invc_tl">Invoice</div>
				<div style="float: right;width:100px;">
                                <a onclick="this.href='invoice_pdf_download?trans_id='+$('#trans_id').val()+'&from='+$('#popup_buyer_name').val()+'&to='+$('#to_company_popup').val()+'&date='+$('#dt').val()+'&typ='+$('#typ').val()+$('#outside_supplier_address').val()" target="_blank"><img src="Views/Transaction/TransCommon/images/open.png" style="margin-top:10px;"></a>    
			...
			<div class="shipping_det_content">
				...
				<input type="text" class="textbox" id="popup_date_shipped" readonly style="margin-left:20px;width:100px;">
					...
					<div id="supplier_ctrls" class="supplier_controls">
						...
						<input type="button" class="gen-btn-red" style="margin-left:30px;" id="invoice_reject_btn" value="Reject">
