...
function saveItem()
{
    ...
    if ($("#from_form").val() == "invoiceForm")
    {
        ...
        itemDet += '<input type="text" class="textbox" maxlength=80 id="item_desc' + itemsCount + '" style="width:100px;margin-right:10px;" disabled  value="' + itemDesc + '";/>';
        itemDet += '<input type="text" class="textbox" maxlength=80 id="part_no' + itemsCount + '" style="width:90px;margin-right:10px;" disabled value="' + partNo + '";/>';
        itemDet += '<input type="text" class="textbox" maxlength=80 id="brcd' + itemsCount + '" style="width:90px;margin-right:10px;" disabled value="' + brcd + '";/>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="quantity_ordered' + itemsCount + '" style="width:60px;" disabled value="' + quantityOrdered + '";/>';
        itemDet += '<div class="quantity_unit" id="quantity_ordered_unit' + itemsCount + '" style="margin-right:10px;">' + quantityOrderedUnit + '</div>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="quantity_shipped' + itemsCount + '" style="width:60px;" disabled value="' + quantityShipped + '";/>';
        itemDet += '<div class="quantity_unit" id="quantity_shipped_unit' + itemsCount + '" style="margin-right:10px;">' + quantityShippedUnit + '</div>';


        itemDet += '<input type="text" class="textbox" maxlength=7 id="price' + itemsCount + '" style="width:60px;" disabled value="' + price + '";/>';
        itemDet += '<div class="quantity_unit" id="currency' + itemsCount + '" style="margin-right:10px;">' + currency + '</div>';
        itemDet += '<input type="text" class="textbox" maxlength=7 id="dscnt' + itemsCount + '" style="width:50px;margin-right:10px;" disabled value="' + dscnt + '";/>';
        itemDet += '<input type="text" class="textbox" maxlength=7 id="multiplier' + itemsCount + '" style="width:100px;margin-right:10px;" disabled value="' + multiplier + '";/>';
    ...
    else  // Add item button clicked from invoice Edit from popup view
    {
        ...
        itemDet += '<input type="text" class="textbox" maxlength=80 id="popup_item_desc' + itemsCount + '" style="width:165px;margin-right:20px;" disabled  value="' + itemDesc + '";/>';
        ...
        itemDet += '<input type="text" class="textbox" maxlength=7 id="popup_quantity_ordered' + itemsCount + '" style="width:90px;" disabled value="' + quantityOrdered + '";/>';
        itemDet += '<div class="quantity_unit" id="popup_quantity_ordered_unit' + itemsCount + '" >' + quantityOrderedUnit + '</div>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="popup_quantity_shipped' + itemsCount + '" style="width:90px;" disabled value="' + quantityShipped + '";/>';
        itemDet += '<div class="quantity_unit" id="popup_quantity_shipped_unit' + itemsCount + '" >' + quantityShippedUnit + '</div>';

        itemDet += '<input type="text" class="textbox" maxlength=7 id="popup_price' + itemsCount + '" style="width:60px;" disabled value="' + price + '";/>';
...
// Calculate total before delete the item
    ...
    var price = parseFloat($("#price" + itemsCount).val());
...
function validateInvoice()
{
    ...
    if ($('#outside_supplier').is(":checked"))
    {
        ...
        invoiceObj.outsideSuppliercountry = $("#otsd_splr_cntry").val();
        invoiceObj.outsideSupplierstate = $("#otsd_splr_st").val();
