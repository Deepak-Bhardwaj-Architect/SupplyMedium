...
function fillQuoteForm(aData)
{
    ...
    for (var i = 0; i < rfqitems.length; i++)
    {
        ...
        itemDet += '<div id="item' + itemsCount + '" class="item" style="width:1015px;float:left;margin-left:20px;margin-right:20px;position:relative;">';
        ...
        itemDet += '<input type="text" class="textbox"  maxlength=7 value="1" id="dscnt' + itemsCount + '" style="width:85px;margin-right:20px;" onkeyup="claculate_invoice(' + itemsCount + ');" />';
...
function fillPOForm(aData)
{
    ...
    for (var i = 0; i < items.length; i++)
    {
        ...
        itemDet += '<div id="item' + itemsCount + '" class="item" style="width:1015px;float:left;margin-left:20px;margin-right:20px;">';
