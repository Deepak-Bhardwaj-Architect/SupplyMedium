...
function fillQuoteForm(aData)
{
    ...
    for (var i = 0; i < rfqitems.length; i++)
    {
        ...
        itemDet += '<input type="text" class="textbox"  maxlength=80 id="brcd' + itemsCount + '" style="width:60px;margin-right:20px;" disabled value="' + item.barcode_id + '";/>';
        itemDet += '<input type="text" class="textbox"  maxlength=7 id="quantity' + itemsCount + '" style="width:60px;"  value="' + item.quantity + '"; onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        ...
        itemDet += '<input type="text"  maxlength=7 class="textbox" id="price' + itemsCount + '" style="width:60px;" onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        ...
        itemDet += '<input type="text" class="textbox"  maxlength=7 value="1" id="dscnt' + itemsCount + '" style="width:35px;margin-right:20px;" onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        itemDet += '<input type="text" class="textbox"  maxlength=7 id="multiplier' + itemsCount + '" style="width:85px;margin-right:20px;" disabled value="0"/>';
