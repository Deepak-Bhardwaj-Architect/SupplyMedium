                        ...
                        <div style="float:left;margin-bottom:50px;">
                            <div class="profileContent" style="border-right: 1px solid #d3d3d3;">
                                ...
                                <div>
                                    ...
                                    <input type="file" style="width:180px;height: 20px;margin-top: 3px;float: left;cursor: pointer !important;font-size: 12px;opacity: 1;" name="complogo" id="complogo" title="The logo dimensions should be at most 500x500 pixels in size should not exceed 1 MB.  
    ...
    <INPUT id="removeaddressbtn2" class="removeaddress" onClick="removeUpdateDeleteCompanyMultipleAddress(3);" name="removeaddressbtn2" type="button" style="display: block;">
                            ...
                            <div class="pricingContent">
                                ...
                                <div class="row" style="height:40px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;<%=UserMaster.showUserCount(companyKey)%>
                                    </label>
                                </div>
                                <!-- max tras vol-->
                                <div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:30px;">
                                    <label class="keylbl"> Transaction volume annually
                                    </label>
                                    <%
                                    int transactionMade=TransactionInvMaster.showTotalTransactionVolume(companyKey);
                                    int transactionAllowed=10000;
                                    %>
                                    <label class="valuelbl">:&nbsp;&nbsp;$<%=transactionMade%>
                                    </label>
                                </div>
                                <!-- Remaining transaction for this month -->
                                <div class="row" style="height:50px;">
                                    <label class="keylbl"> Balance transaction allowed for this year
                                    </label>
                                    <label class="valuelbl">:&nbsp;&nbsp;$<%=transactionAllowed-transactionMade%>
                                    </label>
                                </div>
                                <div class="Sub_Heading">		
                                    Disk Quota
                                    ...
                                    <%
        SmProperties.folderPath = request.getRealPath("") + File.separator + "cropData" + File.separator+"company-"+1;
