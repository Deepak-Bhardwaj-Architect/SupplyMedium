                        ...
                        <div style="float:left;margin-bottom:50px;">
                            <div class="profileContent" style="border-right: 1px solid #d3d3d3;">
                                ...
                                <div>
                                    ...
                                    <input type="file" style="height: 20px;margin-top: 3px;float: left;cursor: pointer !important;font-size: 12px;opacity: 1;" name="complogo" id="complogo" title="The logo dimensions should be at most 500x500 pixels in size should not exceed 1 MB.  
