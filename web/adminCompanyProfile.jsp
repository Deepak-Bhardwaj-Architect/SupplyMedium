...
//                                    int transactionAllowed=10000;
                                ...
                                <div class="row" style="height:50px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=(transactionMade / 100)%>
                                    </label>
                                </div>                              
                                <div class="row" style="height:40px;">
                                ...
                                <%
                                            ...
                                            double total = (transactionMade / 100) + (usersLic * 1) + charges;
                                            long ttl=(long)total;
                                %>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl">
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=(transactionMade / 100)%> till today
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
...
<!--                                        <form id="paypalForm" name="paypalForm" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <input type="hidden" name="currency_code" value="USD">
                                            <input type="hidden" id="item_name" name="item_name" value="SupplyMediuam Platform Charges" />
                                            <input type="hidden" id="amnt" name="amount" value="<%=ttl%>"/>
                                            <input type="hidden" name="bn" value="PP-BuyNowBF:btn_paynowCC_LG.gif:NonHosted">
                                            <input type="hidden" id="rtrn" name="return" value="<%=SmProperties.emailUrl%>adminCompanyProfiles.jsp"/>
                                            <input type="hidden" id="cncl_rtrn" name="cancel_return" value="<%=SmProperties.emailUrl%>adminCompanyProfile.jsp" />-->
                                            <input type="button" value="Pay via Paypal" style="float:right;width:180px;" class="general-button gen-btn-Orange" onClick="$('#amnt').val('<%=ttl%>');document.forms['paypalForm'].submit();" />
<!--                                        </form>-->
                                    </label>
                                </div>
                                <div class="row" style="height:30px;margin-top:20px;">
                                    <img style="cursor: pointer;" src="inside/paypal.jpg" border="0" height="100" alt="PayPal Logo" title="Proceed to Pay"  onclick="$('#amnt').val('<%=ttl%>');document.forms['paypalForm'].submit();">
                                </div>
                                <!--                                <div class="Sub_Heading">
                                                                    Payment Options
                                                                </div>
