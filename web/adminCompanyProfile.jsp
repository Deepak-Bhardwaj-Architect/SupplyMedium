                    ...
                    <div class="content cpcontent" style="height:auto!important;width:942px!important;">
                        <div style="float:left;margin-bottom:50px;">
                            ...
                            <div class="pricingContent" style="width:432px;">
                                ...
                                <%
                                            int userCount = UserMaster.showUserCount(companyKey);
                                            int usersLic = 0;
                                            if (userCount - 2 > 0) {
                                                usersLic = userCount - 2;
                                            }
                                %>
                                ...
                                <div class="row" style="height:40px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;<%=userCount%>
                                    </label>
                                </div>                                
                                <div class="row" style="height:40px;">
                                    <span style="color:green;">After 2 registered users, USD $1 per user per month will be charged</span>
                                </div>
                                <div class="row" style="height:40px;">
                                </div>
                                <!--<div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <%
                                                double transactionMade = TransactionInvMaster.showTotalTransactionVolume(companyKey);
                                                double transactionMade1 = transactionMade / 100;
                                                transactionMade1 = Math.round(transactionMade1 * 100);
                                                transactionMade1 = transactionMade1 / 100;
//                                    int transactionAllowed=10000;
%>
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=transactionMade%>
                                    </label>
                                </div>
                                ...
                                <div class="row" style="height:50px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=transactionMade1%>
                                    </label>
                                </div>                              
                                <div class="row" style="height:40px;">
                                ...
                                <%
                                            ...
                                            long charges = 0;
                                            long consumptionDisk = 0;
                                            if (sizeDisk > allowedDisk) {
                                                consumptionDisk = sizeDisk - allowedDisk;
                                            }
                                            charges = (consumptionDisk / 100) * 1;
                                            if ((consumptionDisk % 100) > 0) {
                                                consumptionDisk++;
                                            }
                                            charges = Math.round(charges * 100);
                                            charges = charges / 100;

                                            double total = transactionMade1 + (usersLic * 1) + charges;
                                            total = Math.round(total * 100);
                                            total = total / 100;
                                %>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl">
                                        <span style="color:green;"><%=usedDiskPercent%>%</span> of disk space used</label>
                                </div>
                                <div class="row">
                                    <label class="keylbl"> Used <span style="color:#f37d01;"><%=sizeDisk%>MB</span>
                                        of your <span style="color:#f37d01;">100MB </span>disk space
                                    </label>
                                </div>                                
                                <div class="row" style="height:40px;">
                                    <span style="color:green;">After usage of first 100MB free space, USD $1 per 100MB annually will be charged.</span>
                                </div>
                                <div class="row" style="height:40px;">
                                </div>
                                <div class="Sub_Heading">		
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=(usersLic * 1)%> per month
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl"> Transaction Charges
                                    </label>
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=transactionMade1%> till today
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl"> Storage Charges
                                    </label>
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=charges%> per month
                                    </label>
                                </div>
<%
        CompanyMaster.updatePlatformAmountGenerated(companyKey, ""+total);
        String chargesAll=CompanyMaster.showPlatformCharges(companyKey);
        double genratedCharges=Double.parseDouble(chargesAll.split("@#@")[0]);
        genratedCharges = Math.round(genratedCharges * 100);
        genratedCharges = genratedCharges / 100;
        double paidCharges=Double.parseDouble(chargesAll.split("@#@")[1]);
        paidCharges = Math.round(paidCharges * 100);
        paidCharges = paidCharges / 100;
        total=genratedCharges;
%>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl" style="color:green;"> Total Charges
                                    </label>
                                    <label class="valuelbl" style="color:green;">:&nbsp;&nbsp;USD $<%=total%> per month
                                    </label>
                                </div>
                                <div class="row" style="height:30px;">
                                    <label class="keylbl"> Paid Amount
                                    </label>
                                    <label class="valuelbl">:&nbsp;&nbsp;USD $<%=paidCharges%> per month
                                    </label>
                                </div>
<%
        total=total-paidCharges;
        total = Math.round(total * 100);
        total = total / 100;
%>
                                <div class="row" style="height:30px;">
                                ...
                                <div class="row" style="height:30px;">
                                    ...
                                    <label class="valuelbl">
                                        <input type="button" value="Pay via Paypal" style="float:right;width:180px;" class="general-button gen-btn-Orange" onClick="javascript:$('#rtrn').val($('#rtrn').val()+'?amt=<%=total%>');$('#amnt').val('<%=total%>');document.forms['paypalForm'].submit();" />
                                    </label>
                                </div>
                                <div class="row" style="height:30px;margin:40px 0;">
                                    <img style="cursor: pointer;" src="inside/paypal.jpg" border="0" height="100" alt="PayPal Logo" title="Proceed to Pay"  onclick="$('#amnt').val('<%=total%>');document.forms['paypalForm'].submit();">
                                </div>
                                <!--                                <div class="Sub_Heading">
                                                                    Payment Options
                                                                </div>
