                        ...
                        <div class="transactionhistorycontent" id="transaction_history_content" style="display: none;">
                            <div id="customer_info" class="customer_info">
                                <div class="trans_history_row">
                                    ...
                                    <label class="trans_history_lbl" style="width:400px;" id="cusName">
                                    </label>
                                </div>
                                <div class="trans_history_row">
                                    <label class="trans_history_lbl">Type: </label>
                                    <label class="trans_history_lbl" style="width:400px;" id="addType">
                                    </label>
                                </div>
                                <div class="trans_history_row">
                                    <label class="trans_history_lbl">Address: </label>
                                    <label class="trans_history_lbl" style="width:400px;" id="cusAddress">
                                    </label>
                                </div>
                                <div class="trans_history_row">
                                    <label class="trans_history_lbl">City: </label>
                                    <label class="trans_history_lbl" style="width:400px;" id="city">
                                    </label>
                                </div>
                                <div class="trans_history_row">
                                    <label class="trans_history_lbl">State: </label>
                                    <label class="trans_history_lbl" style="width:400px;" id="state">
                                    </label>
                                </div>
                                <div class="trans_history_row">
                                    <label class="trans_history_lbl">Customer Phone No: </label>
                                    <label class="trans_history_lbl" style="width:400px;" id="cusId">
                                    </label>
                                </div>
                            </div>
