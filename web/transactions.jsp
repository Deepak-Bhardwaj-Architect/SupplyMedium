...
<html>
    ...
    <body onLoad="lockUnlock('webkrit_content_loader');
                ...
                //$('#popup_ship_date').datetimepicker({dateFormat: 'dd-M-yy', minDate: 0});">
                    ...
                    <div id="trans_content" class="trans_content">
                        ...
                        <div id="rfq_post_confirmation" class="rfq_post_confirmation">
                            <center>
                                <p>
                                    <br>
                                    <br>Do you want to post RFQ in news feed as open BID ?<br>
                                    <br>
                                    <br>
                                    <br>
                                ...
                                <div class="fixed_height">
                                    <table id="rfq_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="rfq_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            %>
                                            <tr <%=stl%>
                                                onclick="$('#rfq_popup').fadeIn();showRfqDetailInPopup('<%=trb.getTransactionKey() %>','<%=trb.getBuyerCompanyKey() %>','<%=trb.getSupplierCompanyKey() %>');$('#toKey').val('<%=toKey %>');
                                                    showRfqPopupData(<%=trb.getTransactionKey()%>,<%=companyKey%>,<%=trb.getBuyerCompanyKey()%>);">
                                                <td class="rowBorder"><img src="inside/<%=img%>"/></td>
                                                <td class="rowBorder"><%=trb.getTransactionNo()%></td>
                                                <td class="rowBorder"><%=trb.getCreatedOn().split(" ")[0]%></td>
                                                <td class="rowBorder"><%=cname%></td>
                                                <td class="rowBorder"><%=cphone%></td>
                                                <td class="rowBorder"><%=cemail%></td>
                                                <td class="rowBorder"><%=cstate%></td>
                                                <td class="rowBorder"><%=cstatus%></td>
                                                <td class="rowBorder"><a target="_blank" href="cropData/company-<%=companyKey%>/transaction/<%=trb.getTransactionNo()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                }
                                                if (al.size() == 0) {
                        ...
                        <div id="rfq_form_content" style="display:none;" class="rfq_form_content">
                            <form method="post" action="TransRfq" onsubmit="return rfqFormValidation();">
                                ...
                                <div class="rfq_form">
                                    ...
                                    <div class="items_head">
                                        ...
                                        <label class="trans_label" style="width:58px;margin-right:20px;">Batch/Lot No</label>
                                    ...
                                    <div class="rfq_form_btns">
                                        ...
                                        <input type="submit" class="gen-btn-blue" value="Send" id="add_rfq_btn" onClick="validateRFQ();">
                                    </div>
                        ...
                        <div style="display: none;z-index:2000;" class="Custome_Popup_Window" id="rfq_add_item_popup">
                            <div class="Cus_Popup_Outline rfq_add_item_popup_outline">
                                ...
                                <div style="margin-top:0px;margin-left:10px;float:left;position:relative;display:block;" id="existingItem">
                                    <div class="items_head">                                        
                                        <label class="trans_label" style="width:500px;margin-right:20px;">Item Name / Item Description / Batch/Lot No / SKU No / Barcode</label>
                                ...
                                %>
                                    ...
                                    <div class="items_head2" id="resulted-data-head" style="display:none;">                                        
                                        ...
                                        <label class="trans_label" style="width:98px;margin-right:20px;font-weight:bold;">Batch/Lot No</label>
...
<!--                                        <input type="text" autocomplete="off" class="textbox" id="popup_quantity" maxlength="7" style="width:90px;">
                                    ...
                                    <div class="rfq_error" id="rfq_item_form_error2" style="width:620px;">
                                    </div>
                                </div>
                            </div>
