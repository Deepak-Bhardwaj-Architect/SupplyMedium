                                    ...
                                    <table id="ProductCatalogList" style="width: 997px;" class="dataTable" aria-describedby="ProductCatalogList_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="rowBorder sorting" role="columnheader" tabindex="0" aria-controls="ProductCatalogList" rowspan="1" colspan="1" aria-label="Barcode: activate to sort column ascending" style="width: 129px;">Barcode</th>
                                                ...
                                                <th class="rowBorder sorting" role="columnheader" tabindex="0" aria-controls="ProductCatalogList" rowspan="1" colspan="1" aria-label="Option: activate to sort column ascending">Option</th>
                                            </tr>
                                        </thead>
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr <%=stl%> onclick="showProductDetails('<%=gpib.getItemKey()%>');">
                                                ...
                                                <td><%=gpib.getPicsCount().split(", ").length%> Images</td>                                                
                                            </tr>
                                            <%
                                            }
                                            %>
