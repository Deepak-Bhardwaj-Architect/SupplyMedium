...
<%@page import="supply.medium.utility.TestMemory"%>
...
{	
    ...
    <%
            ...
            try
            {
                TestMemory.test("header start");
                System.gc();
                TestMemory.test("header end");
                ...
                // group and Department permissions
                
//                GroupPermBean gpbVal=GroupPermMaster.showPermByGroupKey(groupKey);
//                DepartmentPermBean dpbVal=DepartmentPermMaster.showPermByDeptKey(deptKey);
            ...
            <div class="header_right">
                <div class="userdetails" style="margin-top:40px;">
                    ...
                    <div id="acc_menu_content" class="acc_menu_content" style="display: none;">
                        <a href="userAccountSettings.jsp" style="margin-top:19px;" class="acc_menu_item" onClick="showUserAccSettings();">Account Settings</a>
                ...
                <div class="header_links_container">
                    <a class="header_link" id="dashboard_link" href="home.jsp">Home</a>
                    <a class="header_link" id="news_link" href="home.jsp">News&nbsp;&nbsp;|&nbsp;</a>
                    <%
                    if(!websiteUrlLink2.equals(""))
                    {
                    %>
                    <a class="header_link" id="website_link" href="<%=websiteUrlLink2 %>" title="Company Website" target="_blank"><%=urlName2%>&nbsp;&nbsp;|&nbsp;</a>
                <% } %>
                </div>
            </div>
    ...
    <LINK rel="stylesheet" href="inside/Cus_Menu.css">
        <%
                String pageName="";
                pageName=request.getServletPath().replace("/","");
        %>
...
if(session.getAttribute("companyType").toString().equals("Buyers/Suppliers"))
{
    out.println("><a title='Search' href='search.jsp'>Search</a></li>");
}
if(session.getAttribute("companyType").toString().equals("Supplier"))
{
    out.println("><a title='Search' href='searchBuyer.jsp'>Search</a></li>");
}
if(session.getAttribute("companyType").toString().equals("Buyer"))
{
    out.println("><a title='Search' href='search.jsp'>Search</a></li>");
}
...
if(session.getAttribute("companyType").toString().equals("Buyers/Suppliers") || session.getAttribute("companyType").toString().equals("Supplier"))
{
%>                    
                    <li style='width: 2px'>
...
if(session.getAttribute("companyType").toString().equals("Buyers/Suppliers") || session.getAttribute("companyType").toString().equals("Buyer"))
{
%>                    
                    <li style='width: 2px'>
...
if(userType.equals("Admin") || adminTab.equalsIgnoreCase("yes"))
{
%>
                    <li id='Admin' style='width:117px;'
                    <%
                    if(pageName.equals("adminListUsers.jsp")
                    ...
                    %>
                    >
                        <a title='Admin' <% if(!userType.equals("Admin") 
...
%>
            ...
            <div class='nav_Sub Gen_nav'>
                <ul id='SubNetwork'
                    ...
                    %>
                    >
                        <a title='Dashboard' href='home.jsp'>Dashboard</a>
                    </li>
                    <li style='width: 2px'>
...
%>
                ...
                <ul id='SubAdmin'
                    ...
                    if((pageName.equals("adminListUsers.jsp")
                            ...
                            || pageName.equals("adminListUsers.jsp")
                            || pageName.equals("adminManageFolders.jsp")
                            || pageName.equals("adminNewUser.jsp") )&& adminTab.equalsIgnoreCase("yes"))
                    {
                        out.println(" style='display:block;'");
                    }
                    else
                    ...
                    if(!userType.equals("Admin") &&  listUserTab.equalsIgnoreCase("yes"))
                    {
                        out.println(" style='display:block;'");
                    }
                    else
                    ...
                    if(!userType.equals("Admin") &&  groupTab.equalsIgnoreCase("yes"))
                    {
                        out.println(" style='display:block;'");
                    }
                    else
