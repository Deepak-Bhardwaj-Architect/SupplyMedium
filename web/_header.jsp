        ...
        <div class="headercontent">
            ...
            <div class="header_right">
                ...
                <div class="header_links_container">
                    <a class="header_link" id="dashboard_link" href="home.jsp" style="width: 70px;"> Dashboard</a>
                    <a class="header_link" id="news_link" href="home.jsp" style="width: 54px;"> News   | </a>
                    <%
                    if(!websiteUrlLink2.equals(""))
                    {
                    %>
                    <a class="header_link" id="website_link" href="<%=websiteUrlLink2 %>" target="_blank" style="width: 130px;"> Company Website   | </a>
                <% } %>
                </div>
            </div>
        ...
        <div id='Menu'>
            ...
            <div class='nav_Main Gen_nav' style='width:994px;'>
                <ul class='MenuType1 DisplayMenu '>
                    ...
                    %>
                    >
                        <a title='Search' href='search.jsp'>Search</a>
                    </li>
                    <li style='width: 2px'>
