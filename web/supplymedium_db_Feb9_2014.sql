...
--
drop database if exists `supplymedium_db`;
CREATE DATABASE `supplymedium_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `supplymedium_db`;
...
CREATE TABLE IF NOT EXISTS `invoice` (
  ...
  `action` varchar(255) NOTinvoice NULL,
