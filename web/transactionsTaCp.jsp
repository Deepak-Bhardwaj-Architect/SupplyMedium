...
<html>
    ...
    <div class="mainpage" id="mainpage" style="min-height:700px;background-color:#f1f1f1">
        ...
        <form id="tc_form" name="tc_form" action="TermsConditionsAction" method="post" enctype="multipart/form-data">
            <input type="hidden" name="transactionType" value="PO">
                ...
                <div class="tc_content">
                    <div class="menu_container">
                        <div class="tab_container">
                            ...
                            <div class="tab_orange" id="po_tab"><a href="transactionsTaCp.jsp" class="white">Purchase Order</a></div>
                            <div class="tab_gray" id="invoice_tab"><a href="transactionsTaCi.jsp" class="white">Invoice</a></div>
                        </div>
                    ...
                    <div class="transet_container">
                        ...
                        <% TermsConditionsBean tcb= TermsConditionsMaster.show(companyKey, "PO"); 
                        try
                        {
        ...
        <div style="display: none; z-index: 1000;" class="Custome_Popup_Window" id="tc_content_popup">
            <div class="Cus_Popup_Outline add_content_outline">
                ...
                <% } %>
                <input type="submit" class="gen-btn-blue" value="Save" style="margin-left: 290px;" id="content_save_btn">
            </div>
        </div>
        </form>
