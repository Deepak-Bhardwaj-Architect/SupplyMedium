...
%>
        <div style="float: right;width:100px;">
            ...
            <a onClick="this.href = '<%="cropData/company-"+session.getAttribute("companyKey")+"/transaction/RFQ"+request.getParameter("rfqKey")+".pdf" %>'" target="_blank">
                ...
                <div class="mCustomScrollBox mCS-dark-thick" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;">
                    <div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                        ...
                        <div id="item1" class="item" style="width:820px;float:left;margin:0 10px 10px 40px;">
                            ...
                            <input type="text" autocomplete="off" class="textbox" maxlength="7" id="quantity1" style="width:58px;" disabled="" value="<%=transactionRfqItemBean.getQuantity() %>">
                        ...
                        <div id="supplier_ctrls" class="supplier_controls">
                            <%
                            if (session.getAttribute("userKey").toString().equals(request.getParameter("supplierKey")) && objTr.getTransactionStatus().equals("RFQ Sent")){  %>
