    ...
    <body>
        ...
        <div class="contentcontainer">
            <div class="successcontent">
                ...
                <div class="resmsg">
                    <font size="4">Supply Medium has received your request for new password generation.</font><br><br> An email has been sent to your registered email account with instructions to reset your password. Please log in to your email to complete the password reset process.
