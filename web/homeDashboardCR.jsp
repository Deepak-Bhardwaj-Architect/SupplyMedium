            ...
            <div class="dashboardcontainer contentcontainer" style="min-height:834px;">
                ...
                <div class="main_tab_container">  <!-- This is the main tab bar container -->
                    ...
                    <div id="time_based_report_tab" class="main_tab_unselect">  <!-- This is the Request Queue tab -->
                        <a href="homeDashboardCR.jsp" style="color:#fff;">Time Based Report</a></div>

                    <div id="company_based_report_tab" class="main_tab_select">	<!-- This is the Add Buyer tab -->
                        <a href="homeDashboardCC.jsp" style="color:#fff;">Company Based Report</a></div>
                ...
                <div id="divcompanybasedreport" style="display: block;"> <!-- Company Based Report -->
                    ...
                    <div class="chartTitlebuttons">
                        ...
                        <input type="text" class="textbox" id="start_date" style="float: left; margin-top: 5px; margin-right: 10px; display: block;" readonly="">
                        <div style="float:left;margin-top:5px;margin-right:10px;">
                            To Date 
                        </div>
                        <input type="text" class="textbox" id="end_date" style="float: left; margin-top: 5px; margin-right: 10px; display: block;" readonly="">
                    ...
                    <div class="report_type">
                        <div id="time_report_table" class="singleLine ReportTabSelected"><a href="homeDashboardCR.jsp" style="color:#000;">Report<a/></div>
                        <div id="time_report_chart" class="singleLine ReportTabUnSelect"><a href="homeDashboardCC.jsp" style="color:#000;">Chart</a></div>
                    ...
                    <div class="clearboth"></div>
                    <div class="table" style="display: block; float: left;" id="table2">
                        <div class="tablehead">
                            <div style="float:left; width:49px; height:30px; border-right:1px solid #c8c8c8;padding-top:10px;">S.No</div>
                            <div style="float:left; width:149px; height:30px; border-right:1px solid #c8c8c8;padding-top:10px;">Customers</div>
                        ...
                        <div class="tabledata">
                            ...
                            <div style="float:left; width:149px; height:30px; border-right:1px solid #c8c8c8;padding-top:10px;">edukrit</div>
                            <div style="float:left; width:170px; height:30px; padding-top:10px;text-align:right;">USD 4978.60</div>                                            
                        </div>
                        <div class="tabledata">
                            <div style="float:left; width:49px; height:30px; border-right:1px solid #c8c8c8;padding-top:10px;">2</div>
                            <div style="float:left; width:149px; height:30px; border-right:1px solid #c8c8c8;padding-top:10px;">jobskrit</div>
                            <div style="float:left; width:170px; height:30px; padding-top:10px;text-align:right;">USD 316.80</div>
                        </div>
                    </div>
