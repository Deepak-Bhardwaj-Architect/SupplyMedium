                    ...
                    + "company_master.company_key=company_mailing_address_master.company_key");
                        while (rs.next()) {
                            out.print("<div class='admin_companies_div' style='background:" + clr + "'>"
                                    ...
                                    + "<span style='width:400px;'>" + rs.getString("address") +" "+ StateMaster.showStateFromKey(rs.getString("state")) +" "+ CountryMaster.showCountryFromKey(rs.getString("country")) + "</span>");
                        ...
                        System.out.println(SmProperties.folderPath+":"+sizeDisk);
