                                        ...
                                        <table id="TransList" style="width: 997px;" class="dataTable" aria-describedby="TransList_info">
                                            ...
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                ...
                                                <tr <%=stl%>>
                                                    ...
                                                    <td><a download href="<%=SmProperties.urlPath+"company-"+companyKey+File.separator+"transaction"+File.separator+"INV"+trb.getTrans_key()+".xml"%>" target="_blank">XML File</a></td>
