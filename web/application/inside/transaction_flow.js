...
function fillQuoteForm(aData)
{
    ...
    $("#selected_ven_id").val(fromUserKey);
    $("#selected_ven_id").val(fromUserKey);
    ...
    for (var i = 0; i < rfqitems.length; i++)
    {
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=80 id="item_desc' + itemsCount + '" style="width:100px;margin-right:20px;" disabled  value="' + item.itemDesc + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=80 id="part_no' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + item.partNo + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=80 id="brcd' + itemsCount + '" style="width:60px;margin-right:20px;" disabled value="' + item.barcode_id + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=7 id="quantity' + itemsCount + '" style="width:60px;"  value="' + item.quantity + '"; onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" id="ship_date' + itemsCount + '" style="width:85px;margin-right:20px;" value="' + item.shipDate + '" readonly/>';


        itemDet += '<input type="text" autocomplete="off"  maxlength=7 class="textbox" id="price' + itemsCount + '" style="width:60px;" onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=7 value="1" id="dscnt' + itemsCount + '" style="width:35px;margin-right:20px;" onkeyup="claculate_invoice(' + itemsCount + ');" onblur="this.disabled = true"/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=7 id="multiplier' + itemsCount + '" style="width:85px;margin-right:20px;" disabled value="0"/>';

        itemDet += '<input type="button" class="del_btn" id="del_btn_' + itemsCount + '" style="width:110px;margin-right:20px;" onclick="deleteItem(' + itemsCount + ');" onblur="this.disabled = true"/></div>';
...
function claculate_invoice(val)
{
    ...
    for (var i = 1; i <= itemsCount; i++)
    {
       //alert('ok2'); 
       //alert(tl_lst_prc);
       var mltplr=parseFloat($('#multiplier' + itemsCount).val());
       tl_lst_prc=tl_lst_prc+mltplr;
    }
    //alert(tl_lst_prc);
    $("#tot_price_amt").text(calculateTotPrice(tl_lst_prc, 10));
...
function fillPOForm(aData)
{
    ...
    for (var i = 0; i < items.length; i++)
    {
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="item_desc' + itemsCount + '" style="width:100px;margin-right:20px;" disabled  value="' + item.itemDesc + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="part_no' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + item.partNo + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="brcd' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + item.barcode_id + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="quantity' + itemsCount + '" style="width:60px;"  value="' + item.quantity + '"; onkeyup="claculate_invoice(' + itemsCount + ');"/>';
        itemDet += '<div class="quantity_unit" id="quantity_unit' + itemsCount + '" >' + item.quantityUnit + '</div>';
        itemDet += '<div class="quan_units" id="units_quantity_unit' + itemsCount + '" style="display:none;left:452px;"></div>';


        itemDet += '<input type="text" autocomplete="off" class="textbox" id="ship_date' + itemsCount + '" style="width:85px;margin-right:20px;"  value="' + item.shipDate + '";/>';

        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="price' + itemsCount + '" style="width:60px;"  value="' + item.price + '"; onkeyup="claculate_invoice(' + itemsCount + ');""/>';
        itemDet += '<div class="quantity_unit" id="currency' + itemsCount + '" >' + item.currency + '</div>';
        itemDet += '<div class="currency_list" id="currency_currency' + itemsCount + '" style="display:none;left:689px;" ></div>';

        itemDet += '<input type="text" autocomplete="off" class="textbox"  maxlength=7 value="1" id="dscnt' + itemsCount + '" style="width:50px;margin-right:20px;" onkeyup="claculate_invoice(' + itemsCount + ');" />';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="multiplier' + itemsCount + '" style="width:85px;margin-right:20px;"  value="' + item.multiplier + '"; disabled />';
...
function fillInvoiceForm(aData)
{
    ...
    { 
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="item_desc' + itemsCount + '" style="width:100px;margin-right:10px;" disabled  value="' + item.itemDesc + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="part_no' + itemsCount + '" style="width:90px;margin-right:10px;" disabled value="' + item.partNo + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="brcd' + itemsCount + '" style="width:90px;margin-right:10px;" disabled value="' + item.barcode_id + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="quantity_ordered' + itemsCount + '" style="width:60px;"  value="' + item.quantity + '"; disabled="" onblur="calculateInvoiceTotal()"/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="quantity_shipped' + itemsCount + '" style="width:60px;" />';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="price' + itemsCount + '" style="width:60px;" disabled=""  value="' + item.price + '"; onblur="calculateInvoiceTotal()"/>';
        itemDet += '<div class="quantity_unit" id="currency' + itemsCount + '" >' + item.currency + '</div>';
        itemDet += '<div class="currency_list" id="currency_currency' + itemsCount + '" style="display:none;left:696px;" ></div>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength="12" id="dscnt' + itemsCount + '" style="width:50px;margin-right:10px;" disabled="" value="' + mltplr + '";>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength="12" id="multiplier' + itemsCount + '" style="width:100px;margin-right:10px;" disabled="" value="' + item.multiplier + '";>'; 
        itemDet += '<input type="button" class="del_btn" id="del_btn_' + itemsCount + '" style="width:110px;margin-right:20px;" onclick="deleteItem(' + itemsCount + ');"/></div>';
