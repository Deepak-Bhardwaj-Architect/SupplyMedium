...
{
	$("#quote_accept_btn").attr("disabled", "disabled");
			   ...
			   if(resJSON.result == "success")
				{
				   ...
				   $("#quote_accept_btn").removeAttr("disabled");
				   fetchQuoteRequest();
				}
...
function rejectQuote()
{
	...
	showAjaxLoader();
        $("#quote_reject_btn").attr("disabled", "disabled");
	$.ajax({
		   type: "POST",
		   url: getBaseURL()+"/QuoteServlet",
		   data:{ 
			   ...
			   if(resJSON.result == "success")
				{
				   ...
				   ShowToast( resJSON.message,2000 );
				   $("#quote_reject_btn").removeAttr("disabled");
				   fetchQuoteRequest();
				}
...
function inquireQuote()
{
	...
	showAjaxLoader();
        $("#supp_quote_inquire_btn").attr("disabled", "disabled");
	$.ajax({
		   type: "POST",
			   ...
			   if(resJSON.result == "success")
				{
				   ...
				   ShowToast( resJSON.message,2000 );
				   $("#supp_quote_inquire_btn").removeAttr("disabled");
				   fetchQuoteRequest();
				}
