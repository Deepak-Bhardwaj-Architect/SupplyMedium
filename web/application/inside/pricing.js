$(document).ready(function() {
	...
	$("#basic").click(function() {
		...
		$('#premium').removeClass('orangetag_mo');
                ...
                $('#unlimited').addClass('redtag');
		$('#unlimited').removeClass('redtag_mo');

		var $radios = $('input:radio[name=pricingoption]');

		$radios.filter('[value=Basic]').attr('checked', true);
                $('#couponfieldset').hide();
	...
	$("#unlimited").click(function() {
		...
		$('#premium').removeClass('orangetag_mo');
                ...
                $('#unlimited').removeClass('redtag');
		$('#unlimited').addClass('redtag_mo');

		var $radios = $('input:radio[name=pricingoption]');

		$radios.filter('[value=Unlimited]').attr('checked', true);
                $('#couponfieldset').show();
