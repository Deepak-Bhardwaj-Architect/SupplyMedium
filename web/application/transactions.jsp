                                    ...
                                    <table id="rfq_list" style="width: 997px;padding-left:1px;" class="dataTable" aria-describedby="rfq_list_info">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr <%=stl%> <% if (trb.getTransactionKey().equals(request.getParameter("nid"))) {
                                                ...
                                                <td class="rowBorder" onclick="window.location.href='';"><a target="_blank" href="<%=SmProperties.urlPath%>company-<%=companyKey%>/transaction/<%=trb.getTransactionNo()%>.pdf"><img alt="Open" title="Open" src="inside/open.png"></a></td>
                                            </tr>
                                            <%
                                                        }
                                                        if (al.size() == 0) {
