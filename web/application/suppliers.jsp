...
<html>
    ...
    <BODY onLoad="lockUnlock('webkrit_content_loader');<% if(request.getParameter("name")!=null){ %> showCompaniesNonVendorSearch('<%=request.getParameter("name") %>', 'Supplier'); <% } %>" onkeydown="displayunicode(event);">
