                            ...
                            <form id="file_upload_form_1" name="file_upload_form_1" action="UploadProductFromCsv"
                                ...
                                <div style="margin:50px 0px 0px 300px;">
                                    ...
                                    <div class="file_upload_container">
                                        <input id="catalog_import_upload_control" onchange="$('#catalog_import_text').val(this.files[0].name);"
                                               name="catalog_import_upload_control" class="file_upload_control"
                                               type="file" value="File Chossee" />
                                        <input type="button" style="margin-left: 10px;border-radius:5px;"
                                               id="file_upload_btn_1" class="general-button gen-btn-Orange"
                                               value="Browse" />

                                        <a href="inside/Product_catalog_template.csv" target="_blank" id="helpbtn" class="general-button gen-btn-Orange" style="height:17px;margin-left:10px;width:250px;" title="Click here to download the product catalog csv template.">Download Sample Template</a>
                                    </div>

                                    <input type="submit" style="margin-top: 20px;border-radius:5px;" class="general-button gen-btn-Orange" onclick="showLoading()" value="Upload" />
                                </div>
                            </form>
                            <div>
