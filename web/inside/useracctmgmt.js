...
function userAcctMgmtOnload()
{
    ...
    setTimeout("500",getPasswordPolicy());
    //getPasswordPolicy();
     getUserProfile();
    ...
    $("#wh_savebtnid").click(saveWorkinghoursSettings);

    notifyChkBoxClick();

    whChkBoxClick();
    uploadPicHeadClicked();
...
function uploadPicHeadClicked()
{
    ...
    if ($("#useracct_profilefrm").css('display') === 'none')
    {
        ...
        $("#updt_dtl_arw").removeClass('down_arrow');
        $("#updt_dtl_arw").addClass('right_arrow');
    }
}
...
function updt_dtl()
{
    if ($("#updt_dtl_bx").css('display') == 'none')
    {
        $("#useracct_profilefrm").slideUp();
        $("#useracct_resetpass").slideUp();
        $("#useracct_notifyfrm").slideUp();
        $("#useracct_whfrm").slideUp();
        $("#updt_dtl_bx").slideDown();
        ...
        $("#updt_dtl_arw").removeClass('right_arrow');
        $("#updt_dtl_arw").addClass('down_arrow');        
        
            $.ajax({
                type: "POST",
                url: "update_user_detail.jsp",
                
                success: function(data)
                {
                   // alert(data);
                    document.getElementById('updt_dtl_bx').innerHTML = data;
                },
    ...
    $.ajax({
        ...
        success: function(profileData)
        {
            ...
            if (profileData.result == "success")
            {
                ...
                profileData.ProfilePicPath = profileData.ProfilePicPath.replace("http://localhost:8080//", "");

                $("#profilepicture").attr("src", profileData.ProfilePicPath).load(function()
                {
...
function saveNotificationSettings( )
{
    ...
    $.ajax({
        type: "POST",
        url: getBaseURL() + "/updateNotificationSettings",
        data: {
...
function saveWorkinghoursSettings( )
{
    ...
    $.ajax({
        type: "POST",
        url: getBaseURL() + "/UpdateWorkingHours",
        data: {
