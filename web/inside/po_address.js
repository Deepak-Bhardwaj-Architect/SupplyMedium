...
/* This method is used to get the PO buyer address */
function getPOMyAddress()
{
...
/* This method is used to get the PO Supplier address
 * This request send once user select the supplier from supplier
 * search result.
 */

function getPOSupplierAddress( regnKey )
{
	$.ajax({
		   type: "POST",
		   url: getBaseURL()+"/CompanyFullProfileServlet",
			   ...
			   if(profileJSONObj.result == "success")
				{
                  ...
                  $("#selected_ven_user_key").val(profileData.email);
