...
function showRFQ()
{
	...
	$("#invoice_tab").addClass("main_tab_unselect");
        ...
        $("#payment_tab").removeClass("main_tab_select");
	$("#payment_tab").addClass("main_tab_unselect");
...
{    
	...
	$("#trans_content").load("Views/Transaction/TransCommon/jsp/payment.jsp",function() 
	{
		$("#trans_content").show();
	});;;
	...
	$("#invoice_tab").addClass("main_tab_unselect");
        ...
        $("#payment_tab").removeClass("main_tab_unselect");
	$("#payment_tab").addClass("main_tab_select");
}
