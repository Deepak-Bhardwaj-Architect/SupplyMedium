...
function fillInvoiceForm(aData)
{
    ...
    { 
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength="7" id="dscnt' + itemsCount + '" style="width:50px;margin-right:10px;" disabled="" value="' + mltplr + '";>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength="7" id="multiplier' + itemsCount + '" style="width:100px;margin-right:10px;" disabled="" value="' + item.multiplier + '";>'; 
        itemDet += '<input type="button" class="del_btn" id="del_btn_' + itemsCount + '" style="width:110px;margin-right:20px;" onclick="deleteItem(' + itemsCount + ');"/></div>';
