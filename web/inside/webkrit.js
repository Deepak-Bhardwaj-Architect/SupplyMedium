...
function selectUserRow(select, userKey, status,delstat)
{
    //alert(""+delstat);
    if(delstat=="yes")
    ...
    var actionImages = "<img src='inside/user_edit_btn.png' style='cursor:pointer;z-index:100;margin-right:10px;float: left;' title='Update User Settings' onclick=\"javascript:showUserSettingForAdmin('" + userKey + "');\">" +
