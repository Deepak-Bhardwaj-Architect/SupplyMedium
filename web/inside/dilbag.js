...
function slctd_ctgry(ctgry)
{
    ...
    if (document.getElementById("businesscategory2").value.indexOf(ctgry) == -1)
    {
        //alert('1');    
        if(ctgry!="0")
        document.getElementById("slctd_ctgry_lst").innerHTML += "<li id='cats" + cnt + "' style='background:#f3f3f3;padding:3px 2px;'>" + ctgry + " <span style='cursor:pointer;color:red;' onclick=\"javascript:rmv_ctgry('" + ctgry + "','cats" + cnt + "')\">X</span></li>";
        // alert('2');     
    ...
    document.getElementById("businesscategory2").value=document.getElementById("businesscategory2").value.replace("null","")
}
