...
function saveItem()
{
    ...
    {
        $("#rfq_item_form_error").text("Enter the Batch No.");
    ...
    if ($("#from_form").val() == "RFQForm")
    {
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="item_desc' + itemsCount + '" style="width:175px;margin-right:20px;" disabled  value="' + itemDesc + '";/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="brcd_no' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + popup_brcd + '";/>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=7 id="quantity' + itemsCount + '" style="width:90px;" disabled value="' + quantity + '";/>';
        itemDet += '<div class="quantity_unit" id="quantity_unit' + itemsCount + '" >' + quantityUnit + '</div>';
        itemDet += '<input type="text" autocomplete="off" class="textbox" id="ship_date' + itemsCount + '" style="width:110px;margin-right:20px;" disabled value="' + shipDate + '";/>';
    ...
    else  // Add item button clicked from RFQ Edit from poup view
    {
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="popup_item_desc' + itemsCount + '" style="width:175px;margin-right:20px;" disabled  value="' + itemDesc + '";/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" maxlength=80 id="popup_brcd_no' + itemsCount + '" style="width:90px;margin-right:20px;" disabled value="' + popup_brcd + '";/>';
        ...
        itemDet += '<input type="text" autocomplete="off" class="textbox" id="popup_ship_date' + itemsCount + '" style="width:110px;margin-right:20px;" disabled value="' + shipDate + '";/>';
...
function validateRFQold()
{
    ...
    popdata+="<th width='120'>Batch No.</th>";
