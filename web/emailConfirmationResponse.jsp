    ...
    <body>
        ...
        <div class="contentcontainer">
            <div class="successcontent">
                ...
                <div class="resmsg">
                    <font size="4">Your account has been successfully activated.</font><br><br> Click <a href="index.jsp">here</a> to login. Thank you for Activating your account with Supply Medium.
                </div>
            </div>
        </div>
